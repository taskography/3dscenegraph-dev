...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos15_yneg34_room5_floorA)
  ...
  (:goal (and
	(inreceptacle object8_bottle receptacle35_dining_table)
	(inreceptacle object31_potted_plant receptacle4_sink)
	(inreceptacle object32_potted_plant receptacle5_refrigerator)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos94_ypos38_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object11_bowl receptacle26_chair)
	(inreceptacle object33_potted_plant receptacle12_toilet)))
)

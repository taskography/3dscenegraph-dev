...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg12_ypos59_room6_floorA)
  ...
  (:goal (and
	(inreceptacle object7_book receptacle15_chair)
	(inreceptacle object6_cup receptacle36_dining_table)

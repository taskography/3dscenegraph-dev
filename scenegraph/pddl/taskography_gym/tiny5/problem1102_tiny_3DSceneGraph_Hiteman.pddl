...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos53_ypos18_room11_floorB)
  ...
  (:goal (and
	(inreceptacle object11_bowl receptacle15_toilet)
	...
	(inreceptacle object9_vase receptacle28_couch)))
)

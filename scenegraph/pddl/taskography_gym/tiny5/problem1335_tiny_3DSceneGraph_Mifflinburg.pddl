...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos6_ypos35_room19_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object29_potted_plant receptacle11_toilet)
	(inreceptacle object9_vase receptacle16_chair)

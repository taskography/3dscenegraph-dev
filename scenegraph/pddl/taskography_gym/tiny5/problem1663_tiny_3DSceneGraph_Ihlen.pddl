...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos20_ypos4_room13_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object30_potted_plant receptacle11_toilet)
	(inreceptacle object8_vase receptacle28_chair)

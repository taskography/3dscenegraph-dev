...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos46_yneg32_room6_floorA)
  ...
  (:goal (and
	(inreceptacle object30_potted_plant receptacle9_toilet)
	...
	(inreceptacle object29_potted_plant receptacle9_toilet)))
)

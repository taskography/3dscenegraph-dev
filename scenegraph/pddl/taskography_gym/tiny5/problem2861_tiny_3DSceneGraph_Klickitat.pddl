...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg32_yneg4_room1_floorA)
  ...
  (:goal (and
	(inreceptacle object46_potted_plant receptacle76_refrigerator)
	(inreceptacle object37_potted_plant receptacle59_toilet)

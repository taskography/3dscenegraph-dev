...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos3_ypos43_room3_floorC)
  ...
  (:goal (and
	(inreceptacle object22_vase receptacle3_oven)
	(inreceptacle object30_bowl receptacle7_sink)

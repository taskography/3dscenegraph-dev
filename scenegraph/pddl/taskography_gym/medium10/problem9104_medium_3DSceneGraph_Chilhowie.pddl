...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg89_ypos14_room12_floorA)
  ...
  (:goal (and
	(inreceptacle object2_backpack receptacle18_chair)
	...
	(inreceptacle object4_handbag receptacle29_dining_table)

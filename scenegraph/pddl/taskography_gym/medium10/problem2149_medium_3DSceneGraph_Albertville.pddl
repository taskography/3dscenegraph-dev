...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg49_ypos46_room11_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object72_book receptacle61_sink)))
)

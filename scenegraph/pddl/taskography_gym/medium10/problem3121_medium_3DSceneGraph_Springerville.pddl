...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg4_ypos5_room13_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object11_cup receptacle34_couch)
	(inreceptacle object19_bottle receptacle20_toilet)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object13_book receptacle39_chair)
	(inreceptacle object29_vase receptacle11_refrigerator)

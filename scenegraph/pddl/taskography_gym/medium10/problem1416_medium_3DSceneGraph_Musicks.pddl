...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg6_ypos22_room8_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object34_potted_plant receptacle54_oven)
	(inreceptacle object2_handbag receptacle38_bed)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg30_yneg33_room20_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object7_bottle receptacle49_sink)
	(inreceptacle object10_bowl receptacle39_toilet)))
)

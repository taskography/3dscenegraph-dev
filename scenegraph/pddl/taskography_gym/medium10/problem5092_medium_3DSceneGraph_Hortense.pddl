...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object10_bowl receptacle13_chair)
	(inreceptacle object3_bottle receptacle45_refrigerator)

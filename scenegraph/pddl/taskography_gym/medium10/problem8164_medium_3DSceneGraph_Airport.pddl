...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg73_yneg2_room3_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object88_teddy_bear receptacle70_refrigerator)
	(inreceptacle object49_potted_plant receptacle41_chair)

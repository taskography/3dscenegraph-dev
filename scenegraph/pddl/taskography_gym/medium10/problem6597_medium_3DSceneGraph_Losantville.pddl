...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg58_ypos20_room24_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object13_bottle receptacle59_bed)
	(inreceptacle object11_bottle receptacle8_bench)

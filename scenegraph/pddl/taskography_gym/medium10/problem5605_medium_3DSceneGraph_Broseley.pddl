...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg27_ypos58_room23_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object34_potted_plant receptacle70_sink)
	(inreceptacle object1_umbrella receptacle69_oven)))
)

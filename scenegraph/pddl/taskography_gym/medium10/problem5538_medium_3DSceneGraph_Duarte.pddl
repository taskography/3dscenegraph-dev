...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object13_cake receptacle2_bench)
	(inreceptacle object74_vase receptacle64_sink)
	(inreceptacle object51_potted_plant receptacle56_toilet)

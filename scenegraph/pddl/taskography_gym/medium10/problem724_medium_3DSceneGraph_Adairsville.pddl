...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg81_ypos34_room2_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object35_potted_plant receptacle20_toilet)
	(inreceptacle object15_vase receptacle23_chair)

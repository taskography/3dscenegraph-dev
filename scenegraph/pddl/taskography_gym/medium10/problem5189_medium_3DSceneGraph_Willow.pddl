...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos95_ypos37_room21_floorA)
  ...
  (:goal (and
	(inreceptacle object48_potted_plant receptacle1_oven)
	(inreceptacle object44_potted_plant receptacle4_sink)

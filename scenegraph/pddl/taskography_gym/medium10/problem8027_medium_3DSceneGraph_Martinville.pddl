...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg13_yneg79_room16_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object11_cake receptacle59_sink)
	(inreceptacle object27_potted_plant receptacle48_toilet)
	(inreceptacle object69_clock receptacle44_bed)))
)

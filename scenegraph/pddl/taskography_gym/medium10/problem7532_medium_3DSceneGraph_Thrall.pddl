...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg52_yneg209_room6_floorA)
  ...
  (:goal (and
	(inreceptacle object16_wine_glass receptacle50_couch)

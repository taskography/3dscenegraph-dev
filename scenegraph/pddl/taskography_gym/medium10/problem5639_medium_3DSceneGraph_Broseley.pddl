...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object33_potted_plant receptacle76_refrigerator)
	(inreceptacle object9_spoon receptacle22_chair)

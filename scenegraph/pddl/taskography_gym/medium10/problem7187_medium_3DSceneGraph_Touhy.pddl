...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg62_ypos8_room6_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object41_potted_plant receptacle76_sink)))
)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg19_ypos58_room8_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object24_banana receptacle26_toilet)
	(inreceptacle object25_banana receptacle10_sink)))
)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos54_yneg1_room9_floorB)
  ...
  (:goal (and
	(inreceptacle object28_spoon receptacle51_dining_table)
	(inreceptacle object80_book receptacle52_toilet)
	(inreceptacle object15_suitcase receptacle68_refrigerator)

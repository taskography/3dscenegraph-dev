...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object109_clock receptacle82_oven)
	(inreceptacle object106_clock receptacle4_bench)

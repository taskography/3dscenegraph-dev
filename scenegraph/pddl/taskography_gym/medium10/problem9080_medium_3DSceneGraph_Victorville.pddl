...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object61_potted_plant receptacle20_chair)
	(inreceptacle object2_sports_ball receptacle28_chair)

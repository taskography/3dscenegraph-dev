...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos94_yneg24_room20_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object15_cup receptacle12_refrigerator)
	(inreceptacle object16_clock receptacle10_refrigerator)

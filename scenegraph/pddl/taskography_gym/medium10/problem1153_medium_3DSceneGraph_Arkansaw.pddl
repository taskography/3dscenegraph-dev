...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos8_yneg15_room12_floorA)
  ...
  (:goal (and
	(inreceptacle object7_bowl receptacle39_bed)
	(inreceptacle object3_baseball_bat receptacle47_dining_table)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object73_vase receptacle57_sink)
	(inreceptacle object2_bottle receptacle42_bed)

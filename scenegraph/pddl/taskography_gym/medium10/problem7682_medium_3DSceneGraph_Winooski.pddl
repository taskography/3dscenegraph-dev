...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg63_ypos46_room3_floorC)
  ...
  (:goal (and
	(inreceptacle object85_vase receptacle4_bench)
	...
	(inreceptacle object91_toothbrush receptacle30_chair)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg55_yneg10_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object46_potted_plant receptacle32_bench)
	(inreceptacle object17_bottle receptacle12_sink)

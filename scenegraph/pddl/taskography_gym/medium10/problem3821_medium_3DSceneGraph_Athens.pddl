...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg40_ypos64_room3_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object3_kite receptacle37_couch)))
)

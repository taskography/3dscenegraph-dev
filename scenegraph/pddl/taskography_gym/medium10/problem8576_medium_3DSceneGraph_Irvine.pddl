...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object33_potted_plant receptacle50_oven)
	(inreceptacle object4_bottle receptacle42_dining_table)
	(inreceptacle object8_wine_glass receptacle10_chair)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg46_yneg91_room7_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object104_vase receptacle25_chair)))
)

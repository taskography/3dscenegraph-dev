...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos25_ypos20_room7_floorB)
  ...
  (:goal (and
	(inreceptacle object12_book receptacle39_couch)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object5_tie receptacle38_couch)
	(inreceptacle object85_clock receptacle61_toilet)

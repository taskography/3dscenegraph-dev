...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg8_ypos67_room8_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object63_potted_plant receptacle44_chair)))
)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg27_yneg30_room8_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object10_book receptacle28_couch)
	(inreceptacle object16_teddy_bear receptacle5_sink)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg8_ypos37_room1_floorA)
  ...
  (:goal (and
	(inreceptacle object6_bottle receptacle63_toilet)
	...
	(inreceptacle object2_handbag receptacle60_dining_table)

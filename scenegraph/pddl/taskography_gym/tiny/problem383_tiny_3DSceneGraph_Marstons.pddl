...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg63_yneg3_room18_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object41_potted_plant receptacle1_microwave)
	...
	(inreceptacle object4_vase receptacle48_bed)))
)

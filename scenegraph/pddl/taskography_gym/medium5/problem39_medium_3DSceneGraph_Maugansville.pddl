...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg62_ypos42_room8_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object10_umbrella receptacle30_couch)
	(inreceptacle object13_bottle receptacle55_sink)

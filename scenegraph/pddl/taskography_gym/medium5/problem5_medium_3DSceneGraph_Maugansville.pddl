...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg33_ypos21_room13_floorB)
  ...
  (:goal (and
	(inreceptacle object11_umbrella receptacle60_refrigerator)
	(inreceptacle object13_bottle receptacle60_refrigerator)
	(inreceptacle object10_umbrella receptacle36_bed)

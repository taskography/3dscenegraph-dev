...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg15_yneg15_room12_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object91_toothbrush receptacle67_microwave)
	(inreceptacle object86_vase receptacle52_bed)))
)

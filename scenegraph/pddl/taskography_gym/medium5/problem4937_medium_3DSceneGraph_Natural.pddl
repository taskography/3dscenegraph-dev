...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg90_yneg15_room22_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object81_clock receptacle51_dining_table)
	(inreceptacle object7_tie receptacle74_refrigerator)

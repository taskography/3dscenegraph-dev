...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg113_yneg1_room9_floorB)
  ...
  (:goal (and
	(inreceptacle object29_umbrella receptacle2_oven)
	(inreceptacle object20_clock receptacle15_refrigerator)
	(inreceptacle object30_umbrella receptacle9_sink)
	(inreceptacle object19_clock receptacle26_toilet)

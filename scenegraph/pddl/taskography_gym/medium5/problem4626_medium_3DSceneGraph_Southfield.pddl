...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg19_ypos48_room22_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object31_umbrella receptacle32_bed)
	(inreceptacle object30_umbrella receptacle13_refrigerator)
	(inreceptacle object19_clock receptacle13_refrigerator)))
)

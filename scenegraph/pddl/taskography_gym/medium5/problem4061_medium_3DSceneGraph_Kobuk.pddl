...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg15_yneg26_room20_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object27_potted_plant receptacle17_sink)
	(inreceptacle object6_bottle receptacle9_refrigerator)
	(inreceptacle object5_bottle receptacle29_bed)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg1_ypos17_room21_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object62_clock receptacle48_oven)
	(inreceptacle object11_umbrella receptacle59_refrigerator)

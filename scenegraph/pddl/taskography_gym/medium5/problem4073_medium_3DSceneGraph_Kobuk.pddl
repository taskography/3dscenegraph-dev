...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg55_yneg43_room8_floorB)
  ...
  (:goal (and
	(inreceptacle object6_bottle receptacle28_bed)
	(inreceptacle object3_bottle receptacle28_bed)
	(inreceptacle object7_bottle receptacle12_refrigerator)

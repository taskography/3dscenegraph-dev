...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg35_yneg18_room6_floorA)
  ...
  (:goal (and
	(inreceptacle object23_backpack receptacle30_bed)
	...
	(inreceptacle object27_potted_plant receptacle21_toilet)))
)

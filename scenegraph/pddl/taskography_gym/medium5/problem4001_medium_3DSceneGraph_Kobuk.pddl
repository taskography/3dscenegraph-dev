...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg14_yneg57_room13_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object4_bottle receptacle22_toilet)
	(inreceptacle object3_bottle receptacle8_refrigerator)

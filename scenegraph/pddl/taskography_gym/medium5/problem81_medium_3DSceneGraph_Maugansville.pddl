...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg52_yneg25_room10_floorA)
  ...
  (:goal (and
	(inreceptacle object12_suitcase receptacle2_boat)
	...
	(inreceptacle object10_umbrella receptacle58_refrigerator)))
)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos33_ypos59_room1_floorA)
  ...
  (:goal (and
	(inreceptacle object52_potted_plant receptacle64_toilet)
	...
	(inreceptacle object82_vase receptacle36_couch)

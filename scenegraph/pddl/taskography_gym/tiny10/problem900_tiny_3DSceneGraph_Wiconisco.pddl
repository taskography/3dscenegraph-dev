...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg18_ypos44_room25_floorB)
  ...
  (:goal (and
	(inreceptacle object35_potted_plant receptacle43_toilet)
	(inreceptacle object6_bowl receptacle51_sink)
	(inreceptacle object62_vase receptacle16_chair)

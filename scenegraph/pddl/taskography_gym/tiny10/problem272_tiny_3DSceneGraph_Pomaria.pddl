...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object21_potted_plant receptacle24_bed)
	(inreceptacle object84_book receptacle4_chair)

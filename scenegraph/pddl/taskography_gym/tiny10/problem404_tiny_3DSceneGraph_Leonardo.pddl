...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos36_ypos0_room13_floorA)
  ...
  (:goal (and
	(inreceptacle object11_bottle receptacle73_microwave)
	(inreceptacle object93_vase receptacle62_toilet)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg3_ypos28_room18_floorD)
  ...
  (:goal (and
	...
	(inreceptacle object2_bottle receptacle75_sink)
	...
	(inreceptacle object10_wine_glass receptacle36_couch)))
)

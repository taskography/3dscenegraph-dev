...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg50_yneg4_room16_floorB)
  ...
  (:goal (and
	(inreceptacle object72_keyboard receptacle62_toilet)

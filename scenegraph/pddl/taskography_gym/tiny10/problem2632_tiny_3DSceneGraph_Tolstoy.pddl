...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object1_backpack receptacle68_bed)
	(inreceptacle object22_bowl receptacle42_chair)))
)

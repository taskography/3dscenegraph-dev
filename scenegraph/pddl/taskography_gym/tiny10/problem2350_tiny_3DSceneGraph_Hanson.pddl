...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg4_yneg17_room6_floorC)
  ...
  (:goal (and
	(inreceptacle object53_potted_plant receptacle21_toilet)
	(inreceptacle object11_book receptacle63_bed)

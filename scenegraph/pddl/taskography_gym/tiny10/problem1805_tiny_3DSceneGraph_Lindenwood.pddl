...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg86_ypos8_room34_floorA)
  ...
  (:goal (and
	(inreceptacle object15_bottle receptacle1_oven)
	(inreceptacle object40_potted_plant receptacle6_sink)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object64_potted_plant receptacle37_toilet)
	(inreceptacle object8_book receptacle35_toilet)

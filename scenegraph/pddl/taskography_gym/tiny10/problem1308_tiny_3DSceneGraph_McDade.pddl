...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg37_yneg74_room10_floorC)
  ...
  (:goal (and
	(inreceptacle object28_vase receptacle39_chair)
	...
	(inreceptacle object23_vase receptacle63_dining_table)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg74_ypos33_room12_floorC)
  ...
  (:goal (and
	(inreceptacle object65_vase receptacle51_toilet)
	...
	(inreceptacle object59_book receptacle32_couch)

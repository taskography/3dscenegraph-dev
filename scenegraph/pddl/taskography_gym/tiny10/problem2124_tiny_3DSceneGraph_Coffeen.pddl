...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos32_ypos38_room2_floorC)
  ...
  (:goal (and
	...
	(inreceptacle object5_bottle receptacle76_sink)
	(inreceptacle object38_potted_plant receptacle76_sink)))
)

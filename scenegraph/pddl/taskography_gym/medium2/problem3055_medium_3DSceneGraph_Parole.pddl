...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos17_yneg6_room7_floorA)
	(inroom agent room7_living_room)
  ...
  (:goal (and
	(inreceptacle object15_potted_plant receptacle16_bed)
	(inreceptacle object7_vase receptacle18_dining_table)))
)

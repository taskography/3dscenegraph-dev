...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg111_yneg6_room26_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object100_teddy_bear receptacle15_chair)
	(inreceptacle object99_vase receptacle12_chair)

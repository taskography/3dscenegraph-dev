...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg53_yneg37_room1_floorB)
  ...
  (:goal (and
	(inreceptacle object24_potted_plant receptacle40_sink)
	(inreceptacle object8_bowl receptacle19_chair)
	(inreceptacle object11_bowl receptacle30_toilet)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object2_bottle receptacle45_dining_table)
	(inreceptacle object3_bottle receptacle54_toilet)))
)

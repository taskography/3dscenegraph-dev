...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg27_ypos15_room7_floorA)
  ...
  (:goal (and
	(inreceptacle object79_clock receptacle39_dining_table)
	(inreceptacle object6_bottle receptacle56_oven)

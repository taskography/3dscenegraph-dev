...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg8_yneg49_room11_floorB)
  ...
  (:goal (and
	(inreceptacle object80_remote receptacle89_refrigerator)

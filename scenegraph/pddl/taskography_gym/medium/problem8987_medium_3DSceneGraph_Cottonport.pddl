...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos94_ypos36_room23_floorA)
  ...
  (:goal (and
	(inreceptacle object15_cup receptacle13_refrigerator)
	...
	(inreceptacle object14_cup receptacle34_chair)

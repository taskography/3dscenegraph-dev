...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg44_ypos4_room17_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object61_book receptacle14_chair)
	(inreceptacle object45_mouse receptacle16_chair)

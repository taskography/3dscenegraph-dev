...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg16_ypos40_room2_floorB)
  ...
  (:goal (and
	(inreceptacle object4_suitcase receptacle23_couch)
	...
	(inreceptacle object1_handbag receptacle23_couch)

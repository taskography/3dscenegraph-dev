...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg110_ypos9_room2_floorB)
  ...
  (:goal (and
	(inreceptacle object14_bottle receptacle38_couch)
	...
	(inreceptacle object16_bottle receptacle60_dining_table)))
)

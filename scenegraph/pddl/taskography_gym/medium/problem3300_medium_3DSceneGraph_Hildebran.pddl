...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg80_yneg33_room1_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object18_vase receptacle6_refrigerator)
	(inreceptacle object13_book receptacle39_couch)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object80_book receptacle48_dining_table)
	(inreceptacle object81_clock receptacle31_couch)

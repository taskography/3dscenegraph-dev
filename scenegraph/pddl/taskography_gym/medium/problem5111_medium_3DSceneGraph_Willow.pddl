...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos162_yneg29_room23_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object44_potted_plant receptacle28_toilet)
	(inreceptacle object14_vase receptacle33_chair)

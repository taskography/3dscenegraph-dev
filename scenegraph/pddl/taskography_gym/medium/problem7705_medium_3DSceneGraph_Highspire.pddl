...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg14_ypos19_room16_floorB)
  ...
  (:goal (and
	(inreceptacle object48_teddy_bear receptacle10_chair)
	...
	(inreceptacle object44_book receptacle23_dining_table)

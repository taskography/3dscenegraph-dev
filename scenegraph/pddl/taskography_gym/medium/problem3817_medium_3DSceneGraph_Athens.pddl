...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object9_spoon receptacle51_bed)
	(inreceptacle object86_vase receptacle31_chair)
	(inreceptacle object43_potted_plant receptacle70_oven)))
)

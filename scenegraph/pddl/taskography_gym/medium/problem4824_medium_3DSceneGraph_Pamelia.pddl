...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object78_vase receptacle46_toilet)
	(inreceptacle object68_book receptacle61_refrigerator)

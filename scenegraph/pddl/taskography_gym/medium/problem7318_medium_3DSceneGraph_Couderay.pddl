...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	(inreceptacle object31_bowl receptacle67_dining_table)
	(inreceptacle object51_potted_plant receptacle34_toilet)

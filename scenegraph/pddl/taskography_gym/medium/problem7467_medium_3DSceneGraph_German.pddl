...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object23_suitcase receptacle21_bench)
	(inreceptacle object29_bottle receptacle20_bench)))
)

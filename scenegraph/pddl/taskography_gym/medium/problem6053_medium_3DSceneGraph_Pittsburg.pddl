...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos10_yneg9_room11_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object10_bottle receptacle51_dining_table)
	(inreceptacle object43_potted_plant receptacle48_bed)

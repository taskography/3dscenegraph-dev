...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg14_yneg87_room1_floorA)
  ...
  (:goal (and
	(inreceptacle object14_bottle receptacle22_toilet)

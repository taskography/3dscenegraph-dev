...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos7_ypos15_room10_floorA)
  ...
  (:goal (and
	(inreceptacle object8_knife receptacle65_toilet)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:goal (and
	...
	(inreceptacle object40_potted_plant receptacle59_dining_table)
	(inreceptacle object9_spoon receptacle75_sink)))
)

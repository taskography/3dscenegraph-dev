...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg60_ypos46_room7_floorB)
  ...
  (:goal (and
	(inreceptacle object38_keyboard receptacle31_toilet)
	...
	(inreceptacle object2_backpack receptacle21_couch)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg5_ypos38_room6_floorB)
  ...
  (:goal (and
	...
	(inreceptacle object18_vase receptacle43_couch)

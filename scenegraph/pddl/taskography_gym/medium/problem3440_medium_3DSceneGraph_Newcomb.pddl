...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xneg83_yneg11_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle object20_apple receptacle7_refrigerator)
	(inreceptacle object17_bowl receptacle36_dining_table)

...
(define (problem taskography_pick_and_place) (:domain taskography)
  ...
  (:init 
	(atlocation agent center_location_xpos7_yneg101_room6_floorB)
  ...
  (:goal (and
	(inreceptacle object73_vase receptacle58_refrigerator)
	...
	(inreceptacle object37_potted_plant receptacle28_couch)

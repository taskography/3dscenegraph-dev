...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg47_Ypos20_place2_room22_floorA)
	...
	(inplace agent place2_door_room22_utility_room)
  ...
  (:goal (and
	(inreceptacle item26_vase_mediumitem receptacle47_chair)
	(inreceptacle item9_bottle_smallitem receptacle50_chair)
	(inreceptacle item64_potted_plant_largeitem receptacle66_bed)
	(inreceptacle item40_bowl_smallitem receptacle66_bed)
	(inreceptacle item33_vase_mediumitem receptacle65_bed)
	(inreceptacle item57_potted_plant_largeitem receptacle48_chair)
	(inreceptacle item31_vase_mediumitem receptacle51_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle6_sink)
	(inreceptacle item39_clock_mediumitem receptacle68_bed)
	(inreceptacle item56_potted_plant_largeitem receptacle51_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg27_Ypos4_place13_room1_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item21_bowl_smallitem receptacle75_toilet)
	(inreceptacle item55_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle74_toilet)
	(inreceptacle item109_vase_mediumitem receptacle43_couch)
	(inreceptacle item99_book_smallitem receptacle82_sink)
	(inreceptacle item103_vase_mediumitem receptacle67_bed)
	(inreceptacle item93_book_smallitem receptacle74_toilet)
	(inreceptacle item108_vase_mediumitem receptacle29_chair)
	(inreceptacle item1_backpack_largeitem receptacle88_sink)))
)

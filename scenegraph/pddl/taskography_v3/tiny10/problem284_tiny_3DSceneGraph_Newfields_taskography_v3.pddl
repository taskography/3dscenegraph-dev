...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos14_Ypos2_place6_room14_floorB)
	...
	(inplace agent place6_door_room14_exercise_room)
	...
	(inroom agent room14_exercise_room)
  ...
  (:goal (and
	(inreceptacle item38_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item37_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item19_book_smallitem receptacle26_chair)
	(inreceptacle item48_tv_largeitem receptacle29_chair)
	(inreceptacle item17_bottle_smallitem receptacle10_refrigerator)
	(inreceptacle item15_bottle_smallitem receptacle29_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle6_sink)
	(inreceptacle item21_suitcase_largeitem receptacle5_sink)
	(inreceptacle item12_clock_mediumitem receptacle24_toilet)
	(inreceptacle item13_clock_mediumitem receptacle25_chair)))
)

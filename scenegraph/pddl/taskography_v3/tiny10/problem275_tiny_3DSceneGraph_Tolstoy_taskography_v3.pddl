...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg67_Ypos67_place14_room5_floorB)
	...
	(inplace agent place14_door_room5_bedroom)
  ...
  (:goal (and
	...
	(inreceptacle item11_bottle_smallitem receptacle44_couch)
	(inreceptacle item112_vase_mediumitem receptacle88_sink)
	(inreceptacle item94_book_smallitem receptacle27_chair)
	(inreceptacle item108_vase_mediumitem receptacle38_chair)
	(inreceptacle item50_potted_plant_largeitem receptacle44_couch)
	(inreceptacle item63_potted_plant_largeitem receptacle75_toilet)
	(inreceptacle item92_book_smallitem receptacle68_bed)
	(inreceptacle item2_tie_smallitem receptacle32_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item63_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle82_sink)
	(inreceptacle item6_bottle_smallitem receptacle38_chair)
	(inreceptacle item51_potted_plant_largeitem receptacle41_chair)
	(inreceptacle item100_book_smallitem receptacle28_chair)
	(inreceptacle item96_book_smallitem receptacle76_toilet)
	(inreceptacle item9_bottle_smallitem receptacle67_bed)
	(inreceptacle item58_potted_plant_largeitem receptacle43_couch)
	(inreceptacle item57_potted_plant_largeitem receptacle68_bed)
	(inreceptacle item3_suitcase_largeitem receptacle33_chair)))
)

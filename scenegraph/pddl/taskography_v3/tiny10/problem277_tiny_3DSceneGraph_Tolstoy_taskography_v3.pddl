...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg16_Ypos128_place15_room7_floorB)
	...
	(inplace agent place15_door_room7_childs_room)
  ...
  (:goal (and
	(inreceptacle item49_potted_plant_largeitem receptacle70_bed)
	(inreceptacle item106_vase_mediumitem receptacle87_sink)
	(inreceptacle item95_book_smallitem receptacle36_chair)
	(inreceptacle item104_vase_mediumitem receptacle30_chair)
	(inreceptacle item21_bowl_smallitem receptacle83_sink)
	(inreceptacle item20_bowl_smallitem receptacle86_sink)
	(inreceptacle item1_backpack_largeitem receptacle46_couch)
	(inreceptacle item56_potted_plant_largeitem receptacle73_dining_table)
	(inreceptacle item52_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item5_bottle_smallitem receptacle75_toilet)))
)

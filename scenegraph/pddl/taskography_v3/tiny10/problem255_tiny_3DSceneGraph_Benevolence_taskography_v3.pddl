...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos5_Yneg66_place3_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item29_potted_plant_largeitem receptacle6_sink)
	...
	(inreceptacle item18_bowl_smallitem receptacle34_bed)

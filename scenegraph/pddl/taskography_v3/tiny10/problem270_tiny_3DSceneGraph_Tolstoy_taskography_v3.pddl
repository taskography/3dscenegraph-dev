...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg69_Ypos30_place2_room2_floorB)
  ...
  (:goal (and
	(inreceptacle item100_book_smallitem receptacle66_bed)
	(inreceptacle item15_wine_glass_smallitem receptacle87_sink)
	(inreceptacle item13_bottle_smallitem receptacle66_bed)
	(inreceptacle item20_bowl_smallitem receptacle41_chair)
	(inreceptacle item22_bowl_smallitem receptacle76_toilet)
	(inreceptacle item77_tv_largeitem receptacle25_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle80_oven)
	(inreceptacle item14_wine_glass_smallitem receptacle29_chair)
	(inreceptacle item57_potted_plant_largeitem receptacle89_refrigerator)
	(inreceptacle item17_wine_glass_smallitem receptacle70_bed)))
)

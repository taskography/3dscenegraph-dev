...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg68_Ypos33_place2_room3_floorC)
  ...
  (:goal (and
	(inreceptacle item19_book_smallitem receptacle27_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item37_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item33_potted_plant_largeitem receptacle27_chair)
	(inreceptacle item11_handbag_largeitem receptacle8_sink)
	(inreceptacle item41_potted_plant_largeitem receptacle24_toilet)
	(inreceptacle item21_suitcase_largeitem receptacle32_couch)
	(inreceptacle item16_bottle_smallitem receptacle23_toilet)
	(inreceptacle item35_potted_plant_largeitem receptacle23_toilet)
	(inreceptacle item39_potted_plant_largeitem receptacle46_bed)))
)

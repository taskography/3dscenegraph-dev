...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos6_Ypos18_place0_room15_floorA)
	...
	(inplace agent place0_door_room15_home_office)
  ...
  (:goal (and
	(inreceptacle item34_potted_plant_largeitem receptacle24_toilet)
	(inreceptacle item48_tv_largeitem receptacle25_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item13_clock_mediumitem receptacle46_bed)
	(inreceptacle item20_suitcase_largeitem receptacle30_chair)
	(inreceptacle item33_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item49_tv_largeitem receptacle46_bed)
	(inreceptacle item21_suitcase_largeitem receptacle46_bed)
	(inreceptacle item17_bottle_smallitem receptacle45_bed)

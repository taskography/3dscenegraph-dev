...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg69_Ypos8_place12_room6_floorC)
  ...
  (:goal (and
	(inreceptacle item48_tv_largeitem receptacle24_toilet)
	(inreceptacle item49_tv_largeitem receptacle23_toilet)
	(inreceptacle item18_bottle_smallitem receptacle44_bed)
	(inreceptacle item1_keyboard_largeitem receptacle29_chair)
	(inreceptacle item36_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item47_tv_largeitem receptacle8_sink)
	(inreceptacle item13_clock_mediumitem receptacle30_chair)
	(inreceptacle item38_potted_plant_largeitem receptacle45_bed)
	(inreceptacle item14_vase_mediumitem receptacle32_couch)
	(inreceptacle item12_clock_mediumitem receptacle32_couch)))
)

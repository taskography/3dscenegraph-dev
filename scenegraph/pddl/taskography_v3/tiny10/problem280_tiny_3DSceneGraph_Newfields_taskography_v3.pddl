...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item12_clock_mediumitem receptacle7_sink)
	(inreceptacle item15_bottle_smallitem receptacle2_microwave)
	(inreceptacle item1_keyboard_largeitem receptacle44_bed)
	(inreceptacle item38_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item39_potted_plant_largeitem receptacle24_toilet)
	...
	(inreceptacle item40_potted_plant_largeitem receptacle3_oven)
	(inreceptacle item36_potted_plant_largeitem receptacle46_bed)))
)

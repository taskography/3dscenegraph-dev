...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item19_book_smallitem receptacle6_sink)
	(inreceptacle item18_bottle_smallitem receptacle30_chair)
	(inreceptacle item35_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item11_handbag_largeitem receptacle24_toilet)
	(inreceptacle item13_clock_mediumitem receptacle24_toilet)
	(inreceptacle item34_potted_plant_largeitem receptacle10_refrigerator)
	(inreceptacle item17_bottle_smallitem receptacle24_toilet)
	(inreceptacle item48_tv_largeitem receptacle3_oven)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item34_vase_mediumitem receptacle4_sink)
	(inreceptacle item38_handbag_largeitem receptacle42_toilet)
	(inreceptacle item40_bowl_smallitem receptacle3_sink)
	(inreceptacle item17_bottle_smallitem receptacle51_chair)
	(inreceptacle item62_potted_plant_largeitem receptacle51_chair)
	(inreceptacle item11_bottle_smallitem receptacle4_sink)
	(inreceptacle item15_bottle_smallitem receptacle7_sink)
	...
	(inreceptacle item71_tv_largeitem receptacle42_toilet)))
)

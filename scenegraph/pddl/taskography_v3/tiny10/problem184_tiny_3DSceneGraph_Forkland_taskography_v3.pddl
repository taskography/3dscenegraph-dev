...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg77_Ypos10_place15_room18_floorB)
	...
	(inplace agent place15_door_room18_lobby)
  ...
  (:goal (and
	(inreceptacle item12_bottle_smallitem receptacle42_toilet)
	(inreceptacle item59_potted_plant_largeitem receptacle44_chair)
	(inreceptacle item56_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item11_bottle_smallitem receptacle47_chair)
	(inreceptacle item16_bottle_smallitem receptacle44_chair)
	(inreceptacle item38_handbag_largeitem receptacle2_oven)
	(inreceptacle item64_potted_plant_largeitem receptacle43_toilet)
	(inreceptacle item61_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item24_book_smallitem receptacle4_sink)
	(inreceptacle item13_bottle_smallitem receptacle52_chair)))
)

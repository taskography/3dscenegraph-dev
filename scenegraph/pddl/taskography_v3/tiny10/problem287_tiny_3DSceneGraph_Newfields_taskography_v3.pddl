...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item21_suitcase_largeitem receptacle24_toilet)
	(inreceptacle item18_bottle_smallitem receptacle30_chair)
	(inreceptacle item1_keyboard_largeitem receptacle45_bed)
	(inreceptacle item14_vase_mediumitem receptacle4_sink)
	(inreceptacle item36_potted_plant_largeitem receptacle7_sink)
	(inreceptacle item20_suitcase_largeitem receptacle7_sink)
	(inreceptacle item17_bottle_smallitem receptacle44_bed)
	(inreceptacle item16_bottle_smallitem receptacle32_couch)
	(inreceptacle item12_clock_mediumitem receptacle9_sink)))
)

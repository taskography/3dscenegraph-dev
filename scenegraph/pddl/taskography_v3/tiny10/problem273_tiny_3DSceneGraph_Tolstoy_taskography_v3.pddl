...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos0_Ypos9_place1_room20_floorA)
	...
	(inplace agent place1_door_room20_utility_room)
  ...
  (:goal (and
	...
	(inreceptacle item101_book_smallitem receptacle70_bed)
	(inreceptacle item60_potted_plant_largeitem receptacle39_chair)
	(inreceptacle item1_backpack_largeitem receptacle42_chair)
	(inreceptacle item3_suitcase_largeitem receptacle69_bed)
	(inreceptacle item50_potted_plant_largeitem receptacle76_toilet)
	(inreceptacle item105_vase_mediumitem receptacle66_bed)
	(inreceptacle item58_potted_plant_largeitem receptacle83_sink)))
)

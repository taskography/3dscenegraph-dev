...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg14_Ypos2_place5_room8_floorC)
	...
	(inplace agent place5_door_room8_closet)
  ...
  (:goal (and
	...
	(inreceptacle item1_keyboard_largeitem receptacle32_couch)
	(inreceptacle item11_handbag_largeitem receptacle3_oven)
	(inreceptacle item35_potted_plant_largeitem receptacle3_oven)

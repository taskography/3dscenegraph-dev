...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item40_bowl_smallitem receptacle42_toilet)
	(inreceptacle item30_vase_mediumitem receptacle5_sink)
	(inreceptacle item56_potted_plant_largeitem receptacle49_chair)
	(inreceptacle item22_book_smallitem receptacle5_sink)
	(inreceptacle item10_bottle_smallitem receptacle3_sink)
	(inreceptacle item32_vase_mediumitem receptacle43_toilet)
	(inreceptacle item55_potted_plant_largeitem receptacle7_sink)
	(inreceptacle item24_book_smallitem receptacle2_oven)
	(inreceptacle item34_vase_mediumitem receptacle1_microwave)
	(inreceptacle item14_bottle_smallitem receptacle48_chair)))
)

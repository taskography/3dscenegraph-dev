...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos3_place5_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item15_teddy_bear_mediumitem receptacle24_chair)
	(inreceptacle item18_bowl_smallitem receptacle5_sink)

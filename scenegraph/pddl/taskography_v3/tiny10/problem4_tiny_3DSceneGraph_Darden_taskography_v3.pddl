...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg113_Ypos4_place5_room22_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item59_book_smallitem receptacle14_chair)
	(inreceptacle item61_book_smallitem receptacle56_sink)
	(inreceptacle item33_potted_plant_largeitem receptacle46_bed)
	(inreceptacle item40_potted_plant_largeitem receptacle55_sink)
	(inreceptacle item4_bottle_smallitem receptacle28_chair)
	(inreceptacle item63_book_smallitem receptacle55_sink)
	(inreceptacle item66_vase_mediumitem receptacle26_chair)
	(inreceptacle item6_cup_smallitem receptacle22_chair)
	(inreceptacle item60_book_smallitem receptacle47_bed)))
)

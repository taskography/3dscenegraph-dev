...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos20_Ypos2_place3_room2_floorC)
  ...
  (:goal (and
	(inreceptacle item15_bottle_smallitem receptacle2_microwave)
	(inreceptacle item11_handbag_largeitem receptacle3_oven)
	(inreceptacle item34_potted_plant_largeitem receptacle3_oven)
	(inreceptacle item38_potted_plant_largeitem receptacle2_microwave)
	(inreceptacle item1_keyboard_largeitem receptacle9_sink)
	(inreceptacle item39_potted_plant_largeitem receptacle23_toilet)
	(inreceptacle item18_bottle_smallitem receptacle5_sink)
	(inreceptacle item41_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item20_suitcase_largeitem receptacle44_bed)
	(inreceptacle item17_bottle_smallitem receptacle46_bed)))
)

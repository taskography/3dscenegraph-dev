...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg21_Ypos46_place3_room9_floorA)
	...
	(inplace agent place3_door_room9_corridor)
  ...
  (:goal (and
	(inreceptacle item97_book_smallitem receptacle82_sink)
	(inreceptacle item102_book_smallitem receptacle27_chair)
	(inreceptacle item10_bottle_smallitem receptacle66_bed)
	(inreceptacle item13_bottle_smallitem receptacle71_dining_table)
	(inreceptacle item111_vase_mediumitem receptacle42_chair)
	(inreceptacle item19_wine_glass_smallitem receptacle43_couch)
	(inreceptacle item47_potted_plant_largeitem receptacle34_chair)
	(inreceptacle item91_book_smallitem receptacle30_chair)
	(inreceptacle item12_bottle_smallitem receptacle87_sink)

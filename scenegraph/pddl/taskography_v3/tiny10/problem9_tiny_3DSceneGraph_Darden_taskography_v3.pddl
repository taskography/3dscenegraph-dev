...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg143_Ypos5_place0_room24_floorB)
	...
	(inplace agent place0_door_room24_lobby)
  ...
  (:goal (and
	...
	(inreceptacle item61_book_smallitem receptacle57_sink)
	(inreceptacle item38_potted_plant_largeitem receptacle1_bench)
	(inreceptacle item52_tv_largeitem receptacle50_toilet)
	(inreceptacle item41_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle32_couch)
	(inreceptacle item60_book_smallitem receptacle11_chair)

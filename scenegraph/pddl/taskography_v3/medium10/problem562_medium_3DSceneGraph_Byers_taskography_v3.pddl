...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item3_tie_smallitem receptacle20_couch)
	(inreceptacle item35_tv_largeitem receptacle26_dining_table)
	(inreceptacle item7_suitcase_largeitem receptacle15_chair)
	(inreceptacle item36_tv_largeitem receptacle11_chair)
	...
	(inreceptacle item6_tie_smallitem receptacle30_toilet)

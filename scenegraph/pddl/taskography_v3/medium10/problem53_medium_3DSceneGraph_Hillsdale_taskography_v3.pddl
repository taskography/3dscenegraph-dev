...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item27_laptop_mediumitem receptacle32_sink)
	(inreceptacle item22_potted_plant_largeitem receptacle34_sink)
	(inreceptacle item10_cup_smallitem receptacle15_chair)
	(inreceptacle item1_handbag_largeitem receptacle24_dining_table)
	(inreceptacle item8_bottle_smallitem receptacle17_couch)
	(inreceptacle item39_book_smallitem receptacle36_refrigerator)
	(inreceptacle item6_bottle_smallitem receptacle29_oven)
	(inreceptacle item44_vase_mediumitem receptacle26_toilet)
	(inreceptacle item20_potted_plant_largeitem receptacle25_toilet)
	(inreceptacle item12_spoon_smallitem receptacle14_chair)))
)

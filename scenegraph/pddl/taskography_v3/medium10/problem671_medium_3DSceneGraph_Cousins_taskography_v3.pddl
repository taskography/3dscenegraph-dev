...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg54_Yneg85_place0_room8_floorB)
  ...
  (:goal (and
	(inreceptacle item12_wine_glass_smallitem receptacle48_couch)
	(inreceptacle item18_bowl_smallitem receptacle48_couch)
	(inreceptacle item89_potted_plant_largeitem receptacle47_couch)
	(inreceptacle item72_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item121_book_smallitem receptacle46_chair)
	(inreceptacle item78_potted_plant_largeitem receptacle38_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle113_sink)
	(inreceptacle item21_bowl_smallitem receptacle101_toilet)
	(inreceptacle item125_book_smallitem receptacle115_refrigerator)
	(inreceptacle item8_tie_smallitem receptacle50_couch)))
)

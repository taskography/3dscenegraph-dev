...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg34_Yneg3_place3_room2_floorA)
	...
	(inplace agent place3_door_room2_bedroom)
  ...
  (:goal (and
	(inreceptacle item14_tie_smallitem receptacle29_bed)
	(inreceptacle item35_tv_largeitem receptacle18_toilet)
	(inreceptacle item33_tv_largeitem receptacle18_toilet)
	(inreceptacle item34_tv_largeitem receptacle18_toilet)
	(inreceptacle item13_vase_mediumitem receptacle20_chair)
	...
	(inreceptacle item15_tie_smallitem receptacle31_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos0_Ypos22_place1_room6_floorC)
  ...
  (:goal (and
	(inreceptacle item40_laptop_mediumitem receptacle26_dining_table)
	(inreceptacle item54_vase_mediumitem receptacle44_sink)
	(inreceptacle item33_tv_largeitem receptacle28_dining_table)
	(inreceptacle item22_potted_plant_largeitem receptacle44_sink)
	(inreceptacle item39_laptop_mediumitem receptacle31_toilet)
	(inreceptacle item38_laptop_mediumitem receptacle45_sink)
	(inreceptacle item21_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item49_book_smallitem receptacle43_oven)
	(inreceptacle item52_vase_mediumitem receptacle16_chair)
	(inreceptacle item51_vase_mediumitem receptacle28_dining_table)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item72_clock_mediumitem receptacle30_couch)
	(inreceptacle item11_bottle_smallitem receptacle66_sink)
	(inreceptacle item7_suitcase_largeitem receptacle20_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle5_bench)
	(inreceptacle item37_potted_plant_largeitem receptacle67_sink)
	(inreceptacle item35_potted_plant_largeitem receptacle56_bed)
	(inreceptacle item49_potted_plant_largeitem receptacle22_chair)
	(inreceptacle item17_bowl_smallitem receptacle57_bed)
	(inreceptacle item76_vase_mediumitem receptacle59_dining_table)
	(inreceptacle item51_potted_plant_largeitem receptacle19_chair)))
)

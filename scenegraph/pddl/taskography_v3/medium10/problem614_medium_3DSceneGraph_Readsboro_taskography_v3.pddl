...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg43_Yneg36_place1_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item60_potted_plant_largeitem receptacle9_sink)
	(inreceptacle item2_laptop_mediumitem receptacle34_toilet)
	(inreceptacle item64_potted_plant_largeitem receptacle55_couch)
	(inreceptacle item23_vase_mediumitem receptacle35_toilet)
	(inreceptacle item27_vase_mediumitem receptacle53_couch)
	(inreceptacle item21_vase_mediumitem receptacle33_toilet)
	(inreceptacle item59_potted_plant_largeitem receptacle56_couch)
	(inreceptacle item63_potted_plant_largeitem receptacle11_refrigerator)
	(inreceptacle item30_bowl_smallitem receptacle10_sink)
	(inreceptacle item15_book_smallitem receptacle31_toilet)))
)

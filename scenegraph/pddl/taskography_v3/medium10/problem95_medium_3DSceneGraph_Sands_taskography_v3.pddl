...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos23_Ypos1_place8_room6_floorA)
	...
	(inplace agent place8_door_room6_empty_room)
  ...
  (:goal (and
	...
	(inreceptacle item26_potted_plant_largeitem receptacle21_toilet)
	...
	(inreceptacle item4_surfboard_largeitem receptacle24_couch)
	...
	(inreceptacle item15_cup_smallitem receptacle10_sink)))
)

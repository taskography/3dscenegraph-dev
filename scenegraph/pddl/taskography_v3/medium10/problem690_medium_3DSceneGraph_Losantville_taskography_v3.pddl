...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos37_Ypos85_place3_room22_floorA)
  ...
  (:goal (and
	(inreceptacle item16_bowl_smallitem receptacle1_bench)
	(inreceptacle item65_remote_smallitem receptacle68_oven)
	(inreceptacle item14_cup_smallitem receptacle71_sink)
	(inreceptacle item15_cup_smallitem receptacle23_chair)
	(inreceptacle item9_baseball_bat_largeitem receptacle29_chair)
	(inreceptacle item66_remote_smallitem receptacle71_sink)
	(inreceptacle item11_bottle_smallitem receptacle6_bench)
	(inreceptacle item13_bottle_smallitem receptacle38_chair)
	(inreceptacle item10_bottle_smallitem receptacle39_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle77_refrigerator)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item57_clock_mediumitem receptacle41_dining_table)
	(inreceptacle item7_bowl_smallitem receptacle38_dining_table)
	(inreceptacle item44_tv_largeitem receptacle21_chair)
	(inreceptacle item59_vase_mediumitem receptacle46_oven)
	...
	(inreceptacle item6_bottle_smallitem receptacle54_refrigerator)
	(inreceptacle item56_clock_mediumitem receptacle22_couch)
	(inreceptacle item2_handbag_largeitem receptacle47_oven)
	(inreceptacle item1_handbag_largeitem receptacle41_dining_table)))
)

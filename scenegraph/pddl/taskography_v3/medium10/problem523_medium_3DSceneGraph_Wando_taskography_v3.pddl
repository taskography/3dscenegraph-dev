...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item1_remote_smallitem receptacle30_bed)
	(inreceptacle item16_tie_smallitem receptacle29_bed)
	(inreceptacle item13_vase_mediumitem receptacle3_sink)
	(inreceptacle item35_tv_largeitem receptacle2_oven)
	(inreceptacle item10_vase_mediumitem receptacle29_bed)

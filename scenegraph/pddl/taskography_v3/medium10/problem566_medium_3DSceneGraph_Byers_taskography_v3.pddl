...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg57_Yneg15_place2_room5_floorC)
	...
	(inplace agent place2_door_room5_closet)
  ...
  (:goal (and
	(inreceptacle item4_tie_smallitem receptacle20_couch)
	(inreceptacle item40_laptop_mediumitem receptacle26_dining_table)
	(inreceptacle item34_tv_largeitem receptacle16_chair)
	(inreceptacle item51_vase_mediumitem receptacle18_chair)
	(inreceptacle item52_vase_mediumitem receptacle14_chair)
	(inreceptacle item50_clock_mediumitem receptacle45_sink)
	(inreceptacle item7_suitcase_largeitem receptacle29_toilet)
	(inreceptacle item53_vase_mediumitem receptacle47_refrigerator)
	(inreceptacle item23_potted_plant_largeitem receptacle31_toilet)
	(inreceptacle item21_potted_plant_largeitem receptacle32_toilet)))
)

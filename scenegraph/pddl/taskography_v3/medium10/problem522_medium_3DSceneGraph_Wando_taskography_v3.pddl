...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg4_Yneg45_place2_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item27_potted_plant_largeitem receptacle29_bed)
	(inreceptacle item7_cup_smallitem receptacle24_chair)
	(inreceptacle item13_vase_mediumitem receptacle6_refrigerator)
	(inreceptacle item15_tie_smallitem receptacle26_couch)
	(inreceptacle item17_tie_smallitem receptacle2_oven)
	(inreceptacle item10_vase_mediumitem receptacle2_oven)
	(inreceptacle item35_tv_largeitem receptacle19_chair)
	(inreceptacle item1_remote_smallitem receptacle19_chair)
	(inreceptacle item8_bottle_smallitem receptacle31_bed)
	(inreceptacle item33_tv_largeitem receptacle19_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item2_handbag_largeitem receptacle34_bed)
	(inreceptacle item27_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item56_clock_mediumitem receptacle48_sink)
	...
	(inreceptacle item55_book_smallitem receptacle12_chair)
	(inreceptacle item26_potted_plant_largeitem receptacle11_chair)
	(inreceptacle item25_potted_plant_largeitem receptacle47_oven)))
)

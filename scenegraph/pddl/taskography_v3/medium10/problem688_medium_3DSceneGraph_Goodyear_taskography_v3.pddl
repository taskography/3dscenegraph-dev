...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg39_Ypos23_place4_room11_floorB)
	...
	(inplace agent place4_door_room11_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item43_potted_plant_largeitem receptacle59_dining_table)
	(inreceptacle item9_baseball_bat_largeitem receptacle27_chair)
	(inreceptacle item16_bowl_smallitem receptacle30_couch)
	(inreceptacle item79_vase_mediumitem receptacle27_chair)
	(inreceptacle item55_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item81_vase_mediumitem receptacle67_sink)
	(inreceptacle item8_kite_largeitem receptacle29_couch)
	(inreceptacle item37_potted_plant_largeitem receptacle58_bed)))
)

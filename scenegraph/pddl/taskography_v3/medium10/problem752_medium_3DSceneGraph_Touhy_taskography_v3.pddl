...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item87_vase_mediumitem receptacle33_chair)
	(inreceptacle item11_bottle_smallitem receptacle19_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item1_bicycle_largeitem receptacle30_chair)
	(inreceptacle item86_vase_mediumitem receptacle29_chair)
	(inreceptacle item80_book_smallitem receptacle76_sink)
	(inreceptacle item45_potted_plant_largeitem receptacle61_toilet)
	(inreceptacle item85_clock_mediumitem receptacle32_chair)
	(inreceptacle item9_bottle_smallitem receptacle72_sink)
	(inreceptacle item89_vase_mediumitem receptacle27_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos3_Yneg82_place0_room7_floorA)
	...
	(inplace agent place0_door_room7_exercise_room)
	...
	(inroom agent room7_exercise_room)
  ...
  (:goal (and
	(inreceptacle item33_cup_smallitem receptacle36_toilet)
	(inreceptacle item28_sports_ball_largeitem receptacle21_bench)
	(inreceptacle item3_bicycle_largeitem receptacle44_refrigerator)
	(inreceptacle item1_bicycle_largeitem receptacle35_chair)
	(inreceptacle item29_bottle_smallitem receptacle21_bench)
	(inreceptacle item9_bicycle_largeitem receptacle35_chair)
	(inreceptacle item45_book_smallitem receptacle19_bench)
	(inreceptacle item27_suitcase_largeitem receptacle36_toilet)
	(inreceptacle item13_bicycle_largeitem receptacle41_sink)

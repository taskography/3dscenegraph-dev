...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item57_potted_plant_largeitem receptacle51_couch)
	(inreceptacle item22_vase_mediumitem receptacle45_chair)
	(inreceptacle item3_laptop_mediumitem receptacle42_chair)
	(inreceptacle item28_vase_mediumitem receptacle35_toilet)
	(inreceptacle item29_vase_mediumitem receptacle6_sink)
	(inreceptacle item25_vase_mediumitem receptacle71_dining_table)
	(inreceptacle item26_vase_mediumitem receptacle35_toilet)
	(inreceptacle item20_vase_mediumitem receptacle43_chair)
	(inreceptacle item73_tv_largeitem receptacle36_chair)
	(inreceptacle item63_potted_plant_largeitem receptacle66_bed)))
)

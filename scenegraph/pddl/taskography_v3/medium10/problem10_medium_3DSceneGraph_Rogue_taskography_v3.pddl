...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg70_Ypos20_place2_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item4_sports_ball_largeitem receptacle65_refrigerator)
	(inreceptacle item69_clock_mediumitem receptacle2_bench)
	(inreceptacle item44_potted_plant_largeitem receptacle59_oven)
	(inreceptacle item75_vase_mediumitem receptacle18_chair)
	(inreceptacle item71_vase_mediumitem receptacle51_dining_table)
	(inreceptacle item37_potted_plant_largeitem receptacle15_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle64_refrigerator)
	(inreceptacle item42_potted_plant_largeitem receptacle47_bed)
	(inreceptacle item34_potted_plant_largeitem receptacle21_chair)
	(inreceptacle item13_orange_smallitem receptacle45_bed)))
)

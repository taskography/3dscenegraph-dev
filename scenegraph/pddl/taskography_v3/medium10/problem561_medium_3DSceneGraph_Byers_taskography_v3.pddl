...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item5_tie_smallitem receptacle17_chair)
	(inreceptacle item50_clock_mediumitem receptacle17_chair)
	(inreceptacle item52_vase_mediumitem receptacle32_toilet)
	(inreceptacle item38_laptop_mediumitem receptacle18_chair)
	...
	(inreceptacle item7_suitcase_largeitem receptacle13_chair)
	(inreceptacle item40_laptop_mediumitem receptacle14_chair)))
)

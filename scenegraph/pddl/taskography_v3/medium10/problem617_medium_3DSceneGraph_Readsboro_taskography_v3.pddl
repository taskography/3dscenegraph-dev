...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg70_Yneg83_place14_room17_floorB)
	...
	(inplace agent place14_door_room17_living_room)
  ...
  (:goal (and
	(inreceptacle item20_vase_mediumitem receptacle46_chair)
	(inreceptacle item73_tv_largeitem receptacle44_chair)
	(inreceptacle item15_book_smallitem receptacle49_chair)
	(inreceptacle item14_book_smallitem receptacle45_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle71_dining_table)
	(inreceptacle item28_vase_mediumitem receptacle45_chair)
	(inreceptacle item63_potted_plant_largeitem receptacle43_chair)
	(inreceptacle item29_vase_mediumitem receptacle4_oven)
	(inreceptacle item65_potted_plant_largeitem receptacle4_oven)
	(inreceptacle item16_cup_smallitem receptacle46_chair)))
)

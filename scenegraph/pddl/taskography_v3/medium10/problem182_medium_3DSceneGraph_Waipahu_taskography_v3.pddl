...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item9_bowl_smallitem receptacle10_chair)
	(inreceptacle item6_bottle_smallitem receptacle32_bed)
	(inreceptacle item58_clock_mediumitem receptacle24_couch)
	(inreceptacle item1_handbag_largeitem receptacle21_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle31_bed)
	(inreceptacle item5_bottle_smallitem receptacle38_dining_table)
	(inreceptacle item59_vase_mediumitem receptacle49_sink)
	(inreceptacle item2_handbag_largeitem receptacle17_chair)))
)

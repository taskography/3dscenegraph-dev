...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos62_Ypos44_place4_room12_floorA)
	...
	(inplace agent place4_door_room12_staircase)
  ...
  (:goal (and
	...
	(inreceptacle item2_tie_smallitem receptacle21_chair)
	(inreceptacle item3_tie_smallitem receptacle22_chair)
	(inreceptacle item70_book_smallitem receptacle31_chair)
	(inreceptacle item5_tie_smallitem receptacle66_refrigerator)
	(inreceptacle item11_bottle_smallitem receptacle68_refrigerator)
	(inreceptacle item4_tie_smallitem receptacle19_chair)
	(inreceptacle item75_clock_mediumitem receptacle46_bed)
	(inreceptacle item10_bottle_smallitem receptacle47_bed)
	(inreceptacle item72_book_smallitem receptacle67_refrigerator)))
)

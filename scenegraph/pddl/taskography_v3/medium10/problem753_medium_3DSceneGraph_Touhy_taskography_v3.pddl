...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg4_Ypos24_place3_room20_floorA)
	...
	(inplace agent place3_door_room20_utility_room)
  ...
  (:goal (and
	...
	(inreceptacle item84_clock_mediumitem receptacle20_chair)
	(inreceptacle item67_keyboard_largeitem receptacle17_chair)
	(inreceptacle item80_book_smallitem receptacle29_chair)
	(inreceptacle item62_tv_largeitem receptacle52_bed)
	(inreceptacle item11_bottle_smallitem receptacle34_chair)
	(inreceptacle item65_mouse_smallitem receptacle58_dining_table)
	(inreceptacle item9_bottle_smallitem receptacle32_chair)
	(inreceptacle item63_tv_largeitem receptacle49_bed)))
)

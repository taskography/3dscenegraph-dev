...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg27_Ypos4_place0_room13_floorA)
  ...
  (:goal (and
	(inreceptacle item81_clock_mediumitem receptacle60_toilet)
	(inreceptacle item13_bowl_smallitem receptacle78_refrigerator)
	(inreceptacle item93_vase_mediumitem receptacle71_sink)
	(inreceptacle item67_keyboard_largeitem receptacle22_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle78_refrigerator)
	(inreceptacle item92_vase_mediumitem receptacle29_chair)
	(inreceptacle item89_vase_mediumitem receptacle53_bed)
	(inreceptacle item14_bowl_smallitem receptacle68_oven)
	(inreceptacle item64_tv_largeitem receptacle73_sink)
	(inreceptacle item4_handbag_largeitem receptacle55_dining_table)))
)

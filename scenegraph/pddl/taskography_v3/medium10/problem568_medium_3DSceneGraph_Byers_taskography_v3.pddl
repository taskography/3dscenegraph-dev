...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos9_Ypos0_place0_room12_floorB)
	...
	(inplace agent place0_door_room12_living_room)
  ...
  (:goal (and
	(inreceptacle item4_tie_smallitem receptacle10_chair)
	(inreceptacle item49_book_smallitem receptacle46_sink)
	(inreceptacle item38_laptop_mediumitem receptacle28_dining_table)
	(inreceptacle item40_laptop_mediumitem receptacle43_oven)
	(inreceptacle item54_vase_mediumitem receptacle25_bed)
	(inreceptacle item51_vase_mediumitem receptacle41_microwave)
	(inreceptacle item34_tv_largeitem receptacle44_sink)
	(inreceptacle item3_tie_smallitem receptacle25_bed)
	(inreceptacle item21_potted_plant_largeitem receptacle16_chair)
	(inreceptacle item23_potted_plant_largeitem receptacle26_dining_table)))
)

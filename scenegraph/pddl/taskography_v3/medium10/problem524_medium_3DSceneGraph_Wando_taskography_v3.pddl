...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item33_tv_largeitem receptacle5_refrigerator)
	(inreceptacle item27_potted_plant_largeitem receptacle3_sink)
	(inreceptacle item14_tie_smallitem receptacle30_bed)
	(inreceptacle item17_tie_smallitem receptacle22_chair)
	(inreceptacle item11_vase_mediumitem receptacle24_chair)
	(inreceptacle item15_tie_smallitem receptacle30_bed)
	(inreceptacle item1_remote_smallitem receptacle21_chair)))
)

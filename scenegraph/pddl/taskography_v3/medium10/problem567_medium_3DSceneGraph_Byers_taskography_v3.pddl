...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg23_Ypos14_place6_room11_floorB)
	...
	(inplace agent place6_door_room11_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item7_suitcase_largeitem receptacle19_couch)
	(inreceptacle item8_spoon_smallitem receptacle44_sink)
	(inreceptacle item37_tv_largeitem receptacle32_toilet)
	(inreceptacle item23_potted_plant_largeitem receptacle28_dining_table)
	(inreceptacle item22_potted_plant_largeitem receptacle32_toilet)

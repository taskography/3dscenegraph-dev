...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg51_Yneg4_place7_room6_floorC)
	...
	(inplace agent place7_door_room6_closet)
  ...
  (:goal (and
	...
	(inreceptacle item79_vase_mediumitem receptacle20_chair)
	(inreceptacle item9_cup_smallitem receptacle22_chair)
	(inreceptacle item5_surfboard_largeitem receptacle47_bed)
	(inreceptacle item35_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item67_book_smallitem receptacle15_chair)
	(inreceptacle item11_bowl_smallitem receptacle15_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle46_bed)
	(inreceptacle item12_bowl_smallitem receptacle65_refrigerator)
	(inreceptacle item72_vase_mediumitem receptacle50_dining_table)))
)

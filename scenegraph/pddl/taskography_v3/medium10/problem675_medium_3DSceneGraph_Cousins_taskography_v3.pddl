...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item79_potted_plant_largeitem receptacle51_couch)
	(inreceptacle item64_potted_plant_largeitem receptacle51_couch)
	(inreceptacle item126_book_smallitem receptacle41_chair)
	(inreceptacle item70_potted_plant_largeitem receptacle33_chair)
	(inreceptacle item81_potted_plant_largeitem receptacle50_couch)
	(inreceptacle item89_potted_plant_largeitem receptacle109_sink)
	...
	(inreceptacle item133_vase_mediumitem receptacle40_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg28_Ypos22_place10_room4_floorC)
  ...
  (:goal (and
	(inreceptacle item43_potted_plant_largeitem receptacle62_dining_table)
	(inreceptacle item39_potted_plant_largeitem receptacle1_boat)
	(inreceptacle item18_cake_mediumitem receptacle27_chair)
	(inreceptacle item51_potted_plant_largeitem receptacle4_bench)
	(inreceptacle item45_potted_plant_largeitem receptacle68_sink)
	(inreceptacle item72_clock_mediumitem receptacle59_dining_table)
	(inreceptacle item12_bottle_smallitem receptacle57_bed)
	(inreceptacle item81_vase_mediumitem receptacle60_dining_table)
	(inreceptacle item42_potted_plant_largeitem receptacle65_oven)

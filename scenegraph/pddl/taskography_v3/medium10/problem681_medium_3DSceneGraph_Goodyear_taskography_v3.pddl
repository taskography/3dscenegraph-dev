...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg57_Yneg37_place12_room17_floorA)
	...
	(inplace agent place12_door_room17_utility_room)
  ...
  (:goal (and
	...
	(inreceptacle item55_potted_plant_largeitem receptacle2_boat)
	(inreceptacle item47_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item17_bowl_smallitem receptacle27_chair)
	(inreceptacle item81_vase_mediumitem receptacle23_chair)
	(inreceptacle item45_potted_plant_largeitem receptacle29_couch)
	(inreceptacle item71_book_smallitem receptacle61_dining_table)
	(inreceptacle item12_bottle_smallitem receptacle25_chair)
	(inreceptacle item78_vase_mediumitem receptacle28_chair)
	(inreceptacle item73_clock_mediumitem receptacle64_microwave)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item54_potted_plant_largeitem receptacle57_bed)
	...
	(inreceptacle item73_clock_mediumitem receptacle63_toilet)
	(inreceptacle item77_vase_mediumitem receptacle26_chair)
	(inreceptacle item9_baseball_bat_largeitem receptacle5_bench)

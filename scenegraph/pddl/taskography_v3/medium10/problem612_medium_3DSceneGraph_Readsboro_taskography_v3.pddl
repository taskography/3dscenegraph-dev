...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item1_laptop_mediumitem receptacle6_sink)
	(inreceptacle item18_cup_smallitem receptacle9_sink)
	(inreceptacle item15_book_smallitem receptacle51_couch)
	(inreceptacle item29_vase_mediumitem receptacle54_couch)
	(inreceptacle item28_vase_mediumitem receptacle7_sink)
	(inreceptacle item19_vase_mediumitem receptacle4_oven)
	(inreceptacle item64_potted_plant_largeitem receptacle9_sink)
	(inreceptacle item16_cup_smallitem receptacle56_couch)
	(inreceptacle item21_vase_mediumitem receptacle4_oven)
	(inreceptacle item61_potted_plant_largeitem receptacle36_chair)))
)

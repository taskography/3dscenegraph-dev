...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item19_clock_mediumitem receptacle8_sink)
	(inreceptacle item3_surfboard_largeitem receptacle4_sink)
	(inreceptacle item20_clock_mediumitem receptacle8_sink)
	(inreceptacle item29_umbrella_largeitem receptacle2_oven)
	(inreceptacle item24_tie_smallitem receptacle8_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item4_bottle_smallitem receptacle33_bed)
	(inreceptacle item2_umbrella_largeitem receptacle34_bed)
	(inreceptacle item60_vase_mediumitem receptacle19_chair)
	(inreceptacle item7_cup_smallitem receptacle39_dining_table)
	(inreceptacle item63_vase_mediumitem receptacle37_dining_table)
	(inreceptacle item66_vase_mediumitem receptacle32_bed)
	(inreceptacle item69_toothbrush_smallitem receptacle47_oven)
	(inreceptacle item59_vase_mediumitem receptacle34_bed)
	(inreceptacle item30_potted_plant_largeitem receptacle47_oven)
	(inreceptacle item64_vase_mediumitem receptacle39_dining_table)))
)

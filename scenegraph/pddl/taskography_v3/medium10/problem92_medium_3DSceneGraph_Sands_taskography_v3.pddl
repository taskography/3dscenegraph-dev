...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos47_Yneg3_place5_room2_floorB)
  ...
  (:goal (and
	(inreceptacle item19_frisbee_mediumitem receptacle13_refrigerator)
	(inreceptacle item16_bottle_smallitem receptacle8_sink)
	(inreceptacle item27_potted_plant_largeitem receptacle6_sink)
	(inreceptacle item4_surfboard_largeitem receptacle8_sink)
	(inreceptacle item17_bottle_smallitem receptacle14_refrigerator)
	(inreceptacle item25_potted_plant_largeitem receptacle10_sink)
	(inreceptacle item26_potted_plant_largeitem receptacle2_oven)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg42_Yneg14_place7_room13_floorA)
	...
	(inplace agent place7_door_room13_staircase)
  ...
  (:goal (and
	(inreceptacle item53_vase_mediumitem receptacle43_oven)
	(inreceptacle item5_tie_smallitem receptacle16_chair)
	(inreceptacle item54_vase_mediumitem receptacle15_chair)
	(inreceptacle item8_spoon_smallitem receptacle42_oven)
	(inreceptacle item56_vase_mediumitem receptacle46_sink)
	(inreceptacle item35_tv_largeitem receptacle14_chair)
	(inreceptacle item9_spoon_smallitem receptacle15_chair)
	(inreceptacle item39_laptop_mediumitem receptacle11_chair)
	(inreceptacle item6_tie_smallitem receptacle16_chair)

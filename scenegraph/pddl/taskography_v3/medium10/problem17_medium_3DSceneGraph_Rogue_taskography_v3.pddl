...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg32_Ypos4_place6_room8_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item82_teddy_bear_mediumitem receptacle57_microwave)
	(inreceptacle item74_vase_mediumitem receptacle49_dining_table)
	(inreceptacle item69_clock_mediumitem receptacle22_chair)
	(inreceptacle item79_vase_mediumitem receptacle54_toilet)
	(inreceptacle item39_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item77_vase_mediumitem receptacle17_chair)
	(inreceptacle item11_bowl_smallitem receptacle18_chair)
	(inreceptacle item78_vase_mediumitem receptacle25_couch)
	(inreceptacle item75_vase_mediumitem receptacle27_couch)))
)

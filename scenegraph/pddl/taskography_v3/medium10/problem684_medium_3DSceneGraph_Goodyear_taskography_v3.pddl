...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item73_clock_mediumitem receptacle66_sink)
	(inreceptacle item51_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle70_refrigerator)
	(inreceptacle item17_bowl_smallitem receptacle23_chair)
	(inreceptacle item7_suitcase_largeitem receptacle65_oven)
	(inreceptacle item49_potted_plant_largeitem receptacle64_microwave)
	(inreceptacle item81_vase_mediumitem receptacle1_boat)
	(inreceptacle item55_potted_plant_largeitem receptacle1_boat)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos90_Ypos44_place3_room9_floorA)
	...
	(inplace agent place3_door_room9_kitchen)
  ...
  (:goal (and
	(inreceptacle item39_potted_plant_largeitem receptacle54_toilet)
	(inreceptacle item11_bottle_smallitem receptacle67_refrigerator)
	(inreceptacle item2_tie_smallitem receptacle26_chair)
	(inreceptacle item57_tv_largeitem receptacle31_chair)
	(inreceptacle item36_potted_plant_largeitem receptacle68_refrigerator)
	(inreceptacle item17_banana_smallitem receptacle47_bed)
	(inreceptacle item75_clock_mediumitem receptacle45_bed)
	(inreceptacle item3_tie_smallitem receptacle51_bed)
	(inreceptacle item77_teddy_bear_mediumitem receptacle61_oven)
	(inreceptacle item7_baseball_bat_largeitem receptacle21_chair)))
)

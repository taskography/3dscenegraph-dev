...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item4_bottle_smallitem receptacle49_sink)
	(inreceptacle item63_vase_mediumitem receptacle11_chair)
	(inreceptacle item68_vase_mediumitem receptacle37_dining_table)
	(inreceptacle item66_vase_mediumitem receptacle53_sink)
	(inreceptacle item59_vase_mediumitem receptacle15_chair)
	(inreceptacle item60_vase_mediumitem receptacle18_chair)
	(inreceptacle item58_book_smallitem receptacle33_bed)
	(inreceptacle item55_book_smallitem receptacle50_sink)

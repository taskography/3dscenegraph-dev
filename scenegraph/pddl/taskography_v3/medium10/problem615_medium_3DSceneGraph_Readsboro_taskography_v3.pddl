...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg50_Yneg29_place0_room13_floorC)
	...
	(inplace agent place0_door_room13_empty_room)
  ...
  (:goal (and
	...
	(inreceptacle item16_cup_smallitem receptacle31_toilet)
	(inreceptacle item63_potted_plant_largeitem receptacle8_sink)
	(inreceptacle item18_cup_smallitem receptacle46_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle4_oven)
	(inreceptacle item19_vase_mediumitem receptacle55_couch)
	(inreceptacle item17_cup_smallitem receptacle53_couch)
	(inreceptacle item25_vase_mediumitem receptacle36_chair)
	(inreceptacle item73_tv_largeitem receptacle7_sink)))
)

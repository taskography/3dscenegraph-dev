...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item70_toothbrush_smallitem receptacle22_couch)
	(inreceptacle item2_umbrella_largeitem receptacle36_dining_table)
	(inreceptacle item8_bowl_smallitem receptacle41_dining_table)
	(inreceptacle item27_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item69_toothbrush_smallitem receptacle14_chair)
	(inreceptacle item62_vase_mediumitem receptacle39_dining_table)
	(inreceptacle item59_vase_mediumitem receptacle48_sink)
	(inreceptacle item60_vase_mediumitem receptacle51_sink)
	(inreceptacle item5_bottle_smallitem receptacle39_dining_table)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg43_Yneg7_place6_room15_floorB)
	...
	(inplace agent place6_door_room15_staircase)
  ...
  (:goal (and
	(inreceptacle item9_baseball_bat_largeitem receptacle30_couch)
	(inreceptacle item6_umbrella_largeitem receptacle57_bed)
	(inreceptacle item33_potted_plant_largeitem receptacle62_dining_table)
	(inreceptacle item45_potted_plant_largeitem receptacle57_bed)
	(inreceptacle item49_potted_plant_largeitem receptacle23_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle65_oven)
	(inreceptacle item40_potted_plant_largeitem receptacle2_boat)
	(inreceptacle item75_vase_mediumitem receptacle63_toilet)
	(inreceptacle item78_vase_mediumitem receptacle57_bed)
	(inreceptacle item77_vase_mediumitem receptacle70_refrigerator)))
)

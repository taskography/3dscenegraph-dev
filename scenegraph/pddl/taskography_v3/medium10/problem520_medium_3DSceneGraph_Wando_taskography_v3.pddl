...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg45_Yneg27_place5_room5_floorA)
	...
	(inplace agent place5_door_room5_closet)
  ...
  (:goal (and
	(inreceptacle item27_potted_plant_largeitem receptacle6_refrigerator)
	(inreceptacle item8_bottle_smallitem receptacle24_chair)
	(inreceptacle item1_remote_smallitem receptacle29_bed)
	(inreceptacle item33_tv_largeitem receptacle4_sink)
	(inreceptacle item35_tv_largeitem receptacle20_chair)
	(inreceptacle item11_vase_mediumitem receptacle20_chair)
	(inreceptacle item34_tv_largeitem receptacle25_chair)
	(inreceptacle item14_tie_smallitem receptacle3_sink)

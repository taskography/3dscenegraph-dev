...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg54_Yneg2_place0_room8_floorC)
  ...
  (:goal (and
	(inreceptacle item61_vase_mediumitem receptacle20_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle54_refrigerator)
	(inreceptacle item57_book_smallitem receptacle53_sink)
	...
	(inreceptacle item69_toothbrush_smallitem receptacle53_sink)
	(inreceptacle item68_vase_mediumitem receptacle35_dining_table)
	(inreceptacle item63_vase_mediumitem receptacle12_chair)
	(inreceptacle item4_bottle_smallitem receptacle50_sink)

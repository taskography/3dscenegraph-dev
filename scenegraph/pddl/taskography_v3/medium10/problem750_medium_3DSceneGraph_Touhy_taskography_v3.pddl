...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg62_Ypos76_place14_room3_floorB)
  ...
  (:goal (and
	(inreceptacle item15_banana_smallitem receptacle51_bed)
	(inreceptacle item1_bicycle_largeitem receptacle18_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle37_couch)
	(inreceptacle item14_bowl_smallitem receptacle51_bed)
	(inreceptacle item92_vase_mediumitem receptacle72_sink)
	(inreceptacle item63_tv_largeitem receptacle2_bench)
	(inreceptacle item13_bowl_smallitem receptacle36_couch)
	(inreceptacle item6_tie_smallitem receptacle34_chair)
	(inreceptacle item85_clock_mediumitem receptacle35_chair)
	(inreceptacle item48_potted_plant_largeitem receptacle76_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg32_Ypos2_place12_room17_floorB)
	...
	(inplace agent place12_door_room17_staircase)
  ...
  (:goal (and
	(inreceptacle item66_vase_mediumitem receptacle33_bed)
	(inreceptacle item57_book_smallitem receptacle16_chair)
	(inreceptacle item10_apple_smallitem receptacle53_sink)
	(inreceptacle item6_cup_smallitem receptacle49_sink)
	(inreceptacle item60_vase_mediumitem receptacle51_sink)
	(inreceptacle item31_potted_plant_largeitem receptacle35_dining_table)
	(inreceptacle item65_vase_mediumitem receptacle16_chair)
	(inreceptacle item5_bottle_smallitem receptacle22_couch)

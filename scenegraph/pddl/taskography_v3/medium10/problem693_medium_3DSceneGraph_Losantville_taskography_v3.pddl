...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg10_Yneg19_place14_room7_floorA)
  ...
  (:goal (and
	(inreceptacle item66_remote_smallitem receptacle7_bench)
	(inreceptacle item13_bottle_smallitem receptacle56_bed)
	(inreceptacle item16_bowl_smallitem receptacle33_chair)
	(inreceptacle item9_baseball_bat_largeitem receptacle70_sink)
	(inreceptacle item64_tv_largeitem receptacle35_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle23_chair)
	(inreceptacle item15_cup_smallitem receptacle55_bed)
	(inreceptacle item80_teddy_bear_mediumitem receptacle45_couch)
	(inreceptacle item79_vase_mediumitem receptacle34_chair)

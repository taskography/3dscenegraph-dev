...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg14_Ypos31_place12_room4_floorA)
  ...
  (:goal (and
	(inreceptacle item69_clock_mediumitem receptacle18_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle2_bench)
	(inreceptacle item78_vase_mediumitem receptacle25_couch)
	(inreceptacle item36_potted_plant_largeitem receptacle51_dining_table)
	(inreceptacle item81_vase_mediumitem receptacle23_chair)
	(inreceptacle item76_vase_mediumitem receptacle45_bed)
	(inreceptacle item12_bowl_smallitem receptacle27_couch)
	(inreceptacle item37_potted_plant_largeitem receptacle58_oven)
	(inreceptacle item42_potted_plant_largeitem receptacle54_toilet)
	(inreceptacle item44_potted_plant_largeitem receptacle56_toilet)))
)

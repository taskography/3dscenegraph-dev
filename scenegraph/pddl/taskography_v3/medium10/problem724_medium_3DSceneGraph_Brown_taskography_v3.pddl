...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg69_Ypos0_place0_room26_floorD)
	...
	(inplace agent place0_door_room26_empty_room)
	...
	(inroom agent room26_empty_room)
  ...
  (:goal (and
	(inreceptacle item45_potted_plant_largeitem receptacle30_bench)
	(inreceptacle item28_clock_mediumitem receptacle48_bed)
	(inreceptacle item17_bottle_smallitem receptacle32_bench)
	(inreceptacle item1_baseball_bat_largeitem receptacle9_sink)
	(inreceptacle item22_clock_mediumitem receptacle15_refrigerator)
	(inreceptacle item25_clock_mediumitem receptacle41_chair)
	(inreceptacle item51_tv_largeitem receptacle9_sink)
	(inreceptacle item19_bottle_smallitem receptacle48_bed)
	(inreceptacle item20_bottle_smallitem receptacle36_toilet)
	(inreceptacle item24_clock_mediumitem receptacle12_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item9_bowl_smallitem receptacle35_bed)
	(inreceptacle item56_clock_mediumitem receptacle31_bed)
	...
	(inreceptacle item8_bowl_smallitem receptacle48_sink)
	(inreceptacle item44_tv_largeitem receptacle11_chair)

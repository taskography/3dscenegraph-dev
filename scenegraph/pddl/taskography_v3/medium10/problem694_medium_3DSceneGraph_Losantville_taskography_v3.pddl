...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item65_remote_smallitem receptacle8_bench)
	(inreceptacle item79_vase_mediumitem receptacle2_bench)
	(inreceptacle item12_bottle_smallitem receptacle17_chair)
	(inreceptacle item11_bottle_smallitem receptacle67_microwave)
	(inreceptacle item15_cup_smallitem receptacle57_bed)
	(inreceptacle item13_bottle_smallitem receptacle71_sink)
	(inreceptacle item10_bottle_smallitem receptacle8_bench)
	(inreceptacle item49_potted_plant_largeitem receptacle63_toilet)
	(inreceptacle item66_remote_smallitem receptacle46_couch)
	(inreceptacle item80_teddy_bear_mediumitem receptacle60_dining_table)))
)

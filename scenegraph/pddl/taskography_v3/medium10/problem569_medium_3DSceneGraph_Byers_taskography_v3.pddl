...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg7_Yneg8_place11_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item40_laptop_mediumitem receptacle44_sink)
	(inreceptacle item24_potted_plant_largeitem receptacle47_refrigerator)
	(inreceptacle item6_tie_smallitem receptacle11_chair)
	(inreceptacle item34_tv_largeitem receptacle41_microwave)
	(inreceptacle item22_potted_plant_largeitem receptacle48_refrigerator)
	(inreceptacle item55_vase_mediumitem receptacle32_toilet)
	(inreceptacle item51_vase_mediumitem receptacle29_toilet)
	(inreceptacle item4_tie_smallitem receptacle16_chair)
	(inreceptacle item50_clock_mediumitem receptacle42_oven)
	(inreceptacle item7_suitcase_largeitem receptacle25_bed)))
)

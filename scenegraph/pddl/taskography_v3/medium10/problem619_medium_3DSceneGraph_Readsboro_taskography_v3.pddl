...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg56_Ypos28_place13_room12_floorB)
	...
	(inplace agent place13_door_room12_dining_room)
  ...
  (:goal (and
	(inreceptacle item21_vase_mediumitem receptacle70_dining_table)
	(inreceptacle item3_laptop_mediumitem receptacle51_couch)
	(inreceptacle item63_potted_plant_largeitem receptacle44_chair)
	(inreceptacle item26_vase_mediumitem receptacle56_couch)
	(inreceptacle item2_laptop_mediumitem receptacle56_couch)
	(inreceptacle item18_cup_smallitem receptacle56_couch)
	(inreceptacle item61_potted_plant_largeitem receptacle40_chair)
	(inreceptacle item65_potted_plant_largeitem receptacle66_bed)
	(inreceptacle item29_vase_mediumitem receptacle49_chair)
	(inreceptacle item23_vase_mediumitem receptacle67_bed)))
)

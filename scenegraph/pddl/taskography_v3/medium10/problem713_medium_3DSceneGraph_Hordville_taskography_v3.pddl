...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg36_Yneg10_place5_room10_floorB)
	...
	(inplace agent place5_door_room10_corridor)
  ...
  (:goal (and
	(inreceptacle item7_cup_smallitem receptacle43_toilet)
	(inreceptacle item9_bowl_smallitem receptacle48_sink)
	(inreceptacle item4_bottle_smallitem receptacle22_couch)
	(inreceptacle item70_toothbrush_smallitem receptacle38_dining_table)
	(inreceptacle item2_umbrella_largeitem receptacle51_sink)
	(inreceptacle item65_vase_mediumitem receptacle24_couch)
	(inreceptacle item6_cup_smallitem receptacle24_couch)
	(inreceptacle item3_bottle_smallitem receptacle47_oven)
	(inreceptacle item45_tv_largeitem receptacle47_oven)
	(inreceptacle item30_potted_plant_largeitem receptacle52_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item35_tv_largeitem receptacle16_chair)
	(inreceptacle item39_laptop_mediumitem receptacle15_chair)
	(inreceptacle item56_vase_mediumitem receptacle44_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg68_Yneg35_place12_room13_floorA)
	...
	(inplace agent place12_door_room13_dining_room)
  ...
  (:goal (and
	(inreceptacle item84_potted_plant_largeitem receptacle50_couch)
	(inreceptacle item56_potted_plant_largeitem receptacle48_couch)
	(inreceptacle item22_apple_smallitem receptacle92_bed)
	(inreceptacle item70_potted_plant_largeitem receptacle95_bed)
	(inreceptacle item20_bowl_smallitem receptacle91_bed)
	(inreceptacle item19_bowl_smallitem receptacle36_chair)
	(inreceptacle item67_potted_plant_largeitem receptacle114_sink)
	(inreceptacle item74_potted_plant_largeitem receptacle96_bed)
	(inreceptacle item118_book_smallitem receptacle49_couch)
	(inreceptacle item69_potted_plant_largeitem receptacle110_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg5_Ypos0_place15_room10_floorC)
	...
	(inplace agent place15_door_room10_bedroom)
  ...
  (:goal (and
	(inreceptacle item9_baseball_bat_largeitem receptacle30_chair)
	(inreceptacle item12_bottle_smallitem receptacle78_refrigerator)
	(inreceptacle item13_bottle_smallitem receptacle62_toilet)
	(inreceptacle item16_bowl_smallitem receptacle30_chair)
	(inreceptacle item14_cup_smallitem receptacle61_toilet)
	(inreceptacle item64_tv_largeitem receptacle17_chair)
	(inreceptacle item15_cup_smallitem receptacle44_couch)
	(inreceptacle item65_remote_smallitem receptacle38_chair)
	(inreceptacle item11_bottle_smallitem receptacle27_chair)
	(inreceptacle item80_teddy_bear_mediumitem receptacle35_chair)))
)

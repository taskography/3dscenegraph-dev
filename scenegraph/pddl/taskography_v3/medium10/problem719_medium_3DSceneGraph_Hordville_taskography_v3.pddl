...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg24_Yneg39_place6_room12_floorB)
	...
	(inplace agent place6_door_room12_dining_room)
  ...
  (:goal (and
	(inreceptacle item63_vase_mediumitem receptacle47_oven)
	(inreceptacle item57_book_smallitem receptacle22_couch)
	(inreceptacle item31_potted_plant_largeitem receptacle33_bed)
	(inreceptacle item67_vase_mediumitem receptacle17_chair)
	(inreceptacle item2_umbrella_largeitem receptacle15_chair)
	(inreceptacle item4_bottle_smallitem receptacle19_chair)
	(inreceptacle item1_umbrella_largeitem receptacle34_bed)
	(inreceptacle item61_vase_mediumitem receptacle46_microwave)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg80_Ypos38_place11_room19_floorA)
	...
	(inplace agent place11_door_room19_staircase)
  ...
  (:goal (and
	...
	(inreceptacle item3_surfboard_largeitem receptacle34_bed)
	(inreceptacle item19_clock_mediumitem receptacle9_sink)
	(inreceptacle item18_bottle_smallitem receptacle21_bench)
	(inreceptacle item24_tie_smallitem receptacle36_bed)
	(inreceptacle item30_umbrella_largeitem receptacle36_bed)
	(inreceptacle item16_bottle_smallitem receptacle33_bed)
	(inreceptacle item31_umbrella_largeitem receptacle34_bed)
	(inreceptacle item29_umbrella_largeitem receptacle21_bench)
	(inreceptacle item20_clock_mediumitem receptacle1_microwave)))
)

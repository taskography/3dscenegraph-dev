...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos116_place2_room16_floorA)
	...
	(inplace agent place2_door_room16_living_room)
  ...
  (:goal (and
	(inreceptacle item82_clock_mediumitem receptacle2_bench)
	(inreceptacle item86_vase_mediumitem receptacle23_chair)
	(inreceptacle item93_vase_mediumitem receptacle55_dining_table)
	(inreceptacle item47_potted_plant_largeitem receptacle27_chair)
	(inreceptacle item9_bottle_smallitem receptacle18_chair)
	...
	(inreceptacle item4_handbag_largeitem receptacle69_oven)
	(inreceptacle item87_vase_mediumitem receptacle61_toilet)))
)

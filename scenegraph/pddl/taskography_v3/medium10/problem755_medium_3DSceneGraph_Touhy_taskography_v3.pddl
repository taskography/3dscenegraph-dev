...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item66_keyboard_largeitem receptacle71_sink)
	(inreceptacle item91_vase_mediumitem receptacle31_chair)
	(inreceptacle item85_clock_mediumitem receptacle51_bed)
	(inreceptacle item65_mouse_smallitem receptacle78_refrigerator)
	(inreceptacle item47_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item64_tv_largeitem receptacle70_oven)
	(inreceptacle item15_banana_smallitem receptacle22_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item42_potted_plant_largeitem receptacle61_toilet)
	(inreceptacle item8_bottle_smallitem receptacle78_refrigerator)))
)

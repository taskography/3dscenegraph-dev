...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg61_Yneg32_place4_room4_floorA)
  ...
  (:goal (and
	(inreceptacle item68_vase_mediumitem receptacle41_dining_table)
	...
	(inreceptacle item66_vase_mediumitem receptacle46_microwave)
	(inreceptacle item64_vase_mediumitem receptacle53_sink)
	(inreceptacle item62_vase_mediumitem receptacle50_sink)
	(inreceptacle item58_book_smallitem receptacle12_chair)
	(inreceptacle item60_vase_mediumitem receptacle11_chair)

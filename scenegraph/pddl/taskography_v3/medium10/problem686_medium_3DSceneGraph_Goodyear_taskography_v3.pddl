...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos0_Ypos23_place2_room8_floorB)
	...
	(inplace agent place2_door_room8_dining_room)
  ...
  (:goal (and
	(inreceptacle item38_potted_plant_largeitem receptacle1_boat)
	(inreceptacle item78_vase_mediumitem receptacle69_sink)
	(inreceptacle item9_baseball_bat_largeitem receptacle25_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle56_bed)
	(inreceptacle item52_potted_plant_largeitem receptacle57_bed)
	(inreceptacle item72_clock_mediumitem receptacle26_chair)
	(inreceptacle item6_umbrella_largeitem receptacle60_dining_table)
	(inreceptacle item13_cup_smallitem receptacle20_chair)
	(inreceptacle item75_vase_mediumitem receptacle60_dining_table)
	(inreceptacle item81_vase_mediumitem receptacle3_bench)))
)

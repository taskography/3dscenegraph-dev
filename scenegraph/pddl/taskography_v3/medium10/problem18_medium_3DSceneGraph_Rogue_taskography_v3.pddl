...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item42_potted_plant_largeitem receptacle57_microwave)
	(inreceptacle item4_sports_ball_largeitem receptacle18_chair)
	(inreceptacle item10_knife_smallitem receptacle53_dining_table)
	(inreceptacle item43_potted_plant_largeitem receptacle27_couch)
	(inreceptacle item74_vase_mediumitem receptacle46_bed)
	(inreceptacle item72_vase_mediumitem receptacle57_microwave)
	(inreceptacle item36_potted_plant_largeitem receptacle25_couch)
	(inreceptacle item67_book_smallitem receptacle20_chair)
	(inreceptacle item70_vase_mediumitem receptacle17_chair)
	(inreceptacle item31_potted_plant_largeitem receptacle14_chair)))
)

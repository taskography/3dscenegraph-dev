...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos3_Ypos1_place9_room20_floorA)
	...
	(inplace agent place9_door_room20_storage)
  ...
  (:goal (and
	(inreceptacle item24_tie_smallitem receptacle23_bench)
	...
	(inreceptacle item31_umbrella_largeitem receptacle21_bench)
	(inreceptacle item30_umbrella_largeitem receptacle8_sink)
	(inreceptacle item3_surfboard_largeitem receptacle7_sink)
	(inreceptacle item17_bottle_smallitem receptacle34_bed)
	(inreceptacle item29_umbrella_largeitem receptacle34_bed)
	(inreceptacle item19_clock_mediumitem receptacle12_refrigerator)))
)

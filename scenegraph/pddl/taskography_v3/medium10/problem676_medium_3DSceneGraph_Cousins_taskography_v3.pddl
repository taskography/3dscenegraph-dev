...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos0_Yneg60_place3_room16_floorA)
	...
	(inplace agent place3_door_room16_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item78_potted_plant_largeitem receptacle99_toilet)
	(inreceptacle item103_tv_largeitem receptacle97_dining_table)
	(inreceptacle item69_potted_plant_largeitem receptacle28_chair)
	(inreceptacle item125_book_smallitem receptacle92_bed)
	(inreceptacle item23_apple_smallitem receptacle33_chair)
	(inreceptacle item102_tv_largeitem receptacle105_oven)
	(inreceptacle item22_apple_smallitem receptacle43_chair)
	(inreceptacle item59_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item3_tie_smallitem receptacle116_refrigerator)))
)

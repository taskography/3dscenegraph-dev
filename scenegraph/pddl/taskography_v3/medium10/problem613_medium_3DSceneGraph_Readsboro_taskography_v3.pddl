...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg2_Yneg53_place4_room2_floorB)
  ...
  (:goal (and
	(inreceptacle item28_vase_mediumitem receptacle66_bed)
	(inreceptacle item1_laptop_mediumitem receptacle71_dining_table)
	(inreceptacle item21_vase_mediumitem receptacle55_couch)
	(inreceptacle item57_potted_plant_largeitem receptacle66_bed)
	(inreceptacle item15_book_smallitem receptacle43_chair)
	(inreceptacle item65_potted_plant_largeitem receptacle36_chair)
	(inreceptacle item13_book_smallitem receptacle6_sink)
	(inreceptacle item73_tv_largeitem receptacle5_oven)

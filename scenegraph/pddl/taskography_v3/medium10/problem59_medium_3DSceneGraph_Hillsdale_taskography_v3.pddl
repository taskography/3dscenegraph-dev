...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item2_handbag_largeitem receptacle14_chair)
	(inreceptacle item22_potted_plant_largeitem receptacle24_dining_table)
	(inreceptacle item20_potted_plant_largeitem receptacle35_sink)
	(inreceptacle item4_bottle_smallitem receptacle19_couch)
	(inreceptacle item41_book_smallitem receptacle33_sink)
	(inreceptacle item12_spoon_smallitem receptacle33_sink)
	(inreceptacle item27_laptop_mediumitem receptacle26_toilet)
	(inreceptacle item1_handbag_largeitem receptacle29_oven)
	(inreceptacle item42_vase_mediumitem receptacle24_dining_table)))
)

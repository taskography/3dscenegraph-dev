...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg54_Ypos7_place3_room9_floorB)
	...
	(inplace agent place3_door_room9_home_office)
  ...
  (:goal (and
	(inreceptacle item8_bottle_smallitem receptacle37_refrigerator)
	(inreceptacle item7_bottle_smallitem receptacle24_dining_table)
	(inreceptacle item10_cup_smallitem receptacle16_chair)
	(inreceptacle item1_handbag_largeitem receptacle35_sink)
	(inreceptacle item39_book_smallitem receptacle28_microwave)
	(inreceptacle item38_book_smallitem receptacle23_bed)
	(inreceptacle item21_potted_plant_largeitem receptacle34_sink)
	(inreceptacle item2_handbag_largeitem receptacle25_toilet)
	(inreceptacle item27_laptop_mediumitem receptacle23_bed)
	(inreceptacle item43_vase_mediumitem receptacle23_bed)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg62_Ypos8_place15_room6_floorB)
  ...
  (:goal (and
	(inreceptacle item4_handbag_largeitem receptacle54_dining_table)
	(inreceptacle item93_vase_mediumitem receptacle77_sink)
	(inreceptacle item86_vase_mediumitem receptacle2_bench)
	(inreceptacle item5_tie_smallitem receptacle59_toilet)
	(inreceptacle item41_potted_plant_largeitem receptacle31_chair)
	(inreceptacle item62_tv_largeitem receptacle17_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle3_bench)
	(inreceptacle item89_vase_mediumitem receptacle33_chair)
	(inreceptacle item12_bottle_smallitem receptacle59_toilet)

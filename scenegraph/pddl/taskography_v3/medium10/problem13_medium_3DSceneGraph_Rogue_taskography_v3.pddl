...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item74_vase_mediumitem receptacle2_bench)
	(inreceptacle item79_vase_mediumitem receptacle2_bench)
	(inreceptacle item9_cup_smallitem receptacle63_sink)
	(inreceptacle item12_bowl_smallitem receptacle19_chair)
	(inreceptacle item4_sports_ball_largeitem receptacle20_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle25_couch)
	(inreceptacle item44_potted_plant_largeitem receptacle49_dining_table)
	(inreceptacle item38_potted_plant_largeitem receptacle47_bed)
	(inreceptacle item78_vase_mediumitem receptacle24_chair)

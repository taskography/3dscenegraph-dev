...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg55_Yneg10_place4_room4_floorC)
  ...
  (:goal (and
	(inreceptacle item21_clock_mediumitem receptacle8_sink)
	(inreceptacle item19_bottle_smallitem receptacle16_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle8_sink)
	(inreceptacle item45_potted_plant_largeitem receptacle37_toilet)
	(inreceptacle item1_baseball_bat_largeitem receptacle32_bench)
	(inreceptacle item51_tv_largeitem receptacle41_chair)
	(inreceptacle item17_bottle_smallitem receptacle34_toilet)
	(inreceptacle item23_clock_mediumitem receptacle10_sink)
	(inreceptacle item28_clock_mediumitem receptacle4_oven)

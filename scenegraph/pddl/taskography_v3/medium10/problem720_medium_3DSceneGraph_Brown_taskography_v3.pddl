...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item24_clock_mediumitem receptacle2_microwave)
	(inreceptacle item47_potted_plant_largeitem receptacle12_sink)
	(inreceptacle item25_clock_mediumitem receptacle8_sink)
	(inreceptacle item23_clock_mediumitem receptacle7_sink)
	(inreceptacle item33_bowl_smallitem receptacle32_bench)
	(inreceptacle item27_clock_mediumitem receptacle48_bed)
	(inreceptacle item17_bottle_smallitem receptacle40_chair)
	(inreceptacle item26_clock_mediumitem receptacle2_microwave)
	(inreceptacle item18_bottle_smallitem receptacle10_sink)
	(inreceptacle item44_potted_plant_largeitem receptacle16_refrigerator)))
)

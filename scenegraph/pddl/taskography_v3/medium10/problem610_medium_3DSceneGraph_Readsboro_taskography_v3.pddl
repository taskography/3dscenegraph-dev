...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg40_Yneg98_place2_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item2_laptop_mediumitem receptacle42_chair)
	(inreceptacle item3_laptop_mediumitem receptacle69_bed)
	(inreceptacle item27_vase_mediumitem receptacle45_chair)
	(inreceptacle item15_book_smallitem receptacle8_sink)
	(inreceptacle item19_vase_mediumitem receptacle71_dining_table)
	(inreceptacle item14_book_smallitem receptacle67_bed)
	(inreceptacle item25_vase_mediumitem receptacle54_couch)
	(inreceptacle item17_cup_smallitem receptacle53_couch)
	(inreceptacle item16_cup_smallitem receptacle47_chair)))
)

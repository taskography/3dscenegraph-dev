...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	(inreceptacle item59_tv_largeitem receptacle45_bed)
	(inreceptacle item39_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item15_knife_smallitem receptacle23_chair)
	(inreceptacle item10_bottle_smallitem receptacle26_chair)
	(inreceptacle item8_bottle_smallitem receptacle63_sink)
	(inreceptacle item17_banana_smallitem receptacle33_couch)
	(inreceptacle item70_book_smallitem receptacle25_chair)
	(inreceptacle item71_book_smallitem receptacle22_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos5_Ypos14_place8_room4_floorA)
  ...
  (:goal (and
	(inreceptacle item17_banana_smallitem receptacle23_chair)
	(inreceptacle item16_bowl_smallitem receptacle49_bed)
	(inreceptacle item10_bottle_smallitem receptacle53_dining_table)
	(inreceptacle item69_book_smallitem receptacle63_sink)
	(inreceptacle item14_cup_smallitem receptacle1_bench)
	(inreceptacle item72_book_smallitem receptacle52_dining_table)
	(inreceptacle item59_tv_largeitem receptacle65_sink)
	(inreceptacle item58_tv_largeitem receptacle68_refrigerator)
	(inreceptacle item39_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item77_teddy_bear_mediumitem receptacle66_refrigerator)))
)

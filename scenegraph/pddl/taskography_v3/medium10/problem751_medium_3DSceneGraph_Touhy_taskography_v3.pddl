...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xpos5_Ypos54_place13_room4_floorA)
  ...
  (:goal (and
	(inreceptacle item62_tv_largeitem receptacle50_bed)
	(inreceptacle item48_potted_plant_largeitem receptacle70_oven)
	(inreceptacle item66_keyboard_largeitem receptacle19_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item10_bottle_smallitem receptacle21_chair)
	(inreceptacle item82_clock_mediumitem receptacle33_chair)
	(inreceptacle item85_clock_mediumitem receptacle18_chair)
	(inreceptacle item84_clock_mediumitem receptacle30_chair)
	(inreceptacle item89_vase_mediumitem receptacle31_chair)

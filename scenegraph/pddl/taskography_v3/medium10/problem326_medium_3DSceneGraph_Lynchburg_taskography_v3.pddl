...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:goal (and
	...
	(inreceptacle item57_tv_largeitem receptacle35_couch)
	(inreceptacle item39_potted_plant_largeitem receptacle66_refrigerator)
	(inreceptacle item13_cup_smallitem receptacle45_bed)
	(inreceptacle item9_bottle_smallitem receptacle35_couch)
	(inreceptacle item41_potted_plant_largeitem receptacle1_bench)
	(inreceptacle item2_tie_smallitem receptacle68_refrigerator)
	(inreceptacle item17_banana_smallitem receptacle48_bed)))
)

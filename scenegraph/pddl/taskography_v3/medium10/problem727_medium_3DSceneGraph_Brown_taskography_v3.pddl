...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg3_Ypos35_place20_room34_floorB)
	...
	(inplace agent place20_door_room34_staircase)
  ...
  (:goal (and
	(inreceptacle item26_clock_mediumitem receptacle5_sink)
	(inreceptacle item23_clock_mediumitem receptacle3_oven)
	(inreceptacle item45_potted_plant_largeitem receptacle36_toilet)
	(inreceptacle item17_bottle_smallitem receptacle3_oven)
	(inreceptacle item51_tv_largeitem receptacle50_dining_table)
	(inreceptacle item44_potted_plant_largeitem receptacle42_chair)
	...
	(inreceptacle item33_bowl_smallitem receptacle7_sink)))
)

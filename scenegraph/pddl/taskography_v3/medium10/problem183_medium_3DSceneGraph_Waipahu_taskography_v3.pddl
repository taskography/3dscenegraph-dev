...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg38_Yneg15_place2_room10_floorB)
	...
	(inplace agent place2_door_room10_living_room)
  ...
  (:goal (and
	(inreceptacle item55_book_smallitem receptacle10_chair)
	(inreceptacle item7_bowl_smallitem receptacle11_chair)
	(inreceptacle item3_suitcase_largeitem receptacle54_refrigerator)
	(inreceptacle item29_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item25_potted_plant_largeitem receptacle36_bed)
	(inreceptacle item56_clock_mediumitem receptacle21_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle40_dining_table)
	(inreceptacle item26_potted_plant_largeitem receptacle24_couch)
	(inreceptacle item1_handbag_largeitem receptacle51_refrigerator)

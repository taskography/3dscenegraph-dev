...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg31_Ypos26_place7_room18_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item19_vase_mediumitem receptacle50_chair)
	(inreceptacle item26_vase_mediumitem receptacle46_chair)
	(inreceptacle item15_book_smallitem receptacle4_oven)
	(inreceptacle item18_cup_smallitem receptacle31_toilet)
	(inreceptacle item25_vase_mediumitem receptacle45_chair)
	(inreceptacle item23_vase_mediumitem receptacle66_bed)
	(inreceptacle item16_cup_smallitem receptacle70_dining_table)
	(inreceptacle item58_potted_plant_largeitem receptacle39_chair)

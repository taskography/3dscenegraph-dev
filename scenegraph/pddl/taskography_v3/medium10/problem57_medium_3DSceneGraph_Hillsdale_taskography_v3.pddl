...
(define (problem taskograph_rearrangement) (:domain taskography_v3)
  ...
  (:init 
	(atlocation agent location_Xneg65_Ypos12_place0_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item6_bottle_smallitem receptacle36_refrigerator)
	(inreceptacle item43_vase_mediumitem receptacle36_refrigerator)
	(inreceptacle item39_book_smallitem receptacle14_chair)
	(inreceptacle item44_vase_mediumitem receptacle24_dining_table)
	(inreceptacle item3_handbag_largeitem receptacle29_oven)
	(inreceptacle item21_potted_plant_largeitem receptacle13_chair)
	(inreceptacle item4_bottle_smallitem receptacle37_refrigerator)
	(inreceptacle item22_potted_plant_largeitem receptacle32_sink)
	(inreceptacle item12_spoon_smallitem receptacle15_chair)
	(inreceptacle item40_book_smallitem receptacle28_microwave)))
)

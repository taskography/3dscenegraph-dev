...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg42_Ypos115_place60_room11_floorA)
  ...
  (:goal (and
	(inreceptacle item80_book_smallitem receptacle54_dining_table)
	(inreceptacle item4_handbag_largeitem receptacle77_sink)
	(inreceptacle item92_vase_mediumitem receptacle2_bench)
	(inreceptacle item86_vase_mediumitem receptacle59_toilet)
	(inreceptacle item5_tie_smallitem receptacle31_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle17_chair)
	(inreceptacle item62_tv_largeitem receptacle3_bench)
	(inreceptacle item47_potted_plant_largeitem receptacle33_chair)
	(inreceptacle item88_vase_mediumitem receptacle59_toilet)
	(inreceptacle item12_bottle_smallitem receptacle22_chair)))
)

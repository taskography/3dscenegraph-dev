...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg36_Yneg27_place23_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item57_clock_mediumitem receptacle21_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle53_refrigerator)
	(inreceptacle item55_book_smallitem receptacle11_chair)
	(inreceptacle item44_tv_largeitem receptacle54_refrigerator)
	(inreceptacle item9_bowl_smallitem receptacle37_bed)
	(inreceptacle item58_clock_mediumitem receptacle23_couch)
	(inreceptacle item29_potted_plant_largeitem receptacle34_bed)
	(inreceptacle item59_vase_mediumitem receptacle42_toilet)

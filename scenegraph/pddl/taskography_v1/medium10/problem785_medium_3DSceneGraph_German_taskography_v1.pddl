...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg49_Yneg78_place15_room7_floorA)
  ...
  (:goal (and
	(inreceptacle item1_bicycle_largeitem receptacle20_bench)
	(inreceptacle item15_bicycle_largeitem receptacle35_chair)
	(inreceptacle item14_bicycle_largeitem receptacle35_chair)
	(inreceptacle item18_motorcycle_largeitem receptacle36_toilet)
	(inreceptacle item37_tv_largeitem receptacle22_bench)
	(inreceptacle item3_bicycle_largeitem receptacle36_toilet)
	...
	(inreceptacle item16_motorcycle_largeitem receptacle34_chair)))
)

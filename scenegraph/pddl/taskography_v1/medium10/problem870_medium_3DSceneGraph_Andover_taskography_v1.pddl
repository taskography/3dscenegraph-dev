...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos18_Yneg172_place70_room14_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item30_potted_plant_largeitem receptacle63_sink)
	(inreceptacle item8_bowl_smallitem receptacle60_microwave)
	(inreceptacle item3_baseball_glove_smallitem receptacle23_couch)
	(inreceptacle item41_potted_plant_largeitem receptacle23_couch)
	(inreceptacle item78_teddy_bear_mediumitem receptacle62_oven)

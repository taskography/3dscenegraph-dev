...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg33_Yneg65_place10_room7_floorA)
  ...
  (:goal (and
	(inreceptacle item11_bicycle_largeitem receptacle19_bench)
	(inreceptacle item29_bottle_smallitem receptacle42_refrigerator)
	(inreceptacle item18_motorcycle_largeitem receptacle19_bench)
	(inreceptacle item3_bicycle_largeitem receptacle22_bench)
	(inreceptacle item23_suitcase_largeitem receptacle22_bench)
	(inreceptacle item9_bicycle_largeitem receptacle19_bench)
	(inreceptacle item38_tv_largeitem receptacle35_chair)
	(inreceptacle item15_bicycle_largeitem receptacle36_toilet)
	(inreceptacle item6_bicycle_largeitem receptacle43_refrigerator)
	(inreceptacle item8_bicycle_largeitem receptacle21_bench)))
)

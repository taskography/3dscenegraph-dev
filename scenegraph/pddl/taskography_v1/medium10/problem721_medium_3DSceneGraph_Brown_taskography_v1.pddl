...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg37_Ypos0_place31_room31_floorB)
  ...
  (:goal (and
	(inreceptacle item18_bottle_smallitem receptacle32_bench)
	(inreceptacle item45_potted_plant_largeitem receptacle41_chair)
	(inreceptacle item51_tv_largeitem receptacle34_toilet)
	(inreceptacle item28_clock_mediumitem receptacle10_sink)
	(inreceptacle item24_clock_mediumitem receptacle4_oven)
	(inreceptacle item17_bottle_smallitem receptacle41_chair)
	(inreceptacle item27_clock_mediumitem receptacle35_toilet)
	(inreceptacle item19_bottle_smallitem receptacle9_sink)
	(inreceptacle item33_bowl_smallitem receptacle35_toilet)
	(inreceptacle item21_clock_mediumitem receptacle36_toilet)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg55_Ypos20_place41_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item39_laptop_mediumitem receptacle28_dining_table)
	(inreceptacle item38_laptop_mediumitem receptacle44_sink)
	(inreceptacle item21_potted_plant_largeitem receptacle31_toilet)
	(inreceptacle item49_book_smallitem receptacle45_sink)
	(inreceptacle item55_vase_mediumitem receptacle45_sink)
	(inreceptacle item52_vase_mediumitem receptacle14_chair)
	(inreceptacle item40_laptop_mediumitem receptacle43_oven)
	(inreceptacle item54_vase_mediumitem receptacle16_chair)
	(inreceptacle item36_tv_largeitem receptacle28_dining_table)))
)

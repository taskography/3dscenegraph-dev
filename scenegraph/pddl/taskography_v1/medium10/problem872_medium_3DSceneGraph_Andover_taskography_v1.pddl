...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos23_Yneg10_place46_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item1_tie_smallitem receptacle15_chair)
	(inreceptacle item6_wine_glass_smallitem receptacle42_bed)
	(inreceptacle item5_bottle_smallitem receptacle14_chair)
	(inreceptacle item75_vase_mediumitem receptacle52_toilet)
	(inreceptacle item71_book_smallitem receptacle17_chair)
	(inreceptacle item31_potted_plant_largeitem receptacle49_dining_table)
	(inreceptacle item29_potted_plant_largeitem receptacle61_oven)
	(inreceptacle item38_potted_plant_largeitem receptacle62_oven)
	(inreceptacle item2_baseball_glove_smallitem receptacle45_bed)
	(inreceptacle item37_potted_plant_largeitem receptacle50_toilet)))
)

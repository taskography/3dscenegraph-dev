...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos75_Ypos11_place30_room8_floorA)
  ...
  (:goal (and
	(inreceptacle item4_tie_smallitem receptacle23_chair)
	(inreceptacle item57_tv_largeitem receptacle20_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle31_chair)
	(inreceptacle item15_knife_smallitem receptacle48_bed)
	(inreceptacle item17_banana_smallitem receptacle23_chair)
	(inreceptacle item14_cup_smallitem receptacle63_sink)
	(inreceptacle item12_bottle_smallitem receptacle51_bed)
	(inreceptacle item2_tie_smallitem receptacle34_couch)
	(inreceptacle item39_potted_plant_largeitem receptacle29_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg48_Yneg27_place16_room5_floorA)
  ...
  (:goal (and
	(inreceptacle item9_bottle_smallitem receptacle20_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle21_chair)
	(inreceptacle item34_tv_largeitem receptacle2_oven)
	(inreceptacle item17_tie_smallitem receptacle26_couch)
	(inreceptacle item13_vase_mediumitem receptacle22_chair)
	(inreceptacle item8_bottle_smallitem receptacle23_chair)
	(inreceptacle item15_tie_smallitem receptacle19_chair)
	(inreceptacle item10_vase_mediumitem receptacle23_chair)

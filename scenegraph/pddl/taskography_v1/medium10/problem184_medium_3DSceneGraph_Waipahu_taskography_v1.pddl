...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg40_Ypos32_place13_room7_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item8_bowl_smallitem receptacle42_toilet)
	(inreceptacle item28_potted_plant_largeitem receptacle39_dining_table)
	(inreceptacle item1_handbag_largeitem receptacle43_toilet)
	(inreceptacle item7_bowl_smallitem receptacle23_couch)
	(inreceptacle item25_potted_plant_largeitem receptacle31_bed)
	(inreceptacle item27_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item58_clock_mediumitem receptacle52_refrigerator)

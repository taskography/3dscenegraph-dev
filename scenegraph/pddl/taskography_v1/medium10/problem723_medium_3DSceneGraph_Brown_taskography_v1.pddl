...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg38_Yneg21_place28_room37_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item28_clock_mediumitem receptacle32_bench)
	(inreceptacle item17_bottle_smallitem receptacle9_sink)
	(inreceptacle item51_tv_largeitem receptacle15_refrigerator)
	(inreceptacle item22_clock_mediumitem receptacle9_sink)
	(inreceptacle item25_clock_mediumitem receptacle48_bed)
	(inreceptacle item44_potted_plant_largeitem receptacle36_toilet)
	(inreceptacle item19_bottle_smallitem receptacle12_sink)
	(inreceptacle item20_bottle_smallitem receptacle43_chair)))
)

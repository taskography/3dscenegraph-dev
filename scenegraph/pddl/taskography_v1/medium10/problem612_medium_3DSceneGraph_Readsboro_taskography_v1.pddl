...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg69_Yneg43_place34_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item16_cup_smallitem receptacle68_bed)
	(inreceptacle item26_vase_mediumitem receptacle31_toilet)
	(inreceptacle item73_tv_largeitem receptacle34_toilet)
	(inreceptacle item25_vase_mediumitem receptacle38_chair)
	(inreceptacle item15_book_smallitem receptacle41_chair)
	(inreceptacle item27_vase_mediumitem receptacle36_chair)
	(inreceptacle item13_book_smallitem receptacle52_couch)
	(inreceptacle item60_potted_plant_largeitem receptacle68_bed)
	(inreceptacle item24_vase_mediumitem receptacle42_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg18_Yneg38_place41_room12_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item38_potted_plant_largeitem receptacle65_oven)
	(inreceptacle item73_clock_mediumitem receptacle31_couch)
	(inreceptacle item76_vase_mediumitem receptacle28_chair)
	(inreceptacle item82_vase_mediumitem receptacle57_bed)
	(inreceptacle item14_bowl_smallitem receptacle62_dining_table)
	(inreceptacle item32_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item13_cup_smallitem receptacle2_boat)
	(inreceptacle item44_potted_plant_largeitem receptacle68_sink)
	(inreceptacle item18_cake_mediumitem receptacle70_refrigerator)))
)

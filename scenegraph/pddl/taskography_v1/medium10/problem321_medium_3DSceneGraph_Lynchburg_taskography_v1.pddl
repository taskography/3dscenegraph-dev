...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos19_Ypos34_place27_room13_floorB)
  ...
  (:goal (and
	(inreceptacle item70_book_smallitem receptacle28_chair)
	(inreceptacle item16_bowl_smallitem receptacle21_chair)
	(inreceptacle item7_baseball_bat_largeitem receptacle33_couch)
	(inreceptacle item73_book_smallitem receptacle53_dining_table)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos19_Yneg15_place8_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item17_tie_smallitem receptacle30_bed)
	(inreceptacle item12_vase_mediumitem receptacle18_toilet)
	(inreceptacle item33_tv_largeitem receptacle22_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item10_vase_mediumitem receptacle22_chair)
	(inreceptacle item8_bottle_smallitem receptacle20_chair)
	(inreceptacle item35_tv_largeitem receptacle24_chair)
	(inreceptacle item1_remote_smallitem receptacle29_bed)
	(inreceptacle item16_tie_smallitem receptacle3_sink)
	(inreceptacle item9_bottle_smallitem receptacle25_chair)))
)

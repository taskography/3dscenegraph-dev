...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos19_Yneg17_place7_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item17_tie_smallitem receptacle3_sink)
	(inreceptacle item27_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item14_tie_smallitem receptacle21_chair)
	(inreceptacle item8_bottle_smallitem receptacle5_refrigerator)
	(inreceptacle item15_tie_smallitem receptacle32_bed)
	(inreceptacle item9_bottle_smallitem receptacle22_chair)
	(inreceptacle item11_vase_mediumitem receptacle21_chair)
	(inreceptacle item16_tie_smallitem receptacle26_couch)

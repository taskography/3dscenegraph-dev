...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg83_Yneg22_place20_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item18_banana_smallitem receptacle29_couch)
	(inreceptacle item16_bowl_smallitem receptacle7_refrigerator)

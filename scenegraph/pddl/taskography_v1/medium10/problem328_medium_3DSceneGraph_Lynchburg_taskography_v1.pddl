...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos90_Ypos15_place31_room8_floorA)
  ...
  (:goal (and
	(inreceptacle item16_bowl_smallitem receptacle33_couch)
	(inreceptacle item41_potted_plant_largeitem receptacle19_chair)
	(inreceptacle item39_potted_plant_largeitem receptacle49_bed)
	(inreceptacle item57_tv_largeitem receptacle65_sink)
	(inreceptacle item73_book_smallitem receptacle45_bed)
	(inreceptacle item6_suitcase_largeitem receptacle65_sink)
	(inreceptacle item36_potted_plant_largeitem receptacle33_couch)
	(inreceptacle item17_banana_smallitem receptacle31_chair)

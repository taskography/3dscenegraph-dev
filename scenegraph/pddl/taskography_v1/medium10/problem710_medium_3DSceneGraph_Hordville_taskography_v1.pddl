...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos18_Yneg50_place53_room13_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item61_vase_mediumitem receptacle50_sink)
	(inreceptacle item56_book_smallitem receptacle14_chair)
	(inreceptacle item30_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item60_vase_mediumitem receptacle42_toilet)
	(inreceptacle item1_umbrella_largeitem receptacle23_couch)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg106_Ypos38_place38_room17_floorB)
  ...
  (:goal (and
	(inreceptacle item30_umbrella_largeitem receptacle35_bed)
	(inreceptacle item19_clock_mediumitem receptacle10_sink)
	(inreceptacle item24_tie_smallitem receptacle14_refrigerator)
	(inreceptacle item17_bottle_smallitem receptacle23_bench)
	(inreceptacle item29_umbrella_largeitem receptacle28_chair)
	...
	(inreceptacle item31_umbrella_largeitem receptacle28_chair)

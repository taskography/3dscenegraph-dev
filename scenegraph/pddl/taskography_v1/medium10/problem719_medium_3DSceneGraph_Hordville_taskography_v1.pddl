...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg48_Ypos6_place14_room8_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item6_cup_smallitem receptacle11_chair)
	(inreceptacle item62_vase_mediumitem receptacle19_chair)
	(inreceptacle item57_book_smallitem receptacle32_bed)
	(inreceptacle item66_vase_mediumitem receptacle49_sink)
	(inreceptacle item55_book_smallitem receptacle46_microwave)
	(inreceptacle item45_tv_largeitem receptacle46_microwave)
	(inreceptacle item67_vase_mediumitem receptacle34_bed)
	(inreceptacle item10_apple_smallitem receptacle33_bed)))
)

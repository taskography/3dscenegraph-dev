...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos14_Ypos9_place20_room8_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item15_tie_smallitem receptacle2_oven)
	(inreceptacle item33_tv_largeitem receptacle22_chair)
	(inreceptacle item35_tv_largeitem receptacle2_oven)
	(inreceptacle item11_vase_mediumitem receptacle20_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle5_refrigerator)
	(inreceptacle item34_tv_largeitem receptacle3_sink)
	(inreceptacle item7_cup_smallitem receptacle22_chair)
	(inreceptacle item16_tie_smallitem receptacle24_chair)))
)

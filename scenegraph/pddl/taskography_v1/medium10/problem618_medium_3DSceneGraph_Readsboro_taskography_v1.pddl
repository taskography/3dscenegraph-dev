...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg44_Yneg25_place45_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item25_vase_mediumitem receptacle34_toilet)
	(inreceptacle item15_book_smallitem receptacle36_chair)
	(inreceptacle item65_potted_plant_largeitem receptacle68_bed)
	(inreceptacle item20_vase_mediumitem receptacle47_chair)
	(inreceptacle item19_vase_mediumitem receptacle31_toilet)
	(inreceptacle item57_potted_plant_largeitem receptacle36_chair)

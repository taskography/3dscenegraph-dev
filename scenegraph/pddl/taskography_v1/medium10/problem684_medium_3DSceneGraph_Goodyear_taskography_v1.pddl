...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg22_Ypos6_place14_room11_floorB)
  ...
  (:goal (and
	(inreceptacle item16_bowl_smallitem receptacle66_sink)
	(inreceptacle item83_vase_mediumitem receptacle23_chair)
	(inreceptacle item74_clock_mediumitem receptacle4_bench)
	(inreceptacle item71_book_smallitem receptacle61_dining_table)
	(inreceptacle item33_potted_plant_largeitem receptacle4_bench)
	(inreceptacle item15_bowl_smallitem receptacle59_dining_table)
	(inreceptacle item37_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item81_vase_mediumitem receptacle27_chair)
	(inreceptacle item50_potted_plant_largeitem receptacle2_boat)

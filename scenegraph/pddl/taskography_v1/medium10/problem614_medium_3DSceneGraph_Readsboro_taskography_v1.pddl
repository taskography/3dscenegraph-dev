...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg1_Yneg47_place53_room19_floorC)
  ...
  (:goal (and
	(inreceptacle item20_vase_mediumitem receptacle66_bed)
	(inreceptacle item16_cup_smallitem receptacle51_couch)
	(inreceptacle item60_potted_plant_largeitem receptacle43_chair)
	(inreceptacle item2_laptop_mediumitem receptacle43_chair)
	(inreceptacle item64_potted_plant_largeitem receptacle32_toilet)
	(inreceptacle item30_bowl_smallitem receptacle31_toilet)
	(inreceptacle item1_laptop_mediumitem receptacle68_bed)
	(inreceptacle item65_potted_plant_largeitem receptacle31_toilet)
	(inreceptacle item73_tv_largeitem receptacle70_dining_table)

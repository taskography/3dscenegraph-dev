...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg94_Ypos67_place16_room7_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item18_bottle_smallitem receptacle11_refrigerator)
	(inreceptacle item31_umbrella_largeitem receptacle1_microwave)

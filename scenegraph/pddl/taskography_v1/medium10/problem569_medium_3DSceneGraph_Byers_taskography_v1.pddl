...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg54_Yneg21_place18_room5_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item52_vase_mediumitem receptacle10_chair)
	(inreceptacle item39_laptop_mediumitem receptacle11_chair)
	(inreceptacle item37_tv_largeitem receptacle25_bed)
	(inreceptacle item56_vase_mediumitem receptacle45_sink)
	(inreceptacle item34_tv_largeitem receptacle28_dining_table)
	(inreceptacle item49_book_smallitem receptacle47_refrigerator)
	(inreceptacle item24_potted_plant_largeitem receptacle29_toilet)

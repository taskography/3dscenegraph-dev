...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos5_Ypos12_place19_room20_floorA)
  ...
  (:goal (and
	(inreceptacle item47_potted_plant_largeitem receptacle59_toilet)
	(inreceptacle item65_mouse_smallitem receptacle31_chair)
	(inreceptacle item87_vase_mediumitem receptacle18_chair)
	(inreceptacle item6_tie_smallitem receptacle60_toilet)
	(inreceptacle item89_vase_mediumitem receptacle19_chair)
	(inreceptacle item15_banana_smallitem receptacle23_chair)
	(inreceptacle item93_vase_mediumitem receptacle34_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle57_dining_table)
	(inreceptacle item46_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item82_clock_mediumitem receptacle36_couch)))
)

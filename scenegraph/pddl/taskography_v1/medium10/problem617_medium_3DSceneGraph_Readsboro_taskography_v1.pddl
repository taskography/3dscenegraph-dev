...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg50_Yneg36_place29_room16_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item73_tv_largeitem receptacle56_couch)
	(inreceptacle item61_potted_plant_largeitem receptacle40_chair)
	(inreceptacle item3_laptop_mediumitem receptacle66_bed)
	(inreceptacle item29_vase_mediumitem receptacle49_chair)
	(inreceptacle item23_vase_mediumitem receptacle67_bed)
	(inreceptacle item62_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item24_vase_mediumitem receptacle8_sink)
	(inreceptacle item21_vase_mediumitem receptacle52_couch)
	(inreceptacle item27_vase_mediumitem receptacle9_sink)))
)

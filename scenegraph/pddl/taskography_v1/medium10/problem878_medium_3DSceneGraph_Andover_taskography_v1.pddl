...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos12_Yneg56_place66_room2_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item26_potted_plant_largeitem receptacle49_dining_table)
	(inreceptacle item35_potted_plant_largeitem receptacle69_refrigerator)
	(inreceptacle item54_tv_largeitem receptacle48_dining_table)
	(inreceptacle item6_wine_glass_smallitem receptacle12_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle61_oven)
	(inreceptacle item53_tv_largeitem receptacle69_refrigerator)
	(inreceptacle item59_remote_smallitem receptacle22_couch)
	(inreceptacle item4_bottle_smallitem receptacle66_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos83_Ypos61_place63_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item75_clock_mediumitem receptacle21_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle64_sink)
	(inreceptacle item14_cup_smallitem receptacle68_refrigerator)
	(inreceptacle item76_vase_mediumitem receptacle51_bed)
	(inreceptacle item12_bottle_smallitem receptacle45_bed)
	(inreceptacle item3_tie_smallitem receptacle65_sink)
	...
	(inreceptacle item17_banana_smallitem receptacle18_chair)))
)

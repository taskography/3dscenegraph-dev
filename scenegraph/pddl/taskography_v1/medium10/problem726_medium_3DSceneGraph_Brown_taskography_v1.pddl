...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg71_Ypos16_place54_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item17_bottle_smallitem receptacle42_chair)
	(inreceptacle item26_clock_mediumitem receptacle32_bench)
	(inreceptacle item51_tv_largeitem receptacle3_oven)
	(inreceptacle item1_baseball_bat_largeitem receptacle6_sink)
	(inreceptacle item28_clock_mediumitem receptacle7_sink)
	(inreceptacle item44_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item21_clock_mediumitem receptacle3_oven)
	(inreceptacle item45_potted_plant_largeitem receptacle31_bench)

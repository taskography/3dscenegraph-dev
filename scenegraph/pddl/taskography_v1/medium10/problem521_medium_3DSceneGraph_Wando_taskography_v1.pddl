...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg42_Yneg46_place33_room3_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item28_potted_plant_largeitem receptacle29_bed)
	(inreceptacle item16_tie_smallitem receptacle18_toilet)
	(inreceptacle item12_vase_mediumitem receptacle31_bed)
	(inreceptacle item11_vase_mediumitem receptacle30_bed)
	(inreceptacle item14_tie_smallitem receptacle24_chair)
	(inreceptacle item13_vase_mediumitem receptacle23_chair)
	(inreceptacle item35_tv_largeitem receptacle30_bed)
	(inreceptacle item9_bottle_smallitem receptacle29_bed)
	(inreceptacle item1_remote_smallitem receptacle3_sink)))
)

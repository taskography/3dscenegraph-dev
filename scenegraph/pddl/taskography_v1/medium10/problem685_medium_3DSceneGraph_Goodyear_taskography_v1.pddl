...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos10_Ypos36_place34_room8_floorB)
  ...
  (:goal (and
	(inreceptacle item83_vase_mediumitem receptacle24_chair)
	(inreceptacle item78_vase_mediumitem receptacle1_boat)
	(inreceptacle item9_baseball_bat_largeitem receptacle69_sink)

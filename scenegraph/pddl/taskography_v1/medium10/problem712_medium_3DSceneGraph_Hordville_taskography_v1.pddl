...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg8_Yneg43_place31_room13_floorB)
  ...
  (:goal (and
	(inreceptacle item4_bottle_smallitem receptacle43_toilet)
	(inreceptacle item28_potted_plant_largeitem receptacle48_sink)
	(inreceptacle item3_bottle_smallitem receptacle22_couch)
	(inreceptacle item65_vase_mediumitem receptacle38_dining_table)
	(inreceptacle item6_cup_smallitem receptacle51_sink)
	(inreceptacle item68_vase_mediumitem receptacle24_couch)
	(inreceptacle item45_tv_largeitem receptacle47_oven)
	(inreceptacle item30_potted_plant_largeitem receptacle47_oven)
	(inreceptacle item55_book_smallitem receptacle52_sink)
	(inreceptacle item58_book_smallitem receptacle24_couch)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos130_Yneg68_place39_room3_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item33_cup_smallitem receptacle35_chair)
	(inreceptacle item9_bicycle_largeitem receptacle20_bench)
	(inreceptacle item12_bicycle_largeitem receptacle34_chair)
	(inreceptacle item45_book_smallitem receptacle36_toilet)
	(inreceptacle item14_bicycle_largeitem receptacle19_bench)
	(inreceptacle item30_bottle_smallitem receptacle42_refrigerator)
	(inreceptacle item1_bicycle_largeitem receptacle19_bench)
	(inreceptacle item23_suitcase_largeitem receptacle36_toilet)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos16_Ypos16_place48_room4_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item72_book_smallitem receptacle62_sink)
	(inreceptacle item9_bottle_smallitem receptacle54_toilet)
	(inreceptacle item6_suitcase_largeitem receptacle54_toilet)
	(inreceptacle item15_knife_smallitem receptacle68_refrigerator)
	(inreceptacle item8_bottle_smallitem receptacle52_dining_table)

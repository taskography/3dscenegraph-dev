...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg19_Yneg14_place50_room6_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item1_baseball_bat_largeitem receptacle31_bench)
	(inreceptacle item24_clock_mediumitem receptacle42_chair)
	(inreceptacle item23_clock_mediumitem receptacle50_dining_table)
	(inreceptacle item25_clock_mediumitem receptacle50_dining_table)
	...
	(inreceptacle item20_bottle_smallitem receptacle34_toilet)

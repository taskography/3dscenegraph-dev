...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	(inreceptacle item6_bottle_smallitem receptacle54_toilet)
	(inreceptacle item77_vase_mediumitem receptacle48_dining_table)
	(inreceptacle item80_vase_mediumitem receptacle2_bench)

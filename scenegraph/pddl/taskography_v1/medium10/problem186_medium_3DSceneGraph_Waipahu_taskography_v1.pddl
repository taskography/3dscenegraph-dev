...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos1_Yneg12_place42_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item25_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item28_potted_plant_largeitem receptacle41_dining_table)
	(inreceptacle item56_clock_mediumitem receptacle11_chair)
	(inreceptacle item1_handbag_largeitem receptacle41_dining_table)
	(inreceptacle item55_book_smallitem receptacle51_refrigerator)
	(inreceptacle item44_tv_largeitem receptacle15_chair)
	(inreceptacle item26_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item9_bowl_smallitem receptacle11_chair)
	(inreceptacle item58_clock_mediumitem receptacle11_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos34_Yneg90_place15_room11_floorB)
  ...
  (:goal (and
	(inreceptacle item2_baseball_glove_smallitem receptacle17_chair)
	(inreceptacle item3_baseball_glove_smallitem receptacle68_refrigerator)
	(inreceptacle item77_teddy_bear_mediumitem receptacle64_sink)
	(inreceptacle item5_bottle_smallitem receptacle51_toilet)
	(inreceptacle item74_book_smallitem receptacle51_toilet)
	(inreceptacle item33_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item7_bowl_smallitem receptacle23_couch)
	(inreceptacle item28_potted_plant_largeitem receptacle46_dining_table)
	(inreceptacle item71_book_smallitem receptacle14_chair)

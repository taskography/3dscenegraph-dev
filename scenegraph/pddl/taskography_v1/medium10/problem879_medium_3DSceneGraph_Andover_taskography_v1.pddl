...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg18_Yneg58_place22_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item1_tie_smallitem receptacle17_chair)
	(inreceptacle item2_baseball_glove_smallitem receptacle16_chair)
	(inreceptacle item33_potted_plant_largeitem receptacle50_toilet)
	(inreceptacle item4_bottle_smallitem receptacle42_bed)
	(inreceptacle item56_tv_largeitem receptacle52_toilet)
	(inreceptacle item53_tv_largeitem receptacle45_bed)
	...
	(inreceptacle item77_teddy_bear_mediumitem receptacle10_chair)
	(inreceptacle item57_tv_largeitem receptacle52_toilet)))
)

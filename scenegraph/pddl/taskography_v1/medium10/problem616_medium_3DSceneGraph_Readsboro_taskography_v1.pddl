...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg7_Yneg62_place67_room19_floorC)
  ...
  (:goal (and
	(inreceptacle item15_book_smallitem receptacle52_couch)
	(inreceptacle item17_cup_smallitem receptacle51_couch)
	(inreceptacle item65_potted_plant_largeitem receptacle38_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle47_chair)
	(inreceptacle item19_vase_mediumitem receptacle48_chair)
	(inreceptacle item16_cup_smallitem receptacle49_chair)
	(inreceptacle item63_potted_plant_largeitem receptacle49_chair)
	(inreceptacle item13_book_smallitem receptacle44_chair)
	(inreceptacle item29_vase_mediumitem receptacle9_sink)
	(inreceptacle item1_laptop_mediumitem receptacle55_couch)))
)

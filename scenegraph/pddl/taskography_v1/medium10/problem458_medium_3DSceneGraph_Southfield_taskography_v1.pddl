...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg143_Ypos0_place41_room9_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item31_umbrella_largeitem receptacle25_toilet)
	...
	(inreceptacle item19_clock_mediumitem receptacle7_sink)

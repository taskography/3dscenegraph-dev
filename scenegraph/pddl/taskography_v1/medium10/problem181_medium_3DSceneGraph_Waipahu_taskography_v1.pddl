...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg53_Yneg26_place24_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item4_suitcase_largeitem receptacle41_dining_table)
	(inreceptacle item9_bowl_smallitem receptacle50_sink)
	(inreceptacle item59_vase_mediumitem receptacle32_bed)
	(inreceptacle item27_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item1_handbag_largeitem receptacle31_bed)
	(inreceptacle item26_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item6_bottle_smallitem receptacle15_chair)
	(inreceptacle item58_clock_mediumitem receptacle10_chair)
	(inreceptacle item7_bowl_smallitem receptacle32_bed)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos136_Yneg62_place34_room8_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item4_bicycle_largeitem receptacle36_toilet)
	(inreceptacle item38_tv_largeitem receptacle43_refrigerator)
	(inreceptacle item8_bicycle_largeitem receptacle44_refrigerator)
	(inreceptacle item33_cup_smallitem receptacle34_chair)
	(inreceptacle item15_bicycle_largeitem receptacle34_chair)
	(inreceptacle item25_suitcase_largeitem receptacle43_refrigerator)))
)

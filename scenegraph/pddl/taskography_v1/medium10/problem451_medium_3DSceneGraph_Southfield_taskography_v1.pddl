...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg138_Ypos26_place28_room15_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item30_umbrella_largeitem receptacle13_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle25_toilet)))
)

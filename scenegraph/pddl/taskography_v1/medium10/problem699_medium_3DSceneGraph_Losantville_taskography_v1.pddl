...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg30_Yneg10_place54_room10_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item13_bottle_smallitem receptacle74_sink)
	(inreceptacle item9_baseball_bat_largeitem receptacle54_bed)
	(inreceptacle item80_teddy_bear_mediumitem receptacle40_chair)
	(inreceptacle item79_vase_mediumitem receptacle20_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle51_bed)
	(inreceptacle item16_bowl_smallitem receptacle74_sink)
	(inreceptacle item64_tv_largeitem receptacle26_chair)
	(inreceptacle item12_bottle_smallitem receptacle52_bed)

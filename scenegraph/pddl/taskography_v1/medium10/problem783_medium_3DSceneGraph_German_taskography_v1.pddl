...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg38_Yneg77_place12_room7_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item40_laptop_mediumitem receptacle22_bench)
	(inreceptacle item11_bicycle_largeitem receptacle22_bench)
	(inreceptacle item12_bicycle_largeitem receptacle43_refrigerator)
	(inreceptacle item4_bicycle_largeitem receptacle35_chair)
	...
	(inreceptacle item17_motorcycle_largeitem receptacle34_chair)))
)

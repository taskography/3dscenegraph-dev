...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg8_Ypos60_place29_room22_floorA)
  ...
  (:goal (and
	(inreceptacle item16_bottle_smallitem receptacle36_bed)
	(inreceptacle item18_bottle_smallitem receptacle5_sink)
	(inreceptacle item3_surfboard_largeitem receptacle33_bed)
	(inreceptacle item31_umbrella_largeitem receptacle22_bench)
	(inreceptacle item20_clock_mediumitem receptacle33_bed)
	(inreceptacle item19_clock_mediumitem receptacle6_sink)
	(inreceptacle item24_tie_smallitem receptacle15_refrigerator)
	(inreceptacle item30_umbrella_largeitem receptacle27_toilet)
	(inreceptacle item17_bottle_smallitem receptacle1_microwave)
	(inreceptacle item29_umbrella_largeitem receptacle13_refrigerator)))
)

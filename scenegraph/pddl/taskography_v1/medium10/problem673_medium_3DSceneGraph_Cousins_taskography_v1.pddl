...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg58_Yneg58_place97_room22_floorB)
  ...
  (:goal (and
	(inreceptacle item118_book_smallitem receptacle32_chair)
	(inreceptacle item54_potted_plant_largeitem receptacle44_chair)
	(inreceptacle item59_potted_plant_largeitem receptacle40_chair)
	(inreceptacle item133_vase_mediumitem receptacle34_chair)
	(inreceptacle item71_potted_plant_largeitem receptacle31_chair)
	(inreceptacle item27_cake_mediumitem receptacle93_bed)
	(inreceptacle item11_bottle_smallitem receptacle50_couch)
	(inreceptacle item70_potted_plant_largeitem receptacle116_refrigerator)
	(inreceptacle item127_book_smallitem receptacle108_sink)
	(inreceptacle item17_cup_smallitem receptacle93_bed)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg59_Ypos5_place86_room7_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item4_tie_smallitem receptacle111_sink)
	(inreceptacle item120_book_smallitem receptacle93_bed)
	(inreceptacle item90_potted_plant_largeitem receptacle44_chair)
	(inreceptacle item136_teddy_bear_mediumitem receptacle37_chair)
	(inreceptacle item77_potted_plant_largeitem receptacle113_sink)
	(inreceptacle item10_bottle_smallitem receptacle45_chair)
	(inreceptacle item133_vase_mediumitem receptacle115_refrigerator)))
)

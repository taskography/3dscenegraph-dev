...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos104_Ypos44_place60_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item15_knife_smallitem receptacle22_chair)
	(inreceptacle item69_book_smallitem receptacle1_bench)
	(inreceptacle item38_potted_plant_largeitem receptacle67_refrigerator)
	(inreceptacle item39_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item74_book_smallitem receptacle55_toilet)
	(inreceptacle item2_tie_smallitem receptacle20_chair)

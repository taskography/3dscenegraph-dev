...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg40_Yneg45_place51_room5_floorC)
  ...
  (:goal (and
	(inreceptacle item4_bottle_smallitem receptacle67_refrigerator)
	(inreceptacle item74_book_smallitem receptacle12_chair)
	(inreceptacle item29_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item35_potted_plant_largeitem receptacle62_oven)
	(inreceptacle item3_baseball_glove_smallitem receptacle50_toilet)
	(inreceptacle item77_teddy_bear_mediumitem receptacle23_couch)
	(inreceptacle item2_baseball_glove_smallitem receptacle63_sink)
	(inreceptacle item58_laptop_mediumitem receptacle65_sink)
	(inreceptacle item39_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item33_potted_plant_largeitem receptacle66_sink)))
)

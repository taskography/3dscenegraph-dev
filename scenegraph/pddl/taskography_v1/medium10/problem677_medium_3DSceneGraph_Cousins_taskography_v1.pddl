...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos7_Yneg68_place33_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item74_potted_plant_largeitem receptacle116_refrigerator)
	(inreceptacle item7_tie_smallitem receptacle50_couch)

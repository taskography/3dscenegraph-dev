...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos72_place68_room15_floorB)
  ...
  (:goal (and
	(inreceptacle item51_tv_largeitem receptacle31_bench)
	(inreceptacle item47_potted_plant_largeitem receptacle50_dining_table)
	(inreceptacle item27_clock_mediumitem receptacle36_toilet)
	(inreceptacle item25_clock_mediumitem receptacle15_refrigerator)
	(inreceptacle item21_clock_mediumitem receptacle16_refrigerator)
	(inreceptacle item22_clock_mediumitem receptacle37_toilet)
	(inreceptacle item1_baseball_bat_largeitem receptacle11_sink)
	(inreceptacle item28_clock_mediumitem receptacle43_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg52_Yneg24_place53_room37_floorA)
  ...
  (:goal (and
	(inreceptacle item27_clock_mediumitem receptacle38_toilet)
	(inreceptacle item21_clock_mediumitem receptacle32_bench)
	(inreceptacle item51_tv_largeitem receptacle39_chair)
	(inreceptacle item23_clock_mediumitem receptacle48_bed)
	(inreceptacle item1_baseball_bat_largeitem receptacle43_chair)
	(inreceptacle item17_bottle_smallitem receptacle50_dining_table)
	(inreceptacle item25_clock_mediumitem receptacle3_oven)

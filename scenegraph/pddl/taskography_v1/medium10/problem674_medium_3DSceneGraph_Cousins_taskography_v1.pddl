...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg20_Yneg32_place77_room11_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item56_potted_plant_largeitem receptacle91_bed)
	(inreceptacle item89_potted_plant_largeitem receptacle116_refrigerator)
	(inreceptacle item85_potted_plant_largeitem receptacle96_bed)
	(inreceptacle item2_tie_smallitem receptacle43_chair)
	(inreceptacle item76_potted_plant_largeitem receptacle38_chair)
	(inreceptacle item12_wine_glass_smallitem receptacle50_couch)))
)

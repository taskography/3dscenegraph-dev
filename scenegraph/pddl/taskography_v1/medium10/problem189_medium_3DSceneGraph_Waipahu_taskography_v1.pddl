...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg42_Ypos46_place13_room7_floorA)
  ...
  (:goal (and
	(inreceptacle item57_clock_mediumitem receptacle11_chair)
	(inreceptacle item4_suitcase_largeitem receptacle47_oven)
	(inreceptacle item25_potted_plant_largeitem receptacle46_oven)
	(inreceptacle item5_bottle_smallitem receptacle14_chair)
	(inreceptacle item56_clock_mediumitem receptacle52_refrigerator)
	(inreceptacle item3_suitcase_largeitem receptacle49_sink)
	(inreceptacle item2_handbag_largeitem receptacle18_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg47_Ypos27_place13_room5_floorB)
  ...
  (:goal (and
	(inreceptacle item31_umbrella_largeitem receptacle7_sink)
	(inreceptacle item16_bottle_smallitem receptacle22_bench)
	(inreceptacle item3_surfboard_largeitem receptacle36_bed)
	(inreceptacle item24_tie_smallitem receptacle15_refrigerator)
	(inreceptacle item17_bottle_smallitem receptacle35_bed)
	(inreceptacle item29_umbrella_largeitem receptacle5_sink)
	(inreceptacle item19_clock_mediumitem receptacle13_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle36_bed)
	(inreceptacle item30_umbrella_largeitem receptacle2_oven)
	(inreceptacle item20_clock_mediumitem receptacle4_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	(inreceptacle item65_remote_smallitem receptacle23_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle69_sink)
	(inreceptacle item10_bottle_smallitem receptacle27_chair)
	(inreceptacle item15_cup_smallitem receptacle57_bed)
	(inreceptacle item66_remote_smallitem receptacle77_refrigerator)
	(inreceptacle item13_bottle_smallitem receptacle50_bed)
	(inreceptacle item80_teddy_bear_mediumitem receptacle59_bed)
	(inreceptacle item79_vase_mediumitem receptacle24_chair)

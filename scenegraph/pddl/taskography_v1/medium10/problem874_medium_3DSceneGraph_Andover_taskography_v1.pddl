...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg49_Yneg50_place68_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item8_bowl_smallitem receptacle68_refrigerator)
	(inreceptacle item29_potted_plant_largeitem receptacle67_refrigerator)
	(inreceptacle item7_bowl_smallitem receptacle67_refrigerator)
	(inreceptacle item74_book_smallitem receptacle62_oven)
	(inreceptacle item56_tv_largeitem receptacle48_dining_table)
	(inreceptacle item35_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item40_potted_plant_largeitem receptacle24_couch)
	(inreceptacle item4_bottle_smallitem receptacle9_chair)
	(inreceptacle item58_laptop_mediumitem receptacle9_chair)
	(inreceptacle item78_teddy_bear_mediumitem receptacle60_microwave)))
)

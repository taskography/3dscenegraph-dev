...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg49_Yneg9_place58_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item21_clock_mediumitem receptacle29_bench)
	(inreceptacle item26_clock_mediumitem receptacle3_oven)
	(inreceptacle item17_bottle_smallitem receptacle29_bench)
	(inreceptacle item45_potted_plant_largeitem receptacle29_bench)
	(inreceptacle item1_baseball_bat_largeitem receptacle50_dining_table)
	(inreceptacle item23_clock_mediumitem receptacle49_bed)
	(inreceptacle item19_bottle_smallitem receptacle36_toilet)
	(inreceptacle item51_tv_largeitem receptacle13_refrigerator)
	(inreceptacle item47_potted_plant_largeitem receptacle29_bench)))
)

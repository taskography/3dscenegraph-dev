...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg86_Ypos72_place72_room3_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item45_potted_plant_largeitem receptacle76_sink)
	(inreceptacle item90_vase_mediumitem receptacle34_chair)
	(inreceptacle item85_clock_mediumitem receptacle61_toilet)
	(inreceptacle item9_bottle_smallitem receptacle70_oven)
	...
	(inreceptacle item15_banana_smallitem receptacle60_toilet)
	(inreceptacle item42_potted_plant_largeitem receptacle74_sink)))
)

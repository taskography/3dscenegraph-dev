...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg88_Yneg94_place64_room6_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item30_bowl_smallitem receptacle48_chair)
	(inreceptacle item1_laptop_mediumitem receptacle71_dining_table)
	(inreceptacle item19_vase_mediumitem receptacle33_toilet)))
)

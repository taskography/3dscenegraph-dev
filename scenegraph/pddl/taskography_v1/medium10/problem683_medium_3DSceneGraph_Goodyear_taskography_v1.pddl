...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	(inreceptacle item46_potted_plant_largeitem receptacle1_boat)
	(inreceptacle item11_bottle_smallitem receptacle1_boat)
	(inreceptacle item47_potted_plant_largeitem receptacle56_bed)
	(inreceptacle item16_bowl_smallitem receptacle59_dining_table)
	(inreceptacle item77_vase_mediumitem receptacle58_bed)
	(inreceptacle item53_potted_plant_largeitem receptacle58_bed)
	(inreceptacle item51_potted_plant_largeitem receptacle19_chair)
	(inreceptacle item15_bowl_smallitem receptacle29_couch)

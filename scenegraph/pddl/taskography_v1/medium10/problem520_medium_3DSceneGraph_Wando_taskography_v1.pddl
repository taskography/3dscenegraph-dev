...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg10_Yneg48_place24_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item9_bottle_smallitem receptacle29_bed)
	(inreceptacle item11_vase_mediumitem receptacle19_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item7_cup_smallitem receptacle22_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle3_sink)
	(inreceptacle item15_tie_smallitem receptacle29_bed)
	(inreceptacle item35_tv_largeitem receptacle24_chair)
	(inreceptacle item16_tie_smallitem receptacle6_refrigerator)
	(inreceptacle item10_vase_mediumitem receptacle2_oven)
	(inreceptacle item34_tv_largeitem receptacle2_oven)))
)

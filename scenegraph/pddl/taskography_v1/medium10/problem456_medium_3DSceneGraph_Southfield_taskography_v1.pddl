...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg83_Ypos51_place34_room21_floorA)
  ...
  (:goal (and
	(inreceptacle item16_bottle_smallitem receptacle4_sink)
	(inreceptacle item24_tie_smallitem receptacle1_microwave)
	(inreceptacle item20_clock_mediumitem receptacle28_chair)
	(inreceptacle item3_surfboard_largeitem receptacle22_bench)
	(inreceptacle item29_umbrella_largeitem receptacle33_bed)
	(inreceptacle item17_bottle_smallitem receptacle34_bed)
	(inreceptacle item19_clock_mediumitem receptacle1_microwave)
	(inreceptacle item30_umbrella_largeitem receptacle9_sink)
	(inreceptacle item31_umbrella_largeitem receptacle4_sink)

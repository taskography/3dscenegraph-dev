...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos2_Ypos20_place93_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item102_tv_largeitem receptacle115_refrigerator)
	(inreceptacle item86_potted_plant_largeitem receptacle95_bed)
	(inreceptacle item80_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item84_potted_plant_largeitem receptacle105_oven)
	(inreceptacle item132_vase_mediumitem receptacle36_chair)
	(inreceptacle item19_bowl_smallitem receptacle108_sink)
	(inreceptacle item9_bottle_smallitem receptacle108_sink)
	(inreceptacle item63_potted_plant_largeitem receptacle49_couch)
	(inreceptacle item127_book_smallitem receptacle113_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg18_Ypos24_place57_room18_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item72_potted_plant_largeitem receptacle91_bed)
	(inreceptacle item128_book_smallitem receptacle94_bed)
	(inreceptacle item71_potted_plant_largeitem receptacle47_couch)
	(inreceptacle item74_potted_plant_largeitem receptacle109_sink)
	(inreceptacle item81_potted_plant_largeitem receptacle50_couch)
	(inreceptacle item55_potted_plant_largeitem receptacle95_bed)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg57_Yneg18_place55_room12_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item82_teddy_bear_mediumitem receptacle23_chair)
	...
	(inreceptacle item9_cup_smallitem receptacle55_toilet)))
)

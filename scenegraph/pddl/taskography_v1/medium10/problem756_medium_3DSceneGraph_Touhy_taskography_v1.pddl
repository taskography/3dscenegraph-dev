...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg75_Ypos90_place74_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item1_bicycle_largeitem receptacle3_bench)
	...
	(inreceptacle item91_vase_mediumitem receptacle29_chair)
	(inreceptacle item88_vase_mediumitem receptacle53_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos5_Yneg44_place11_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item34_tv_largeitem receptacle6_refrigerator)
	(inreceptacle item27_potted_plant_largeitem receptacle18_toilet)
	(inreceptacle item9_bottle_smallitem receptacle31_bed)
	(inreceptacle item16_tie_smallitem receptacle23_chair)
	(inreceptacle item15_tie_smallitem receptacle24_chair)
	(inreceptacle item1_remote_smallitem receptacle5_refrigerator)
	(inreceptacle item10_vase_mediumitem receptacle30_bed)
	(inreceptacle item7_cup_smallitem receptacle21_chair)
	(inreceptacle item14_tie_smallitem receptacle23_chair)))
)

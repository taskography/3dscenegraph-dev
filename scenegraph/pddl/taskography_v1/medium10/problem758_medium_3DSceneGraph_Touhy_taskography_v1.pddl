...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg24_Ypos8_place24_room7_floorB)
  ...
  (:goal (and
	(inreceptacle item87_vase_mediumitem receptacle77_sink)
	(inreceptacle item82_clock_mediumitem receptacle31_chair)
	(inreceptacle item4_handbag_largeitem receptacle23_chair)
	(inreceptacle item14_bowl_smallitem receptacle33_chair)
	(inreceptacle item65_mouse_smallitem receptacle24_chair)
	(inreceptacle item48_potted_plant_largeitem receptacle32_chair)
	(inreceptacle item62_tv_largeitem receptacle32_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle52_bed)
	(inreceptacle item6_tie_smallitem receptacle56_dining_table)
	(inreceptacle item41_potted_plant_largeitem receptacle3_bench)))
)

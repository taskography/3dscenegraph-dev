...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg45_Ypos1_place35_room2_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item11_vase_mediumitem receptacle29_bed)
	(inreceptacle item7_cup_smallitem receptacle31_bed)
	(inreceptacle item35_tv_largeitem receptacle21_chair)
	(inreceptacle item16_tie_smallitem receptacle31_bed)
	(inreceptacle item27_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item8_bottle_smallitem receptacle25_chair)
	(inreceptacle item15_tie_smallitem receptacle23_chair)
	(inreceptacle item1_remote_smallitem receptacle4_sink)
	(inreceptacle item17_tie_smallitem receptacle32_bed)))
)

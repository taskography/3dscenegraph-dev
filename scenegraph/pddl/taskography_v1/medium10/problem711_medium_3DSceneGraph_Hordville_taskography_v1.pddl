...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos14_Yneg21_place48_room6_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item61_vase_mediumitem receptacle12_chair)
	(inreceptacle item57_book_smallitem receptacle53_sink)
	(inreceptacle item70_toothbrush_smallitem receptacle35_dining_table)
	(inreceptacle item4_bottle_smallitem receptacle12_chair)
	(inreceptacle item29_potted_plant_largeitem receptacle50_sink)
	(inreceptacle item5_bottle_smallitem receptacle17_chair)

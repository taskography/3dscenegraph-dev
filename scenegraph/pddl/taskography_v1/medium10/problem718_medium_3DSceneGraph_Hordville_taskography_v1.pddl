...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg15_Yneg29_place51_room3_floorC)
  ...
  (:goal (and
	(inreceptacle item67_vase_mediumitem receptacle11_chair)
	(inreceptacle item65_vase_mediumitem receptacle18_chair)
	(inreceptacle item26_potted_plant_largeitem receptacle51_sink)
	(inreceptacle item57_book_smallitem receptacle50_sink)
	(inreceptacle item8_bowl_smallitem receptacle35_dining_table)
	(inreceptacle item4_bottle_smallitem receptacle37_dining_table)
	(inreceptacle item3_bottle_smallitem receptacle32_bed)

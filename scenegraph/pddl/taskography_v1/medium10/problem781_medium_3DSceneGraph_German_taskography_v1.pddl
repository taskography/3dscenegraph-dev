...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos213_Yneg63_place25_room5_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item16_motorcycle_largeitem receptacle35_chair)
	(inreceptacle item7_bicycle_largeitem receptacle20_bench)
	(inreceptacle item17_motorcycle_largeitem receptacle20_bench)
	(inreceptacle item9_bicycle_largeitem receptacle34_chair)
	(inreceptacle item38_tv_largeitem receptacle34_chair)

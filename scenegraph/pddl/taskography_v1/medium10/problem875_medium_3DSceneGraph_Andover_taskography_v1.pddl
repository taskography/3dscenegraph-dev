...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos12_Yneg66_place67_room2_floorC)
  ...
  (:goal (and
	(inreceptacle item28_potted_plant_largeitem receptacle50_toilet)
	(inreceptacle item58_laptop_mediumitem receptacle51_toilet)
	(inreceptacle item38_potted_plant_largeitem receptacle42_bed)
	(inreceptacle item31_potted_plant_largeitem receptacle42_bed)
	(inreceptacle item78_teddy_bear_mediumitem receptacle49_dining_table)
	(inreceptacle item5_bottle_smallitem receptacle61_oven)
	(inreceptacle item6_wine_glass_smallitem receptacle12_chair)
	(inreceptacle item57_tv_largeitem receptacle51_toilet)
	(inreceptacle item39_potted_plant_largeitem receptacle9_chair)
	(inreceptacle item53_tv_largeitem receptacle14_chair)))
)

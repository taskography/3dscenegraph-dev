...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg33_Ypos6_place8_room6_floorA)
  ...
  (:goal (and
	(inreceptacle item19_banana_smallitem receptacle7_refrigerator)
	(inreceptacle item15_vase_mediumitem receptacle1_microwave)
	(inreceptacle item18_banana_smallitem receptacle35_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg46_Ypos5_place15_room8_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item2_umbrella_largeitem receptacle22_couch)
	(inreceptacle item30_potted_plant_largeitem receptacle36_dining_table)
	(inreceptacle item67_vase_mediumitem receptacle41_dining_table)
	(inreceptacle item27_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item70_toothbrush_smallitem receptacle14_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg22_Ypos8_place57_room11_floorB)
  ...
  (:goal (and
	(inreceptacle item76_vase_mediumitem receptacle1_boat)
	(inreceptacle item10_bottle_smallitem receptacle65_oven)
	(inreceptacle item53_potted_plant_largeitem receptacle67_sink)
	(inreceptacle item71_book_smallitem receptacle21_chair)
	(inreceptacle item34_potted_plant_largeitem receptacle67_sink)
	(inreceptacle item16_bowl_smallitem receptacle3_bench)
	(inreceptacle item40_potted_plant_largeitem receptacle28_chair)
	(inreceptacle item72_clock_mediumitem receptacle29_couch)
	(inreceptacle item42_potted_plant_largeitem receptacle70_refrigerator)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos7_Ypos1_place49_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item6_bottle_smallitem receptacle35_bed)
	(inreceptacle item4_suitcase_largeitem receptacle50_sink)
	(inreceptacle item5_bottle_smallitem receptacle47_oven)
	(inreceptacle item9_bowl_smallitem receptacle45_microwave)
	(inreceptacle item59_vase_mediumitem receptacle17_chair)
	(inreceptacle item7_bowl_smallitem receptacle31_bed)
	(inreceptacle item57_clock_mediumitem receptacle54_refrigerator)
	(inreceptacle item56_clock_mediumitem receptacle35_bed)
	(inreceptacle item26_potted_plant_largeitem receptacle31_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg53_Yneg19_place34_room6_floorC)
  ...
  (:goal (and
	(inreceptacle item28_potted_plant_largeitem receptacle61_oven)
	(inreceptacle item55_tv_largeitem receptacle44_bed)
	...
	(inreceptacle item31_potted_plant_largeitem receptacle64_sink)
	(inreceptacle item78_teddy_bear_mediumitem receptacle66_sink)

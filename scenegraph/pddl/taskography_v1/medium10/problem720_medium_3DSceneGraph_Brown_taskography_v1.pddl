...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg41_Yneg10_place60_room3_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item1_baseball_bat_largeitem receptacle15_refrigerator)
	(inreceptacle item28_clock_mediumitem receptacle38_toilet)
	(inreceptacle item51_tv_largeitem receptacle42_chair)
	(inreceptacle item44_potted_plant_largeitem receptacle10_sink)
	(inreceptacle item18_bottle_smallitem receptacle13_refrigerator)
	(inreceptacle item26_clock_mediumitem receptacle9_sink)
	(inreceptacle item21_clock_mediumitem receptacle7_sink)
	(inreceptacle item17_bottle_smallitem receptacle49_bed)

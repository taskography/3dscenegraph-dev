...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos22_place16_room6_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item51_vase_mediumitem receptacle25_bed)
	(inreceptacle item8_spoon_smallitem receptacle14_chair)
	(inreceptacle item6_tie_smallitem receptacle1_bench)
	(inreceptacle item33_tv_largeitem receptacle29_toilet)
	(inreceptacle item7_suitcase_largeitem receptacle10_chair)
	(inreceptacle item54_vase_mediumitem receptacle32_toilet)
	(inreceptacle item56_vase_mediumitem receptacle41_microwave)
	(inreceptacle item36_tv_largeitem receptacle47_refrigerator)
	(inreceptacle item9_spoon_smallitem receptacle12_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos1_Yneg106_place72_room3_floorB)
  ...
  (:goal (and
	(inreceptacle item19_bowl_smallitem receptacle91_bed)
	(inreceptacle item67_potted_plant_largeitem receptacle36_chair)
	(inreceptacle item22_apple_smallitem receptacle114_sink)
	...
	(inreceptacle item65_potted_plant_largeitem receptacle39_chair)
	(inreceptacle item75_potted_plant_largeitem receptacle108_sink)
	(inreceptacle item21_bowl_smallitem receptacle31_chair)
	(inreceptacle item81_potted_plant_largeitem receptacle30_chair)))
)

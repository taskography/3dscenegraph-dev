...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos51_Yneg24_place17_room1_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item27_potted_plant_largeitem receptacle23_toilet)
	(inreceptacle item15_cup_smallitem receptacle13_refrigerator)
	(inreceptacle item5_surfboard_largeitem receptacle9_sink)
	...
	(inreceptacle item19_frisbee_mediumitem receptacle10_sink)))
)

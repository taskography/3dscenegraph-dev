...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg54_Yneg70_place105_room22_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item124_book_smallitem receptacle112_sink)
	(inreceptacle item85_potted_plant_largeitem receptacle46_chair)
	(inreceptacle item88_potted_plant_largeitem receptacle115_refrigerator)
	(inreceptacle item54_potted_plant_largeitem receptacle116_refrigerator)
	(inreceptacle item126_book_smallitem receptacle114_sink)
	(inreceptacle item17_cup_smallitem receptacle105_oven)))
)

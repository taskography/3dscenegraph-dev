...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos164_Yneg28_place26_room5_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item28_sports_ball_largeitem receptacle22_bench)
	(inreceptacle item10_bicycle_largeitem receptacle36_toilet)
	...
	(inreceptacle item17_motorcycle_largeitem receptacle42_refrigerator)
	(inreceptacle item37_tv_largeitem receptacle22_bench)
	(inreceptacle item14_bicycle_largeitem receptacle36_toilet)

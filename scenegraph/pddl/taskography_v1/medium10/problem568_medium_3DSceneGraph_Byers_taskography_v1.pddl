...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg27_Ypos29_place47_room3_floorC)
  ...
  (:goal (and
	(inreceptacle item52_vase_mediumitem receptacle29_toilet)
	(inreceptacle item7_suitcase_largeitem receptacle17_chair)
	...
	(inreceptacle item35_tv_largeitem receptacle32_toilet)
	(inreceptacle item2_backpack_largeitem receptacle48_refrigerator)
	(inreceptacle item55_vase_mediumitem receptacle26_dining_table)
	(inreceptacle item21_potted_plant_largeitem receptacle29_toilet)
	(inreceptacle item36_tv_largeitem receptacle46_sink)))
)

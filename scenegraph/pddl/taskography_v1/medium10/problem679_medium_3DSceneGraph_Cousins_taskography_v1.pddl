...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos12_Ypos22_place93_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item89_potted_plant_largeitem receptacle93_bed)
	(inreceptacle item86_potted_plant_largeitem receptacle109_sink)
	(inreceptacle item65_potted_plant_largeitem receptacle36_chair)
	(inreceptacle item82_potted_plant_largeitem receptacle108_sink)
	(inreceptacle item117_book_smallitem receptacle110_sink)
	(inreceptacle item121_book_smallitem receptacle29_chair)
	(inreceptacle item23_apple_smallitem receptacle40_chair)
	(inreceptacle item78_potted_plant_largeitem receptacle111_sink)
	(inreceptacle item123_book_smallitem receptacle41_chair)
	(inreceptacle item14_wine_glass_smallitem receptacle37_chair)))
)

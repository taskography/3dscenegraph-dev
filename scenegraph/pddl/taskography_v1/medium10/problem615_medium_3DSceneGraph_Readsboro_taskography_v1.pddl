...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos6_Yneg99_place55_room15_floorC)
  ...
  (:goal (and
	(inreceptacle item64_potted_plant_largeitem receptacle43_chair)
	(inreceptacle item22_vase_mediumitem receptacle4_oven)
	(inreceptacle item60_potted_plant_largeitem receptacle4_oven)
	(inreceptacle item21_vase_mediumitem receptacle6_sink)
	(inreceptacle item23_vase_mediumitem receptacle68_bed)
	(inreceptacle item73_tv_largeitem receptacle54_couch)
	(inreceptacle item63_potted_plant_largeitem receptacle46_chair)
	(inreceptacle item30_bowl_smallitem receptacle72_dining_table)
	(inreceptacle item58_potted_plant_largeitem receptacle54_couch)
	(inreceptacle item61_potted_plant_largeitem receptacle71_dining_table)))
)

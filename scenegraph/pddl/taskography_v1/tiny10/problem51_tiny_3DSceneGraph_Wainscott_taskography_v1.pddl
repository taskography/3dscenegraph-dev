...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg32_Ypos24_place34_room2_floorA)
  ...
  (:goal (and
	(inreceptacle item15_cup_smallitem receptacle69_dining_table)
	(inreceptacle item58_potted_plant_largeitem receptacle23_chair)
	(inreceptacle item11_vase_mediumitem receptacle25_chair)
	(inreceptacle item12_vase_mediumitem receptacle18_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item8_book_smallitem receptacle34_chair)
	(inreceptacle item63_potted_plant_largeitem receptacle32_chair)
	(inreceptacle item57_potted_plant_largeitem receptacle71_dining_table)
	(inreceptacle item13_clock_mediumitem receptacle70_dining_table)

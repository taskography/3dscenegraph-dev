...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg90_Ypos17_place93_room2_floorB)
  ...
  (:goal (and
	(inreceptacle item7_bottle_smallitem receptacle43_couch)
	(inreceptacle item52_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item4_bottle_smallitem receptacle80_oven)
	(inreceptacle item91_book_smallitem receptacle46_couch)
	(inreceptacle item55_potted_plant_largeitem receptacle67_bed)
	(inreceptacle item102_book_smallitem receptacle33_chair)
	(inreceptacle item95_book_smallitem receptacle29_chair)
	(inreceptacle item105_vase_mediumitem receptacle88_sink)
	(inreceptacle item90_book_smallitem receptacle72_dining_table)
	(inreceptacle item62_potted_plant_largeitem receptacle81_toaster)))
)

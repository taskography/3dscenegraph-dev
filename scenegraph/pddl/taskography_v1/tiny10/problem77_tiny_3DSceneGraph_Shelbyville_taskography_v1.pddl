...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos23_Yneg26_place70_room5_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item12_bottle_smallitem receptacle76_sink)
	(inreceptacle item10_bottle_smallitem receptacle80_sink)
	(inreceptacle item2_backpack_largeitem receptacle32_chair)
	(inreceptacle item88_vase_mediumitem receptacle32_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle59_bed)
	(inreceptacle item72_laptop_mediumitem receptacle24_chair)
	(inreceptacle item1_bicycle_largeitem receptacle62_dining_table)

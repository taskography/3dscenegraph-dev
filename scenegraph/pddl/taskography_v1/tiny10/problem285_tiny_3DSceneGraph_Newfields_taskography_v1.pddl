...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg68_Yneg14_place32_room16_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item36_potted_plant_largeitem receptacle9_sink)
	(inreceptacle item40_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item11_handbag_largeitem receptacle9_sink)
	(inreceptacle item12_clock_mediumitem receptacle30_chair)
	(inreceptacle item1_keyboard_largeitem receptacle45_bed)
	(inreceptacle item18_bottle_smallitem receptacle2_microwave)
	(inreceptacle item14_vase_mediumitem receptacle3_oven)
	(inreceptacle item35_potted_plant_largeitem receptacle27_chair)
	(inreceptacle item49_tv_largeitem receptacle28_chair)))
)

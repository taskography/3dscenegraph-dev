...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg5_Ypos7_place12_room11_floorA)
  ...
  (:goal (and
	(inreceptacle item8_vase_mediumitem receptacle2_oven)
	(inreceptacle item18_apple_smallitem receptacle27_couch)
	(inreceptacle item13_vase_mediumitem receptacle3_sink)
	(inreceptacle item19_apple_smallitem receptacle23_chair)
	(inreceptacle item12_vase_mediumitem receptacle25_chair)
	(inreceptacle item29_potted_plant_largeitem receptacle33_dining_table)
	(inreceptacle item15_vase_mediumitem receptacle32_bed)
	(inreceptacle item7_vase_mediumitem receptacle31_bed)
	(inreceptacle item10_vase_mediumitem receptacle31_bed)
	(inreceptacle item11_vase_mediumitem receptacle3_sink)))
)

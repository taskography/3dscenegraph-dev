...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg7_Ypos7_place11_room11_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item18_apple_smallitem receptacle25_chair)
	(inreceptacle item14_vase_mediumitem receptacle4_sink)
	(inreceptacle item16_bowl_smallitem receptacle31_bed)
	(inreceptacle item19_apple_smallitem receptacle25_chair)
	(inreceptacle item17_bowl_smallitem receptacle24_chair)
	(inreceptacle item9_vase_mediumitem receptacle21_toilet)
	(inreceptacle item28_potted_plant_largeitem receptacle33_dining_table)
	(inreceptacle item12_vase_mediumitem receptacle6_refrigerator)
	(inreceptacle item11_vase_mediumitem receptacle20_toilet)))
)

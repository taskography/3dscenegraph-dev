...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg26_Ypos2_place56_room13_floorB)
  ...
  (:goal (and
	(inreceptacle item22_book_smallitem receptacle51_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle52_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle43_toilet)
	...
	(inreceptacle item38_handbag_largeitem receptacle67_bed)
	(inreceptacle item64_potted_plant_largeitem receptacle68_bed)
	(inreceptacle item37_vase_mediumitem receptacle1_microwave)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg78_Ypos28_place42_room14_floorA)
  ...
  (:goal (and
	(inreceptacle item44_vase_mediumitem receptacle86_chair)
	(inreceptacle item51_wine_glass_smallitem receptacle90_couch)
	(inreceptacle item65_bottle_smallitem receptacle4_sink)
	(inreceptacle item100_potted_plant_largeitem receptacle80_chair)
	(inreceptacle item60_bowl_smallitem receptacle90_couch)
	(inreceptacle item29_book_smallitem receptacle80_chair)
	(inreceptacle item97_potted_plant_largeitem receptacle116_bed)
	(inreceptacle item33_cup_smallitem receptacle4_sink)
	(inreceptacle item40_vase_mediumitem receptacle79_chair)

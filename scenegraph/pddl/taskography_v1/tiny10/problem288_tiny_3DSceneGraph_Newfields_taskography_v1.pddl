...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg21_Yneg11_place47_room11_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item49_tv_largeitem receptacle2_microwave)
	(inreceptacle item14_vase_mediumitem receptacle31_couch)
	(inreceptacle item13_clock_mediumitem receptacle10_refrigerator)
	(inreceptacle item21_suitcase_largeitem receptacle45_bed)
	...
	(inreceptacle item15_bottle_smallitem receptacle9_sink)
	(inreceptacle item11_handbag_largeitem receptacle2_microwave)))
)

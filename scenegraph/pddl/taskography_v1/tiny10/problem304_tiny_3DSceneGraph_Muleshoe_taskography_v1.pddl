...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos10_Yneg9_place82_room18_floorA)
  ...
  (:goal (and
	(inreceptacle item63_bowl_smallitem receptacle81_chair)
	(inreceptacle item15_book_smallitem receptacle87_chair)
	(inreceptacle item18_book_smallitem receptacle117_bed)
	(inreceptacle item107_potted_plant_largeitem receptacle85_chair)
	(inreceptacle item43_vase_mediumitem receptacle93_couch)
	(inreceptacle item44_vase_mediumitem receptacle3_sink)
	(inreceptacle item62_bowl_smallitem receptacle84_chair)
	(inreceptacle item50_wine_glass_smallitem receptacle93_couch)
	(inreceptacle item97_potted_plant_largeitem receptacle81_chair)
	(inreceptacle item21_book_smallitem receptacle116_bed)))
)

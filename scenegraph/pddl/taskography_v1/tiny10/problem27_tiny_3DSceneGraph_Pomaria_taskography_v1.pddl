...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg126_Yneg10_place72_room17_floorA)
  ...
  (:goal (and
	(inreceptacle item46_book_smallitem receptacle2_chair)
	(inreceptacle item15_potted_plant_largeitem receptacle9_chair)
	(inreceptacle item72_book_smallitem receptacle1_chair)
	(inreceptacle item78_book_smallitem receptacle34_sink)
	(inreceptacle item69_book_smallitem receptacle36_sink)
	(inreceptacle item98_vase_mediumitem receptacle36_sink)
	(inreceptacle item80_book_smallitem receptacle7_chair)
	(inreceptacle item67_book_smallitem receptacle8_chair)
	(inreceptacle item20_potted_plant_largeitem receptacle3_chair)

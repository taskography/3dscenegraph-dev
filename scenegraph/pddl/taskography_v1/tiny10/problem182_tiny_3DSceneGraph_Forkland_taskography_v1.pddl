...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos5_Ypos38_place52_room17_floorB)
  ...
  (:goal (and
	(inreceptacle item24_book_smallitem receptacle6_sink)
	(inreceptacle item12_bottle_smallitem receptacle45_chair)
	(inreceptacle item18_bottle_smallitem receptacle41_toilet)
	(inreceptacle item59_potted_plant_largeitem receptacle49_chair)
	(inreceptacle item8_bottle_smallitem receptacle53_couch)
	(inreceptacle item28_vase_mediumitem receptacle46_chair)
	(inreceptacle item19_bottle_smallitem receptacle50_chair)
	(inreceptacle item14_bottle_smallitem receptacle66_bed)
	(inreceptacle item17_bottle_smallitem receptacle48_chair)
	(inreceptacle item71_tv_largeitem receptacle47_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg35_Ypos27_place50_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item20_wine_glass_smallitem receptacle75_sink)
	...
	(inreceptacle item87_vase_mediumitem receptacle69_toilet)
	(inreceptacle item82_book_smallitem receptacle25_chair)
	(inreceptacle item56_potted_plant_largeitem receptacle44_couch)

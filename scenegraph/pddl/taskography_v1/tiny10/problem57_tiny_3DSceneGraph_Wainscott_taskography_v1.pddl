...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos5_Ypos0_place43_room20_floorB)
  ...
  (:goal (and
	(inreceptacle item62_potted_plant_largeitem receptacle34_chair)
	(inreceptacle item42_potted_plant_largeitem receptacle2_oven)
	(inreceptacle item52_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item63_potted_plant_largeitem receptacle41_couch)
	(inreceptacle item4_bottle_smallitem receptacle10_refrigerator)
	(inreceptacle item15_cup_smallitem receptacle28_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle19_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle39_couch)
	(inreceptacle item56_potted_plant_largeitem receptacle25_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos26_Ypos70_place21_room8_floorA)
  ...
  (:goal (and
	(inreceptacle item19_apple_smallitem receptacle24_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle2_oven)
	(inreceptacle item29_potted_plant_largeitem receptacle31_bed)
	(inreceptacle item15_vase_mediumitem receptacle20_toilet)
	(inreceptacle item12_vase_mediumitem receptacle21_toilet)
	(inreceptacle item9_vase_mediumitem receptacle27_couch)
	(inreceptacle item8_vase_mediumitem receptacle22_chair)
	(inreceptacle item17_bowl_smallitem receptacle26_chair)
	(inreceptacle item30_potted_plant_largeitem receptacle31_bed)
	(inreceptacle item7_vase_mediumitem receptacle23_chair)))
)

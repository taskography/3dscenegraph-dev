...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos4_Yneg34_place22_room11_floorA)
  ...
  (:goal (and
	(inreceptacle item63_book_smallitem receptacle37_refrigerator)
	(inreceptacle item29_tv_largeitem receptacle38_refrigerator)
	(inreceptacle item92_clock_mediumitem receptacle22_bed)
	(inreceptacle item66_book_smallitem receptacle38_refrigerator)
	(inreceptacle item46_book_smallitem receptacle4_chair)
	(inreceptacle item71_book_smallitem receptacle37_refrigerator)
	(inreceptacle item84_book_smallitem receptacle10_couch)
	(inreceptacle item30_tv_largeitem receptacle24_bed)
	(inreceptacle item18_potted_plant_largeitem receptacle10_couch)
	(inreceptacle item81_book_smallitem receptacle4_chair)))
)

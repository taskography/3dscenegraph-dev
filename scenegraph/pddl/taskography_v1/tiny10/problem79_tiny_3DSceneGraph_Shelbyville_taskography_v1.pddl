...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg44_Ypos51_place61_room22_floorA)
  ...
  (:goal (and
	(inreceptacle item70_tv_largeitem receptacle79_sink)
	(inreceptacle item52_potted_plant_largeitem receptacle80_sink)
	(inreceptacle item86_vase_mediumitem receptacle66_toilet)
	(inreceptacle item5_handbag_largeitem receptacle38_chair)
	(inreceptacle item20_wine_glass_smallitem receptacle41_chair)
	(inreceptacle item21_wine_glass_smallitem receptacle25_chair)
	(inreceptacle item82_book_smallitem receptacle80_sink)
	(inreceptacle item50_potted_plant_largeitem receptacle44_couch)
	(inreceptacle item83_book_smallitem receptacle61_bed)
	(inreceptacle item2_backpack_largeitem receptacle81_refrigerator)))
)

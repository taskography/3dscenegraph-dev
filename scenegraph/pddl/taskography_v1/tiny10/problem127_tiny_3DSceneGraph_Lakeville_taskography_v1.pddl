...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg123_Yneg105_place24_room17_floorA)
  ...
  (:goal (and
	(inreceptacle item16_book_smallitem receptacle82_toilet)
	(inreceptacle item52_bowl_smallitem receptacle4_refrigerator)
	(inreceptacle item35_book_smallitem receptacle76_bed)
	(inreceptacle item23_book_smallitem receptacle65_chair)
	(inreceptacle item48_vase_mediumitem receptacle71_couch)
	(inreceptacle item11_book_smallitem receptacle82_toilet)
	(inreceptacle item50_vase_mediumitem receptacle3_sink)
	(inreceptacle item32_book_smallitem receptacle1_oven)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg113_Ypos8_place74_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item11_potted_plant_largeitem receptacle10_couch)
	(inreceptacle item45_book_smallitem receptacle25_toilet)
	(inreceptacle item60_book_smallitem receptacle24_bed)
	(inreceptacle item86_book_smallitem receptacle2_chair)
	(inreceptacle item94_vase_mediumitem receptacle6_chair)
	(inreceptacle item54_book_smallitem receptacle38_refrigerator)
	(inreceptacle item64_book_smallitem receptacle5_chair)

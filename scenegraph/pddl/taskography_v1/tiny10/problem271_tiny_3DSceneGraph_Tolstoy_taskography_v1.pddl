...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos115_place43_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item24_bowl_smallitem receptacle27_chair)
	(inreceptacle item14_wine_glass_smallitem receptacle80_oven)
	(inreceptacle item102_book_smallitem receptacle36_chair)
	(inreceptacle item3_suitcase_largeitem receptacle35_chair)
	(inreceptacle item105_vase_mediumitem receptacle71_dining_table)
	(inreceptacle item79_laptop_mediumitem receptacle37_chair)
	(inreceptacle item17_wine_glass_smallitem receptacle44_couch)
	(inreceptacle item50_potted_plant_largeitem receptacle85_sink)
	(inreceptacle item101_book_smallitem receptacle81_toaster)
	(inreceptacle item12_bottle_smallitem receptacle84_sink)))
)

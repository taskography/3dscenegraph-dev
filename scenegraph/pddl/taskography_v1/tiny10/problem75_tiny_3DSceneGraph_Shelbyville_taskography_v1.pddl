...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos22_Ypos13_place77_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item3_backpack_largeitem receptacle33_chair)
	(inreceptacle item10_bottle_smallitem receptacle34_chair)
	(inreceptacle item82_book_smallitem receptacle33_chair)
	(inreceptacle item22_bowl_smallitem receptacle81_refrigerator)
	(inreceptacle item91_vase_mediumitem receptacle38_chair)

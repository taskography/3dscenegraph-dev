...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos28_Ypos52_place16_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item18_apple_smallitem receptacle20_toilet)
	...
	(inreceptacle item8_vase_mediumitem receptacle21_toilet)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	...
	(inreceptacle item58_potted_plant_largeitem receptacle68_dining_table)
	(inreceptacle item72_tv_largeitem receptacle40_couch)
	(inreceptacle item15_cup_smallitem receptacle5_sink)
	(inreceptacle item64_potted_plant_largeitem receptacle67_bed)
	(inreceptacle item48_potted_plant_largeitem receptacle69_dining_table)
	(inreceptacle item45_potted_plant_largeitem receptacle68_dining_table)
	(inreceptacle item3_bottle_smallitem receptacle26_chair)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg91_Ypos46_place63_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item52_wine_glass_smallitem receptacle93_couch)
	(inreceptacle item9_book_smallitem receptacle71_chair)
	(inreceptacle item119_tv_largeitem receptacle93_couch)
	(inreceptacle item99_potted_plant_largeitem receptacle72_chair)
	(inreceptacle item103_potted_plant_largeitem receptacle66_toilet)
	(inreceptacle item61_bowl_smallitem receptacle91_couch)
	(inreceptacle item35_cup_smallitem receptacle84_chair)
	(inreceptacle item14_book_smallitem receptacle66_toilet)
	(inreceptacle item46_vase_mediumitem receptacle4_sink)
	(inreceptacle item104_potted_plant_largeitem receptacle75_chair)))
)

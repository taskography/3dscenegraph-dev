...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg159_Yneg25_place61_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item8_book_smallitem receptacle79_dining_table)
	(inreceptacle item43_vase_mediumitem receptacle68_chair)
	(inreceptacle item30_book_smallitem receptacle72_couch)
	(inreceptacle item13_book_smallitem receptacle53_chair)
	(inreceptacle item40_cup_smallitem receptacle72_couch)
	(inreceptacle item24_book_smallitem receptacle53_chair)
	(inreceptacle item31_book_smallitem receptacle76_bed)
	(inreceptacle item52_bowl_smallitem receptacle58_chair)
	(inreceptacle item39_book_smallitem receptacle73_couch)
	(inreceptacle item83_tv_largeitem receptacle56_chair)))
)

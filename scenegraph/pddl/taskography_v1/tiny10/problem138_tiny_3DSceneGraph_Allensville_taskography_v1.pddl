...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos27_Ypos61_place21_room8_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item12_vase_mediumitem receptacle27_couch)
	(inreceptacle item9_vase_mediumitem receptacle2_oven)
	(inreceptacle item19_apple_smallitem receptacle31_bed)
	(inreceptacle item11_vase_mediumitem receptacle31_bed)
	(inreceptacle item16_bowl_smallitem receptacle22_chair)
	(inreceptacle item15_vase_mediumitem receptacle3_sink)
	(inreceptacle item14_vase_mediumitem receptacle33_dining_table)
	(inreceptacle item18_apple_smallitem receptacle32_bed)

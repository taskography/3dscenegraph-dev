...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg74_Ypos36_place41_room3_floorC)
  ...
  (:goal (and
	(inreceptacle item14_vase_mediumitem receptacle10_refrigerator)
	(inreceptacle item41_potted_plant_largeitem receptacle2_microwave)
	...
	(inreceptacle item48_tv_largeitem receptacle4_sink)

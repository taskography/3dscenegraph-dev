...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos43_Ypos49_place25_room2_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item35_potted_plant_largeitem receptacle53_bed)
	(inreceptacle item39_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item10_vase_mediumitem receptacle2_sink)
	(inreceptacle item36_potted_plant_largeitem receptacle5_refrigerator)
	(inreceptacle item41_potted_plant_largeitem receptacle18_chair)
	(inreceptacle item8_vase_mediumitem receptacle2_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg71_Ypos12_place19_room9_floorC)
  ...
  (:goal (and
	(inreceptacle item98_vase_mediumitem receptacle33_oven)
	(inreceptacle item84_book_smallitem receptacle38_refrigerator)
	(inreceptacle item40_book_smallitem receptacle7_chair)
	(inreceptacle item94_vase_mediumitem receptacle35_sink)
	(inreceptacle item73_book_smallitem receptacle37_refrigerator)
	(inreceptacle item76_book_smallitem receptacle8_chair)
	(inreceptacle item88_book_smallitem receptacle1_chair)
	(inreceptacle item85_book_smallitem receptacle22_bed)
	(inreceptacle item63_book_smallitem receptacle22_bed)
	(inreceptacle item91_book_smallitem receptacle22_bed)))
)

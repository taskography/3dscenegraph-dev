...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg30_Ypos84_place23_room17_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item38_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item42_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item33_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item37_potted_plant_largeitem receptacle46_bed)
	(inreceptacle item47_tv_largeitem receptacle23_toilet)

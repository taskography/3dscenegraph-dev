...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg145_Yneg21_place36_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item16_book_smallitem receptacle75_bed)
	(inreceptacle item44_vase_mediumitem receptacle56_chair)
	(inreceptacle item83_tv_largeitem receptacle63_chair)
	(inreceptacle item47_vase_mediumitem receptacle61_chair)
	(inreceptacle item28_book_smallitem receptacle66_chair)
	(inreceptacle item74_potted_plant_largeitem receptacle69_chair)
	(inreceptacle item22_book_smallitem receptacle79_dining_table)
	(inreceptacle item5_book_smallitem receptacle65_chair)
	(inreceptacle item6_book_smallitem receptacle65_chair)
	(inreceptacle item46_vase_mediumitem receptacle3_sink)))
)

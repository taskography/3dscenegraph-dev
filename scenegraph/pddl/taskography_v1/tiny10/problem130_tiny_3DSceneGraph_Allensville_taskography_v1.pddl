...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos29_Ypos37_place20_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item30_potted_plant_largeitem receptacle21_toilet)
	(inreceptacle item11_vase_mediumitem receptacle4_sink)
	(inreceptacle item29_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item28_potted_plant_largeitem receptacle31_bed)
	(inreceptacle item10_vase_mediumitem receptacle4_sink)
	(inreceptacle item13_vase_mediumitem receptacle3_sink)
	(inreceptacle item7_vase_mediumitem receptacle22_chair)
	(inreceptacle item16_bowl_smallitem receptacle32_bed)
	(inreceptacle item8_vase_mediumitem receptacle22_chair)
	(inreceptacle item15_vase_mediumitem receptacle4_sink)))
)

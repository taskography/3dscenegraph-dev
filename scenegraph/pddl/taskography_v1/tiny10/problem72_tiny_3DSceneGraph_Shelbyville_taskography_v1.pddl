...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos43_Ypos21_place74_room17_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item51_potted_plant_largeitem receptacle79_sink)
	(inreceptacle item72_laptop_mediumitem receptacle25_chair)
	(inreceptacle item50_potted_plant_largeitem receptacle62_dining_table)
	(inreceptacle item8_suitcase_largeitem receptacle26_chair)
	(inreceptacle item9_bottle_smallitem receptacle59_bed)
	(inreceptacle item47_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item2_backpack_largeitem receptacle79_sink)
	(inreceptacle item12_bottle_smallitem receptacle33_chair)
	(inreceptacle item86_vase_mediumitem receptacle57_bed)))
)

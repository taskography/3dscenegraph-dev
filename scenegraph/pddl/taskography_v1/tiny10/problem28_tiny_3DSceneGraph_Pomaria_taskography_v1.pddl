...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	(inreceptacle item89_book_smallitem receptacle25_toilet)
	(inreceptacle item75_book_smallitem receptacle3_chair)
	(inreceptacle item86_book_smallitem receptacle4_chair)
	(inreceptacle item61_book_smallitem receptacle25_toilet)
	(inreceptacle item30_tv_largeitem receptacle1_chair)
	(inreceptacle item40_book_smallitem receptacle26_toilet)
	(inreceptacle item76_book_smallitem receptacle25_toilet)
	(inreceptacle item92_clock_mediumitem receptacle25_toilet)
	(inreceptacle item21_potted_plant_largeitem receptacle1_chair)
	(inreceptacle item29_tv_largeitem receptacle33_oven)))
)

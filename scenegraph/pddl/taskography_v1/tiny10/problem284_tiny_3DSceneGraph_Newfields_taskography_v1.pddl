...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg8_Yneg13_place22_room14_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item21_suitcase_largeitem receptacle3_oven)
	(inreceptacle item19_book_smallitem receptacle25_chair)
	(inreceptacle item47_tv_largeitem receptacle28_chair)
	(inreceptacle item11_handbag_largeitem receptacle32_couch)
	(inreceptacle item40_potted_plant_largeitem receptacle8_sink)

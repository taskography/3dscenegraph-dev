...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg54_Ypos37_place35_room3_floorC)
  ...
  (:goal (and
	(inreceptacle item36_potted_plant_largeitem receptacle8_sink)
	(inreceptacle item19_book_smallitem receptacle26_chair)
	(inreceptacle item47_tv_largeitem receptacle27_chair)
	(inreceptacle item35_potted_plant_largeitem receptacle24_toilet)
	(inreceptacle item42_potted_plant_largeitem receptacle27_chair)
	(inreceptacle item38_potted_plant_largeitem receptacle44_bed)
	(inreceptacle item21_suitcase_largeitem receptacle6_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg84_Yneg48_place90_room20_floorA)
  ...
  (:goal (and
	(inreceptacle item60_bowl_smallitem receptacle72_chair)
	(inreceptacle item47_vase_mediumitem receptacle69_toilet)
	(inreceptacle item21_book_smallitem receptacle74_chair)
	(inreceptacle item9_book_smallitem receptacle95_couch)
	(inreceptacle item33_cup_smallitem receptacle86_chair)
	(inreceptacle item45_vase_mediumitem receptacle116_bed)
	(inreceptacle item16_book_smallitem receptacle79_chair)
	(inreceptacle item34_cup_smallitem receptacle77_chair)
	(inreceptacle item111_potted_plant_largeitem receptacle69_toilet)
	(inreceptacle item17_book_smallitem receptacle74_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg49_Ypos34_place41_room22_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item35_vase_mediumitem receptacle47_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle66_bed)
	(inreceptacle item13_bottle_smallitem receptacle66_bed)
	(inreceptacle item26_vase_mediumitem receptacle65_bed)
	(inreceptacle item71_tv_largeitem receptacle48_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle51_chair)
	(inreceptacle item40_bowl_smallitem receptacle6_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg87_Ypos27_place30_room17_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item21_potted_plant_largeitem receptacle23_bed)
	(inreceptacle item67_book_smallitem receptacle3_chair)
	(inreceptacle item20_potted_plant_largeitem receptacle37_refrigerator)
	(inreceptacle item31_laptop_mediumitem receptacle5_chair)
	(inreceptacle item96_vase_mediumitem receptacle7_chair)
	(inreceptacle item14_potted_plant_largeitem receptacle1_chair)
	(inreceptacle item66_book_smallitem receptacle7_chair)
	(inreceptacle item91_book_smallitem receptacle4_chair)
	(inreceptacle item44_book_smallitem receptacle23_bed)))
)

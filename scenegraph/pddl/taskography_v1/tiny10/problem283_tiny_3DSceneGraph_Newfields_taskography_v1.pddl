...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	...
	(inreceptacle item16_bottle_smallitem receptacle45_bed)
	(inreceptacle item47_tv_largeitem receptacle46_bed)
	(inreceptacle item14_vase_mediumitem receptacle30_chair)
	(inreceptacle item37_potted_plant_largeitem receptacle27_chair)
	(inreceptacle item19_book_smallitem receptacle30_chair)
	(inreceptacle item12_clock_mediumitem receptacle28_chair)
	(inreceptacle item15_bottle_smallitem receptacle10_refrigerator)))
)

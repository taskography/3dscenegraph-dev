...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos3_Ypos60_place81_room19_floorB)
  ...
  (:goal (and
	(inreceptacle item19_bottle_smallitem receptacle76_sink)
	(inreceptacle item9_bottle_smallitem receptacle57_bed)
	(inreceptacle item50_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item72_laptop_mediumitem receptacle63_dining_table)
	(inreceptacle item14_bottle_smallitem receptacle63_dining_table)
	(inreceptacle item83_book_smallitem receptacle38_chair)
	(inreceptacle item52_potted_plant_largeitem receptacle66_toilet)
	(inreceptacle item5_handbag_largeitem receptacle59_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg47_Ypos38_place24_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item80_book_smallitem receptacle25_toilet)
	(inreceptacle item69_book_smallitem receptacle7_chair)
	(inreceptacle item86_book_smallitem receptacle10_couch)
	(inreceptacle item70_book_smallitem receptacle35_sink)
	(inreceptacle item89_book_smallitem receptacle37_refrigerator)
	(inreceptacle item96_vase_mediumitem receptacle25_toilet)
	(inreceptacle item15_potted_plant_largeitem receptacle24_bed)
	(inreceptacle item27_tv_largeitem receptacle37_refrigerator)
	(inreceptacle item88_book_smallitem receptacle36_sink)

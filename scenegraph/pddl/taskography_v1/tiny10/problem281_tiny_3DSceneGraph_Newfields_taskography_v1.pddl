...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos9_Yneg14_place20_room14_floorB)
  ...
  (:goal (and
	(inreceptacle item48_tv_largeitem receptacle10_refrigerator)
	(inreceptacle item40_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item20_suitcase_largeitem receptacle30_chair)
	(inreceptacle item35_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item49_tv_largeitem receptacle45_bed)
	(inreceptacle item16_bottle_smallitem receptacle26_chair)
	(inreceptacle item36_potted_plant_largeitem receptacle31_couch)
	(inreceptacle item34_potted_plant_largeitem receptacle2_microwave)
	(inreceptacle item11_handbag_largeitem receptacle44_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos10_Ypos26_place27_room13_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item87_vase_mediumitem receptacle59_bed)
	(inreceptacle item20_wine_glass_smallitem receptacle27_chair)
	(inreceptacle item46_potted_plant_largeitem receptacle57_bed)
	(inreceptacle item56_potted_plant_largeitem receptacle29_chair)

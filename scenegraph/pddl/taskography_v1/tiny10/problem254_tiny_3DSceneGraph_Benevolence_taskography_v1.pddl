...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos8_Yneg35_place24_room3_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item18_bowl_smallitem receptacle7_sink)
	...
	(inreceptacle item16_teddy_bear_mediumitem receptacle7_sink)))
)

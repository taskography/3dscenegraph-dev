...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg10_Ypos11_place40_room27_floorA)
  ...
  (:goal (and
	(inreceptacle item59_tv_largeitem receptacle6_sink)
	(inreceptacle item17_vase_mediumitem receptacle29_chair)
	(inreceptacle item46_potted_plant_largeitem receptacle19_toilet)
	(inreceptacle item14_clock_mediumitem receptacle26_chair)
	(inreceptacle item13_book_smallitem receptacle31_chair)
	(inreceptacle item48_potted_plant_largeitem receptacle8_sink)

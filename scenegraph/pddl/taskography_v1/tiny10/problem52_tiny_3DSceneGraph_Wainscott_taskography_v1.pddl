...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg36_Ypos4_place52_room15_floorB)
  ...
  (:goal (and
	(inreceptacle item13_clock_mediumitem receptacle68_dining_table)
	...
	(inreceptacle item44_potted_plant_largeitem receptacle67_bed)
	(inreceptacle item48_potted_plant_largeitem receptacle30_chair)
	(inreceptacle item47_potted_plant_largeitem receptacle10_refrigerator)
	(inreceptacle item42_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item3_bottle_smallitem receptacle71_dining_table)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg6_Ypos13_place11_room5_floorB)
  ...
  (:goal (and
	(inreceptacle item43_potted_plant_largeitem receptacle15_chair)
	(inreceptacle item12_backpack_largeitem receptacle53_bed)
	(inreceptacle item6_book_smallitem receptacle53_bed)
	(inreceptacle item7_bottle_smallitem receptacle24_couch)
	(inreceptacle item47_potted_plant_largeitem receptacle21_chair)
	(inreceptacle item10_vase_mediumitem receptacle52_bed)
	(inreceptacle item27_potted_plant_largeitem receptacle52_bed)
	(inreceptacle item34_potted_plant_largeitem receptacle17_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle53_bed)

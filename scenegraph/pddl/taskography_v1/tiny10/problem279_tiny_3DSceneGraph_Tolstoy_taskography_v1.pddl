...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg87_Yneg3_place71_room4_floorA)
  ...
  (:goal (and
	(inreceptacle item78_tv_largeitem receptacle73_dining_table)
	...
	(inreceptacle item94_book_smallitem receptacle29_chair)
	(inreceptacle item7_bottle_smallitem receptacle89_refrigerator)
	(inreceptacle item23_bowl_smallitem receptacle85_sink)

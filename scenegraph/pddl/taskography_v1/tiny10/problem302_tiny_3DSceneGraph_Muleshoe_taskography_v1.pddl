...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg103_Yneg19_place88_room15_floorB)
  ...
  (:goal (and
	(inreceptacle item105_potted_plant_largeitem receptacle71_chair)
	(inreceptacle item102_potted_plant_largeitem receptacle91_couch)
	(inreceptacle item7_book_smallitem receptacle93_couch)
	(inreceptacle item23_book_smallitem receptacle67_toilet)
	(inreceptacle item101_potted_plant_largeitem receptacle116_bed)
	(inreceptacle item15_book_smallitem receptacle80_chair)
	(inreceptacle item119_tv_largeitem receptacle78_chair)
	(inreceptacle item46_vase_mediumitem receptacle67_toilet)
	(inreceptacle item63_bowl_smallitem receptacle70_chair)
	(inreceptacle item41_vase_mediumitem receptacle79_chair)))
)

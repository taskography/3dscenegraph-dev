...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg110_Ypos27_place77_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item50_wine_glass_smallitem receptacle115_bed)
	(inreceptacle item13_book_smallitem receptacle93_couch)
	(inreceptacle item65_bottle_smallitem receptacle73_chair)
	(inreceptacle item26_book_smallitem receptacle77_chair)
	(inreceptacle item104_potted_plant_largeitem receptacle69_toilet)
	(inreceptacle item9_book_smallitem receptacle74_chair)
	(inreceptacle item59_bowl_smallitem receptacle71_chair)
	(inreceptacle item39_vase_mediumitem receptacle90_couch)
	(inreceptacle item100_potted_plant_largeitem receptacle74_chair)
	(inreceptacle item41_vase_mediumitem receptacle76_chair)))
)

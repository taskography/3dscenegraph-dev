...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg54_Ypos141_place46_room32_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item13_book_smallitem receptacle7_sink)
	(inreceptacle item59_tv_largeitem receptacle9_refrigerator)
	(inreceptacle item17_vase_mediumitem receptacle18_toilet)
	(inreceptacle item44_potted_plant_largeitem receptacle22_chair)
	(inreceptacle item15_bottle_smallitem receptacle31_chair)
	(inreceptacle item55_potted_plant_largeitem receptacle32_chair)
	(inreceptacle item11_book_smallitem receptacle7_sink)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg31_Ypos0_place76_room6_floorC)
  ...
  (:goal (and
	(inreceptacle item89_book_smallitem receptacle2_chair)
	(inreceptacle item40_book_smallitem receptacle3_chair)
	(inreceptacle item54_book_smallitem receptacle8_chair)
	(inreceptacle item41_book_smallitem receptacle5_chair)
	(inreceptacle item70_book_smallitem receptacle2_chair)
	(inreceptacle item59_book_smallitem receptacle10_couch)
	(inreceptacle item82_book_smallitem receptacle1_chair)
	(inreceptacle item19_potted_plant_largeitem receptacle26_toilet)
	(inreceptacle item21_potted_plant_largeitem receptacle22_bed)
	(inreceptacle item88_book_smallitem receptacle6_chair)))
)

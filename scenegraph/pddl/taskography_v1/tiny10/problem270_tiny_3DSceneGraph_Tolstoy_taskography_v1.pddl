...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos13_Ypos100_place95_room3_floorB)
  ...
  (:goal (and
	(inreceptacle item101_book_smallitem receptacle82_sink)
	(inreceptacle item106_vase_mediumitem receptacle69_bed)
	(inreceptacle item22_bowl_smallitem receptacle45_couch)
	(inreceptacle item50_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item15_wine_glass_smallitem receptacle39_chair)
	(inreceptacle item13_bottle_smallitem receptacle85_sink)
	(inreceptacle item56_potted_plant_largeitem receptacle28_chair)
	(inreceptacle item14_wine_glass_smallitem receptacle45_couch)
	(inreceptacle item63_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item93_book_smallitem receptacle30_chair)))
)

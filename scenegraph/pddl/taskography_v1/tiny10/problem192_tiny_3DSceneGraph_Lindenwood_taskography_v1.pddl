...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg75_Ypos39_place30_room28_floorA)
  ...
  (:goal (and
	(inreceptacle item13_book_smallitem receptacle22_chair)
	(inreceptacle item14_clock_mediumitem receptacle28_chair)
	(inreceptacle item51_potted_plant_largeitem receptacle20_toilet)
	(inreceptacle item59_tv_largeitem receptacle37_couch)
	(inreceptacle item43_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item50_potted_plant_largeitem receptacle20_toilet)
	...
	(inreceptacle item12_book_smallitem receptacle20_toilet)
	(inreceptacle item54_potted_plant_largeitem receptacle19_toilet)))
)

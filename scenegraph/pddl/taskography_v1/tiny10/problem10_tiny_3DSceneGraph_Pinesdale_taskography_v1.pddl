...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos14_Ypos150_place65_room16_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item41_vase_mediumitem receptacle65_chair)
	(inreceptacle item33_clock_mediumitem receptacle6_sink)
	(inreceptacle item70_potted_plant_largeitem receptacle1_oven)
	(inreceptacle item29_book_smallitem receptacle51_toilet)
	(inreceptacle item74_potted_plant_largeitem receptacle60_chair)
	(inreceptacle item82_potted_plant_largeitem receptacle49_bench)
	(inreceptacle item48_bowl_smallitem receptacle54_chair)
	(inreceptacle item71_potted_plant_largeitem receptacle53_toilet)))
)

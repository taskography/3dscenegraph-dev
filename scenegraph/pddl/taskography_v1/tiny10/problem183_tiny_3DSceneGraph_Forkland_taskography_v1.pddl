...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg66_Yneg15_place62_room6_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item61_potted_plant_largeitem receptacle49_chair)
	(inreceptacle item29_vase_mediumitem receptacle7_sink)
	(inreceptacle item71_tv_largeitem receptacle46_chair)
	(inreceptacle item62_potted_plant_largeitem receptacle41_toilet)
	(inreceptacle item27_vase_mediumitem receptacle66_bed)
	(inreceptacle item33_vase_mediumitem receptacle53_couch)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg43_Yneg60_place39_room5_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item15_cup_smallitem receptacle25_chair)
	(inreceptacle item52_potted_plant_largeitem receptacle21_chair)
	...
	(inreceptacle item59_potted_plant_largeitem receptacle68_dining_table)
	(inreceptacle item56_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item55_potted_plant_largeitem receptacle10_refrigerator)
	(inreceptacle item11_vase_mediumitem receptacle37_couch)))
)

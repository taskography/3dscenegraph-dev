...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg68_Ypos80_place45_room19_floorA)
  ...
  (:goal (and
	(inreceptacle item14_clock_mediumitem receptacle37_couch)
	(inreceptacle item55_potted_plant_largeitem receptacle30_chair)
	(inreceptacle item16_bowl_smallitem receptacle35_couch)
	(inreceptacle item12_book_smallitem receptacle57_dining_table)
	...
	(inreceptacle item59_tv_largeitem receptacle28_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle37_couch)

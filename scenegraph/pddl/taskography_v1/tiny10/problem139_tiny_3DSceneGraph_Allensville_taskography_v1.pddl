...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos35_Yneg8_place17_room1_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item30_potted_plant_largeitem receptacle33_dining_table)
	(inreceptacle item13_vase_mediumitem receptacle4_sink)
	(inreceptacle item9_vase_mediumitem receptacle4_sink)
	(inreceptacle item19_apple_smallitem receptacle33_dining_table)

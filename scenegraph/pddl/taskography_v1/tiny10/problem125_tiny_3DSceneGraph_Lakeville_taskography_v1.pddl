...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg119_Yneg87_place51_room3_floorB)
  ...
  (:goal (and
	(inreceptacle item45_vase_mediumitem receptacle69_chair)
	(inreceptacle item83_tv_largeitem receptacle69_chair)
	(inreceptacle item44_vase_mediumitem receptacle75_bed)
	(inreceptacle item17_book_smallitem receptacle64_chair)
	(inreceptacle item50_vase_mediumitem receptacle62_chair)
	(inreceptacle item8_book_smallitem receptacle76_bed)
	(inreceptacle item26_book_smallitem receptacle3_sink)
	(inreceptacle item13_book_smallitem receptacle68_chair)
	(inreceptacle item25_book_smallitem receptacle82_toilet)
	(inreceptacle item22_book_smallitem receptacle81_dining_table)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	...
	(inreceptacle item48_potted_plant_largeitem receptacle26_couch)
	(inreceptacle item31_potted_plant_largeitem receptacle25_couch)
	(inreceptacle item42_potted_plant_largeitem receptacle14_toilet)
	(inreceptacle item7_bottle_smallitem receptacle52_bed)
	(inreceptacle item6_book_smallitem receptacle1_oven)
	(inreceptacle item32_potted_plant_largeitem receptacle53_bed)
	(inreceptacle item50_potted_plant_largeitem receptacle24_couch)
	(inreceptacle item8_vase_mediumitem receptacle52_bed)

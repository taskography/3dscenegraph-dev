...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos71_Ypos53_place24_room10_floorA)
  ...
  (:goal (and
	(inreceptacle item9_vase_mediumitem receptacle31_bed)
	(inreceptacle item8_vase_mediumitem receptacle2_oven)
	(inreceptacle item12_vase_mediumitem receptacle2_oven)
	(inreceptacle item10_vase_mediumitem receptacle22_chair)
	(inreceptacle item11_vase_mediumitem receptacle26_chair)
	(inreceptacle item14_vase_mediumitem receptacle24_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item17_bowl_smallitem receptacle31_bed)

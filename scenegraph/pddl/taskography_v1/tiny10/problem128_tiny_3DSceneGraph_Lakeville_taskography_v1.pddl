...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg184_Yneg52_place59_room16_floorA)
  ...
  (:goal (and
	(inreceptacle item83_tv_largeitem receptacle3_sink)
	(inreceptacle item13_book_smallitem receptacle78_bed)
	(inreceptacle item12_book_smallitem receptacle66_chair)
	(inreceptacle item31_book_smallitem receptacle76_bed)
	(inreceptacle item29_book_smallitem receptacle73_couch)
	(inreceptacle item35_book_smallitem receptacle79_dining_table)
	(inreceptacle item6_book_smallitem receptacle61_chair)
	(inreceptacle item25_book_smallitem receptacle2_toaster)
	(inreceptacle item45_vase_mediumitem receptacle58_chair)
	(inreceptacle item74_potted_plant_largeitem receptacle67_chair)))
)

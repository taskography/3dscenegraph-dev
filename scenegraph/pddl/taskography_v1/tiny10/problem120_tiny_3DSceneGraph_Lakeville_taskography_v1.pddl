...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg145_Yneg21_place55_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item49_vase_mediumitem receptacle71_couch)
	(inreceptacle item37_book_smallitem receptacle56_chair)
	(inreceptacle item24_book_smallitem receptacle71_couch)
	(inreceptacle item48_vase_mediumitem receptacle53_chair)
	(inreceptacle item41_vase_mediumitem receptacle82_toilet)
	(inreceptacle item20_book_smallitem receptacle75_bed)
	(inreceptacle item17_book_smallitem receptacle71_couch)
	(inreceptacle item32_book_smallitem receptacle81_dining_table)
	(inreceptacle item18_book_smallitem receptacle81_dining_table)
	(inreceptacle item21_book_smallitem receptacle71_couch)))
)

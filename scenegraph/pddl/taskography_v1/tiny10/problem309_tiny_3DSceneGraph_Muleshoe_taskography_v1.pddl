...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg141_Yneg9_place72_room2_floorA)
  ...
  (:goal (and
	(inreceptacle item119_tv_largeitem receptacle6_refrigerator)
	(inreceptacle item56_wine_glass_smallitem receptacle75_chair)
	(inreceptacle item106_potted_plant_largeitem receptacle3_sink)
	(inreceptacle item51_wine_glass_smallitem receptacle117_bed)
	(inreceptacle item41_vase_mediumitem receptacle117_bed)
	(inreceptacle item107_potted_plant_largeitem receptacle91_couch)
	(inreceptacle item26_book_smallitem receptacle81_chair)
	(inreceptacle item24_book_smallitem receptacle83_chair)
	(inreceptacle item16_book_smallitem receptacle94_couch)
	(inreceptacle item110_potted_plant_largeitem receptacle81_chair)))
)

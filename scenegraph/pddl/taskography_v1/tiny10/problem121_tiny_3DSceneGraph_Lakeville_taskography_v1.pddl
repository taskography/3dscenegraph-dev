...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos4_Yneg85_place70_room6_floorA)
  ...
  (:goal (and
	(inreceptacle item26_book_smallitem receptacle68_chair)
	(inreceptacle item21_book_smallitem receptacle78_bed)
	(inreceptacle item32_book_smallitem receptacle3_sink)
	(inreceptacle item24_book_smallitem receptacle1_oven)
	(inreceptacle item34_book_smallitem receptacle58_chair)
	(inreceptacle item46_vase_mediumitem receptacle75_bed)
	(inreceptacle item38_book_smallitem receptacle4_refrigerator)
	(inreceptacle item8_book_smallitem receptacle62_chair)

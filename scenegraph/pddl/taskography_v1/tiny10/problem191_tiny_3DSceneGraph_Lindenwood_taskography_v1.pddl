...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg11_Ypos45_place38_room6_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item52_potted_plant_largeitem receptacle7_sink)
	(inreceptacle item51_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item40_potted_plant_largeitem receptacle6_sink)
	(inreceptacle item15_bottle_smallitem receptacle57_dining_table)
	(inreceptacle item49_potted_plant_largeitem receptacle18_toilet)

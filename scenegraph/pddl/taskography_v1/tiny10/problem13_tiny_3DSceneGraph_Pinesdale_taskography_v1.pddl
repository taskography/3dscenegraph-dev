...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg14_Ypos59_place43_room22_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item79_potted_plant_largeitem receptacle58_chair)
	(inreceptacle item11_book_smallitem receptacle56_chair)
	(inreceptacle item74_potted_plant_largeitem receptacle50_toilet)
	(inreceptacle item44_vase_mediumitem receptacle7_sink)
	(inreceptacle item70_potted_plant_largeitem receptacle85_bed)
	(inreceptacle item17_book_smallitem receptacle64_chair)
	(inreceptacle item23_book_smallitem receptacle6_sink)
	(inreceptacle item18_book_smallitem receptacle2_sink)
	(inreceptacle item69_potted_plant_largeitem receptacle56_chair)))
)

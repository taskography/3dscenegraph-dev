...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg59_Ypos28_place29_room14_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item21_book_smallitem receptacle81_dining_table)
	(inreceptacle item40_cup_smallitem receptacle53_chair)
	(inreceptacle item50_vase_mediumitem receptacle77_bed)
	(inreceptacle item30_book_smallitem receptacle77_bed)
	(inreceptacle item43_vase_mediumitem receptacle81_dining_table)
	(inreceptacle item33_book_smallitem receptacle82_toilet)
	(inreceptacle item31_book_smallitem receptacle4_refrigerator)
	(inreceptacle item15_book_smallitem receptacle73_couch)))
)

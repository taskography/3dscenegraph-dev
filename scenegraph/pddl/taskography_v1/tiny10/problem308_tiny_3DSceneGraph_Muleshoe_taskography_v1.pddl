...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos10_Yneg6_place82_room18_floorA)
  ...
  (:goal (and
	(inreceptacle item18_book_smallitem receptacle114_bed)
	(inreceptacle item65_bottle_smallitem receptacle64_bench)
	(inreceptacle item44_vase_mediumitem receptacle116_bed)
	(inreceptacle item46_vase_mediumitem receptacle84_chair)
	(inreceptacle item102_potted_plant_largeitem receptacle82_chair)
	(inreceptacle item55_wine_glass_smallitem receptacle66_toilet)
	(inreceptacle item42_vase_mediumitem receptacle68_toilet)
	(inreceptacle item35_cup_smallitem receptacle115_bed)
	(inreceptacle item54_wine_glass_smallitem receptacle89_couch)
	(inreceptacle item106_potted_plant_largeitem receptacle115_bed)))
)

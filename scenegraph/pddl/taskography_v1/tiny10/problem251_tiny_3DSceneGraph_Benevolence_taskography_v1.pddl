...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:goal (and
	(inreceptacle item15_teddy_bear_mediumitem receptacle1_microwave)
	(inreceptacle item17_bowl_smallitem receptacle22_toilet)
	(inreceptacle item18_bowl_smallitem receptacle38_dining_table)
	(inreceptacle item16_teddy_bear_mediumitem receptacle25_chair)
	(inreceptacle item31_potted_plant_largeitem receptacle34_bed)
	(inreceptacle item19_bowl_smallitem receptacle27_chair)
	...
	(inreceptacle item39_tv_largeitem receptacle8_refrigerator)))
)

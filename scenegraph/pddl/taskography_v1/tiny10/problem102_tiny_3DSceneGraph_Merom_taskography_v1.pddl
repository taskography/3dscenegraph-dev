...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg2_Ypos52_place20_room8_floorB)
  ...
  (:goal (and
	(inreceptacle item42_potted_plant_largeitem receptacle53_bed)
	(inreceptacle item47_potted_plant_largeitem receptacle26_couch)
	(inreceptacle item39_potted_plant_largeitem receptacle14_toilet)
	(inreceptacle item38_potted_plant_largeitem receptacle51_bed)
	(inreceptacle item33_potted_plant_largeitem receptacle22_chair)
	(inreceptacle item10_vase_mediumitem receptacle2_sink)

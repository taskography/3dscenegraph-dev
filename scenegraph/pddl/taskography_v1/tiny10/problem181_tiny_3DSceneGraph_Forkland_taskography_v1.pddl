...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos17_Yneg20_place58_room15_floorA)
  ...
  (:goal (and
	(inreceptacle item32_vase_mediumitem receptacle6_sink)
	(inreceptacle item19_bottle_smallitem receptacle5_sink)
	(inreceptacle item39_clock_mediumitem receptacle54_couch)
	(inreceptacle item22_book_smallitem receptacle46_chair)
	(inreceptacle item33_vase_mediumitem receptacle45_chair)
	(inreceptacle item8_bottle_smallitem receptacle47_chair)
	(inreceptacle item20_book_smallitem receptacle69_bed)
	(inreceptacle item40_bowl_smallitem receptacle66_bed)
	(inreceptacle item35_vase_mediumitem receptacle66_bed)
	(inreceptacle item34_vase_mediumitem receptacle53_couch)))
)

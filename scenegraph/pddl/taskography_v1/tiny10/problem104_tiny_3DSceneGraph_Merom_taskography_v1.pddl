...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg23_Ypos86_place33_room7_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item12_backpack_largeitem receptacle18_chair)
	...
	(inreceptacle item42_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item34_potted_plant_largeitem receptacle5_refrigerator)
	(inreceptacle item32_potted_plant_largeitem receptacle22_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle54_dining_table)))
)

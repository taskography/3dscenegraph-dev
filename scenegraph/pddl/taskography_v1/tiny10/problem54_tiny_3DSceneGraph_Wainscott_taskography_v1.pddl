...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xneg45_Yneg56_place39_room5_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item3_bottle_smallitem receptacle6_sink)
	...
	(inreceptacle item14_clock_mediumitem receptacle38_couch)

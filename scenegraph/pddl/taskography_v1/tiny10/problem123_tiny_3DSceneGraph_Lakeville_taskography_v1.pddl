...
(define (problem taskograph_rearrangement) (:domain taskography_v1)
  ...
  (:init 
	(atlocation agent location_Xpos4_Yneg23_place83_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item32_book_smallitem receptacle79_dining_table)
	(inreceptacle item12_book_smallitem receptacle58_chair)
	(inreceptacle item49_vase_mediumitem receptacle66_chair)
	(inreceptacle item6_book_smallitem receptacle58_chair)
	(inreceptacle item16_book_smallitem receptacle64_chair)
	(inreceptacle item5_book_smallitem receptacle56_chair)
	(inreceptacle item43_vase_mediumitem receptacle82_toilet)
	(inreceptacle item39_book_smallitem receptacle56_chair)
	(inreceptacle item22_book_smallitem receptacle69_chair)
	(inreceptacle item27_book_smallitem receptacle77_bed)))
)

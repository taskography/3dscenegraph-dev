...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg21_Yneg36_place8_room7_floorB)
	...
	(inplace agent place8_door_room7_corridor)
  ...
  (:goal (and
	...
	(inreceptacle item40_tv_largeitem receptacle5_sink)
	(inreceptacle item31_potted_plant_largeitem receptacle32_bed)
	(inreceptacle item16_teddy_bear_mediumitem receptacle8_refrigerator)
	(inreceptacle item41_tv_largeitem receptacle8_refrigerator)
	(inreceptacle item13_bottle_smallitem receptacle27_chair)
	(inreceptacle item11_bottle_smallitem receptacle34_bed)
	(inreceptacle item30_potted_plant_largeitem receptacle20_toilet)
	(inreceptacle item19_bowl_smallitem receptacle7_sink)
	(inreceptacle item9_book_smallitem receptacle2_oven)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg25_Yneg7_place3_room1_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item71_tv_largeitem receptacle46_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle70_dining_table)
	(inreceptacle item32_vase_mediumitem receptacle41_toilet)
	(inreceptacle item19_bottle_smallitem receptacle48_chair)
	(inreceptacle item8_bottle_smallitem receptacle46_chair)
	(inreceptacle item39_clock_mediumitem receptacle54_couch)
	(inreceptacle item34_vase_mediumitem receptacle48_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle45_chair)
	(inreceptacle item21_book_smallitem receptacle5_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos2_Yneg24_place10_room8_floorC)
  ...
  (:goal (and
	(inreceptacle item29_vase_mediumitem receptacle25_refrigerator)
	(inreceptacle item28_vase_mediumitem receptacle3_sink)
	(inreceptacle item30_vase_mediumitem receptacle65_bed)
	(inreceptacle item8_bottle_smallitem receptacle49_chair)
	(inreceptacle item20_book_smallitem receptacle41_toilet)
	(inreceptacle item64_potted_plant_largeitem receptacle65_bed)
	(inreceptacle item19_bottle_smallitem receptacle4_sink)
	(inreceptacle item18_bottle_smallitem receptacle2_oven)
	(inreceptacle item58_potted_plant_largeitem receptacle45_chair)
	(inreceptacle item39_clock_mediumitem receptacle66_bed)))
)

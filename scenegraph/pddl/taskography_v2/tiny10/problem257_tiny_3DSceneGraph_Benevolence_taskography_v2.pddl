...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg6_Yneg63_place4_room5_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item15_teddy_bear_mediumitem receptacle36_dining_table)
	...
	(inreceptacle item11_bottle_smallitem receptacle38_dining_table)
	(inreceptacle item41_tv_largeitem receptacle1_microwave)))
)

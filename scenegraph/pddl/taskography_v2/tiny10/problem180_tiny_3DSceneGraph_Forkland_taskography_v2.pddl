...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos4_Yneg13_place8_room16_floorB)
  ...
  (:goal (and
	(inreceptacle item24_book_smallitem receptacle46_chair)
	(inreceptacle item27_vase_mediumitem receptacle41_toilet)
	(inreceptacle item33_vase_mediumitem receptacle66_bed)
	(inreceptacle item61_potted_plant_largeitem receptacle53_couch)
	(inreceptacle item55_potted_plant_largeitem receptacle67_bed)
	(inreceptacle item9_bottle_smallitem receptacle46_chair)
	(inreceptacle item40_bowl_smallitem receptacle66_bed)
	(inreceptacle item62_potted_plant_largeitem receptacle2_oven)
	(inreceptacle item58_potted_plant_largeitem receptacle1_microwave)
	(inreceptacle item20_book_smallitem receptacle46_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item22_book_smallitem receptacle54_couch)
	(inreceptacle item40_bowl_smallitem receptacle43_toilet)
	...
	(inreceptacle item37_vase_mediumitem receptacle65_bed)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg53_Ypos23_place0_room14_floorB)
	...
	(inplace agent place0_door_room14_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item31_vase_mediumitem receptacle5_sink)
	(inreceptacle item21_book_smallitem receptacle48_chair)
	(inreceptacle item28_vase_mediumitem receptacle43_toilet)
	(inreceptacle item36_vase_mediumitem receptacle70_dining_table)
	(inreceptacle item12_bottle_smallitem receptacle47_chair)
	(inreceptacle item22_book_smallitem receptacle70_dining_table)
	(inreceptacle item14_bottle_smallitem receptacle65_bed)
	(inreceptacle item18_bottle_smallitem receptacle5_sink)
	(inreceptacle item38_handbag_largeitem receptacle48_chair)))
)

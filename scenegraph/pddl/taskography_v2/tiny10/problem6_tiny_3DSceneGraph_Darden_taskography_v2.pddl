...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg68_Yneg14_place10_room18_floorB)
	...
	(inplace agent place10_door_room18_dining_room)
  ...
  (:goal (and
	...
	(inreceptacle item66_vase_mediumitem receptacle10_chair)
	(inreceptacle item3_bottle_smallitem receptacle16_chair)
	(inreceptacle item5_bottle_smallitem receptacle21_chair)
	(inreceptacle item6_cup_smallitem receptacle58_refrigerator)
	(inreceptacle item62_book_smallitem receptacle46_bed)
	(inreceptacle item9_bowl_smallitem receptacle14_chair)
	(inreceptacle item67_vase_mediumitem receptacle44_bed)
	(inreceptacle item52_tv_largeitem receptacle16_chair)

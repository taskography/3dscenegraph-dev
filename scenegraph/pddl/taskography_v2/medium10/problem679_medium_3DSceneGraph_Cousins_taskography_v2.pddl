...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg54_Yneg67_place17_room22_floorB)
	...
	(inplace agent place17_door_room22_utility_room)
  ...
  (:goal (and
	(inreceptacle item7_tie_smallitem receptacle116_refrigerator)
	(inreceptacle item74_potted_plant_largeitem receptacle50_couch)
	(inreceptacle item118_book_smallitem receptacle109_sink)
	(inreceptacle item131_vase_mediumitem receptacle48_couch)
	(inreceptacle item103_tv_largeitem receptacle43_chair)
	(inreceptacle item130_clock_mediumitem receptacle108_sink)
	(inreceptacle item83_potted_plant_largeitem receptacle40_chair)
	(inreceptacle item77_potted_plant_largeitem receptacle105_oven)
	(inreceptacle item55_potted_plant_largeitem receptacle96_bed)
	(inreceptacle item12_wine_glass_smallitem receptacle38_chair)))
)

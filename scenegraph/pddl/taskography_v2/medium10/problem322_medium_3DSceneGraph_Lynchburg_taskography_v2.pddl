...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos1_Ypos31_place12_room5_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item8_bottle_smallitem receptacle31_chair)
	(inreceptacle item75_clock_mediumitem receptacle66_refrigerator)
	(inreceptacle item57_tv_largeitem receptacle22_chair)
	...
	(inreceptacle item7_baseball_bat_largeitem receptacle66_refrigerator)
	(inreceptacle item16_bowl_smallitem receptacle21_chair)
	(inreceptacle item69_book_smallitem receptacle33_couch)))
)

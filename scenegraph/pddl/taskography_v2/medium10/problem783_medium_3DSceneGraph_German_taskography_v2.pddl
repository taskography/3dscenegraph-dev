...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item23_suitcase_largeitem receptacle22_bench)
	(inreceptacle item31_bottle_smallitem receptacle21_bench)
	(inreceptacle item30_bottle_smallitem receptacle22_bench)
	(inreceptacle item29_bottle_smallitem receptacle19_bench)
	(inreceptacle item4_bicycle_largeitem receptacle34_chair)
	(inreceptacle item18_motorcycle_largeitem receptacle20_bench)
	(inreceptacle item17_motorcycle_largeitem receptacle36_toilet)
	(inreceptacle item38_tv_largeitem receptacle41_sink)
	(inreceptacle item1_bicycle_largeitem receptacle34_chair)

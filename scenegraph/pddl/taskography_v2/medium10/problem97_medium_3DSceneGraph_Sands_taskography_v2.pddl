...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos32_Yneg29_place9_room10_floorA)
	...
	(inplace agent place9_door_room10_staircase)
  ...
  (:goal (and
	(inreceptacle item15_cup_smallitem receptacle2_oven)
	...
	(inreceptacle item27_potted_plant_largeitem receptacle20_toilet)
	(inreceptacle item17_bottle_smallitem receptacle23_toilet)

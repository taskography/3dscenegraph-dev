...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item7_bicycle_largeitem receptacle41_sink)
	(inreceptacle item40_laptop_mediumitem receptacle20_bench)
	(inreceptacle item5_bicycle_largeitem receptacle21_bench)
	(inreceptacle item26_suitcase_largeitem receptacle34_chair)
	(inreceptacle item38_tv_largeitem receptacle20_bench)
	(inreceptacle item12_bicycle_largeitem receptacle35_chair)
	(inreceptacle item9_bicycle_largeitem receptacle43_refrigerator)
	(inreceptacle item4_bicycle_largeitem receptacle22_bench)
	(inreceptacle item6_bicycle_largeitem receptacle36_toilet)

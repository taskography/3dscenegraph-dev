...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item28_clock_mediumitem receptacle37_toilet)
	(inreceptacle item33_bowl_smallitem receptacle16_refrigerator)
	(inreceptacle item46_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item22_clock_mediumitem receptacle9_sink)
	(inreceptacle item20_bottle_smallitem receptacle3_oven)
	(inreceptacle item23_clock_mediumitem receptacle37_toilet)
	(inreceptacle item21_clock_mediumitem receptacle11_sink)
	(inreceptacle item51_tv_largeitem receptacle38_toilet)
	(inreceptacle item25_clock_mediumitem receptacle32_bench)
	(inreceptacle item18_bottle_smallitem receptacle39_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item6_bicycle_largeitem receptacle35_chair)
	(inreceptacle item37_tv_largeitem receptacle21_bench)
	(inreceptacle item38_tv_largeitem receptacle36_toilet)
	(inreceptacle item39_laptop_mediumitem receptacle22_bench)
	(inreceptacle item17_motorcycle_largeitem receptacle36_toilet)
	(inreceptacle item25_suitcase_largeitem receptacle41_sink)
	(inreceptacle item29_bottle_smallitem receptacle21_bench)
	(inreceptacle item4_bicycle_largeitem receptacle44_refrigerator)
	(inreceptacle item23_suitcase_largeitem receptacle20_bench)
	(inreceptacle item33_cup_smallitem receptacle41_sink)))
)

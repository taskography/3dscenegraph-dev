...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos1_Yneg5_place0_room12_floorA)
  ...
  (:goal (and
	(inreceptacle item59_vase_mediumitem receptacle45_microwave)
	...
	(inreceptacle item2_handbag_largeitem receptacle19_chair)
	(inreceptacle item4_suitcase_largeitem receptacle47_oven)
	(inreceptacle item44_tv_largeitem receptacle31_bed)
	(inreceptacle item3_suitcase_largeitem receptacle47_oven)
	(inreceptacle item56_clock_mediumitem receptacle36_bed)))
)

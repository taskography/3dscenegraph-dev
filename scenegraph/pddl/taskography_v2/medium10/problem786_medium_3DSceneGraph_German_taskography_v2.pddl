...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos139_Yneg76_place5_room3_floorA)
	...
	(inplace agent place5_door_room3_bathrrom)
  ...
  (:goal (and
	(inreceptacle item31_bottle_smallitem receptacle22_bench)
	...
	(inreceptacle item25_suitcase_largeitem receptacle36_toilet)
	(inreceptacle item6_bicycle_largeitem receptacle36_toilet)
	(inreceptacle item30_bottle_smallitem receptacle34_chair)
	(inreceptacle item15_bicycle_largeitem receptacle41_sink)

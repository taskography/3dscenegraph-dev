...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	...
	(inreceptacle item31_umbrella_largeitem receptacle23_bench)
	(inreceptacle item19_clock_mediumitem receptacle32_bed)
	(inreceptacle item18_bottle_smallitem receptacle1_microwave)
	(inreceptacle item29_umbrella_largeitem receptacle32_bed)
	(inreceptacle item24_tie_smallitem receptacle32_bed)
	(inreceptacle item16_bottle_smallitem receptacle12_refrigerator)
	(inreceptacle item17_bottle_smallitem receptacle22_bench)
	(inreceptacle item30_umbrella_largeitem receptacle9_sink)

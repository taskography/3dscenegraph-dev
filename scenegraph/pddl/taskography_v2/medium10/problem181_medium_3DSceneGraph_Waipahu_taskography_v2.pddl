...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos11_Ypos39_place8_room1_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item7_bowl_smallitem receptacle39_dining_table)
	(inreceptacle item56_clock_mediumitem receptacle51_refrigerator)
	(inreceptacle item2_handbag_largeitem receptacle37_bed)
	(inreceptacle item25_potted_plant_largeitem receptacle12_chair)
	(inreceptacle item44_tv_largeitem receptacle36_bed)
	(inreceptacle item4_suitcase_largeitem receptacle40_dining_table)))
)

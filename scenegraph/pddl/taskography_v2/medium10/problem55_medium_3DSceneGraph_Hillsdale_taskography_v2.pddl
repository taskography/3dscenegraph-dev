...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	...
	(inreceptacle item1_handbag_largeitem receptacle30_oven)
	(inreceptacle item8_bottle_smallitem receptacle17_couch)
	(inreceptacle item43_vase_mediumitem receptacle31_toaster)
	(inreceptacle item44_vase_mediumitem receptacle30_oven)
	(inreceptacle item41_book_smallitem receptacle17_couch)
	(inreceptacle item11_cup_smallitem receptacle28_microwave)
	(inreceptacle item40_book_smallitem receptacle25_toilet)

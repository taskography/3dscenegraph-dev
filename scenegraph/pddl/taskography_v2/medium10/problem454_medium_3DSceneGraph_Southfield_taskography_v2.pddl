...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item20_clock_mediumitem receptacle27_toilet)
	(inreceptacle item3_surfboard_largeitem receptacle4_sink)
	(inreceptacle item30_umbrella_largeitem receptacle1_microwave)
	(inreceptacle item16_bottle_smallitem receptacle10_sink)
	(inreceptacle item18_bottle_smallitem receptacle4_sink)
	...
	(inreceptacle item24_tie_smallitem receptacle34_bed)
	(inreceptacle item29_umbrella_largeitem receptacle26_toilet)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item70_book_smallitem receptacle48_bed)
	(inreceptacle item3_tie_smallitem receptacle48_bed)
	(inreceptacle item75_clock_mediumitem receptacle46_bed)
	(inreceptacle item72_book_smallitem receptacle27_chair)
	...
	(inreceptacle item2_tie_smallitem receptacle34_couch)
	(inreceptacle item9_bottle_smallitem receptacle63_sink)))
)

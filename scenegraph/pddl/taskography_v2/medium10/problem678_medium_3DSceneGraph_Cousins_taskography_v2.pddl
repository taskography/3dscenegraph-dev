...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos7_Ypos14_place5_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item124_book_smallitem receptacle42_chair)
	(inreceptacle item7_tie_smallitem receptacle43_chair)
	(inreceptacle item5_tie_smallitem receptacle109_sink)
	(inreceptacle item82_potted_plant_largeitem receptacle36_chair)
	(inreceptacle item58_potted_plant_largeitem receptacle114_sink)
	(inreceptacle item55_potted_plant_largeitem receptacle106_oven)
	(inreceptacle item16_wine_glass_smallitem receptacle112_sink)
	(inreceptacle item2_tie_smallitem receptacle40_chair)
	(inreceptacle item85_potted_plant_largeitem receptacle112_sink)
	(inreceptacle item88_potted_plant_largeitem receptacle115_refrigerator)))
)

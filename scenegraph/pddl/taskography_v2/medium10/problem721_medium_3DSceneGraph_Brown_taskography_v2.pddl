...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos0_Ypos77_place18_room15_floorB)
	...
	(inplace agent place18_door_room15_dining_room)
  ...
  (:goal (and
	(inreceptacle item22_clock_mediumitem receptacle40_chair)
	(inreceptacle item45_potted_plant_largeitem receptacle39_chair)
	(inreceptacle item33_bowl_smallitem receptacle11_sink)
	(inreceptacle item46_potted_plant_largeitem receptacle36_toilet)
	(inreceptacle item20_bottle_smallitem receptacle9_sink)
	(inreceptacle item19_bottle_smallitem receptacle29_bench)
	(inreceptacle item25_clock_mediumitem receptacle6_sink)
	(inreceptacle item27_clock_mediumitem receptacle15_refrigerator)
	(inreceptacle item24_clock_mediumitem receptacle38_toilet)
	(inreceptacle item1_baseball_bat_largeitem receptacle42_chair)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos8_Yneg33_place14_room36_floorB)
	...
	(inplace agent place14_door_room36_storage)
  ...
  (:goal (and
	(inreceptacle item24_clock_mediumitem receptacle14_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle7_sink)
	(inreceptacle item26_clock_mediumitem receptacle49_bed)
	(inreceptacle item45_potted_plant_largeitem receptacle3_oven)
	(inreceptacle item51_tv_largeitem receptacle4_oven)
	(inreceptacle item28_clock_mediumitem receptacle34_toilet)
	(inreceptacle item19_bottle_smallitem receptacle14_refrigerator)
	(inreceptacle item44_potted_plant_largeitem receptacle9_sink)
	(inreceptacle item17_bottle_smallitem receptacle39_chair)
	(inreceptacle item20_bottle_smallitem receptacle32_bench)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos3_Yneg108_place2_room3_floorB)
  ...
  (:goal (and
	(inreceptacle item72_potted_plant_largeitem receptacle51_couch)
	(inreceptacle item104_tv_largeitem receptacle110_sink)
	(inreceptacle item26_cake_mediumitem receptacle51_couch)
	(inreceptacle item89_potted_plant_largeitem receptacle91_bed)
	(inreceptacle item52_potted_plant_largeitem receptacle95_bed)
	(inreceptacle item84_potted_plant_largeitem receptacle43_chair)
	(inreceptacle item53_potted_plant_largeitem receptacle100_toilet)
	(inreceptacle item88_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item10_bottle_smallitem receptacle34_chair)
	(inreceptacle item25_cake_mediumitem receptacle113_sink)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	...
	(inreceptacle item19_clock_mediumitem receptacle26_toilet)
	(inreceptacle item24_tie_smallitem receptacle22_bench)
	(inreceptacle item29_umbrella_largeitem receptacle12_refrigerator)
	(inreceptacle item3_surfboard_largeitem receptacle1_microwave)
	(inreceptacle item18_bottle_smallitem receptacle1_microwave)
	(inreceptacle item16_bottle_smallitem receptacle10_sink)
	(inreceptacle item31_umbrella_largeitem receptacle8_sink)
	(inreceptacle item20_clock_mediumitem receptacle23_bench)
	(inreceptacle item17_bottle_smallitem receptacle26_toilet)))
)

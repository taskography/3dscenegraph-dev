...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg6_Ypos32_place15_room33_floorA)
	...
	(inplace agent place15_door_room33_staircase)
  ...
  (:goal (and
	(inreceptacle item19_bottle_smallitem receptacle36_toilet)
	(inreceptacle item47_potted_plant_largeitem receptacle41_chair)
	(inreceptacle item25_clock_mediumitem receptacle29_bench)
	(inreceptacle item21_clock_mediumitem receptacle3_oven)
	(inreceptacle item45_potted_plant_largeitem receptacle29_bench)
	(inreceptacle item1_baseball_bat_largeitem receptacle29_bench)
	(inreceptacle item17_bottle_smallitem receptacle50_dining_table)
	(inreceptacle item33_bowl_smallitem receptacle49_bed)
	(inreceptacle item23_clock_mediumitem receptacle36_toilet)
	(inreceptacle item51_tv_largeitem receptacle13_refrigerator)))
)

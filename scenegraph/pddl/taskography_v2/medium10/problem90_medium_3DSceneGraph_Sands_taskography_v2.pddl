...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos16_Ypos14_place6_room7_floorB)
	...
	(inplace agent place6_door_room7_empty_room)
  ...
  (:goal (and
	...
	(inreceptacle item15_cup_smallitem receptacle14_refrigerator)
	(inreceptacle item5_surfboard_largeitem receptacle20_toilet)
	(inreceptacle item16_bottle_smallitem receptacle6_sink)
	(inreceptacle item26_potted_plant_largeitem receptacle23_toilet)
	(inreceptacle item17_bottle_smallitem receptacle12_refrigerator)
	(inreceptacle item19_frisbee_mediumitem receptacle6_sink)
	(inreceptacle item4_surfboard_largeitem receptacle22_toilet)
	(inreceptacle item25_potted_plant_largeitem receptacle7_sink)

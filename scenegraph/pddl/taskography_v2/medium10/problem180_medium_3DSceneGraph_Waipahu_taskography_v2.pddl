...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	...
	(inreceptacle item9_bowl_smallitem receptacle32_bed)
	(inreceptacle item7_bowl_smallitem receptacle31_bed)
	(inreceptacle item59_vase_mediumitem receptacle18_chair)
	(inreceptacle item6_bottle_smallitem receptacle12_chair)
	(inreceptacle item2_handbag_largeitem receptacle21_chair)
	(inreceptacle item29_potted_plant_largeitem receptacle37_bed)
	(inreceptacle item8_bowl_smallitem receptacle35_bed)

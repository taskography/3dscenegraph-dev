...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg123_Ypos22_place5_room7_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item17_bottle_smallitem receptacle36_bed)
	(inreceptacle item29_umbrella_largeitem receptacle5_sink)
	(inreceptacle item24_tie_smallitem receptacle36_bed)
	(inreceptacle item31_umbrella_largeitem receptacle22_bench)
	(inreceptacle item3_surfboard_largeitem receptacle14_refrigerator)
	...
	(inreceptacle item16_bottle_smallitem receptacle1_microwave)))
)

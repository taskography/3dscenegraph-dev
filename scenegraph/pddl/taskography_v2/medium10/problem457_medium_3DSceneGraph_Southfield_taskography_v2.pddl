...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos1_Ypos59_place3_room3_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item24_tie_smallitem receptacle5_sink)
	(inreceptacle item20_clock_mediumitem receptacle26_toilet)
	(inreceptacle item3_surfboard_largeitem receptacle10_sink)
	(inreceptacle item30_umbrella_largeitem receptacle2_oven)
	(inreceptacle item18_bottle_smallitem receptacle10_sink)
	(inreceptacle item29_umbrella_largeitem receptacle35_bed)
	(inreceptacle item19_clock_mediumitem receptacle5_sink)
	(inreceptacle item17_bottle_smallitem receptacle33_bed)

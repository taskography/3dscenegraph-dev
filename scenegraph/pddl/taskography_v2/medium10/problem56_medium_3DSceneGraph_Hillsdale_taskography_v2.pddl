...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg12_Yneg9_place5_room8_floorA)
  ...
  (:goal (and
	(inreceptacle item11_cup_smallitem receptacle29_oven)
	(inreceptacle item21_potted_plant_largeitem receptacle18_couch)
	(inreceptacle item20_potted_plant_largeitem receptacle13_chair)
	(inreceptacle item1_handbag_largeitem receptacle17_couch)
	(inreceptacle item43_vase_mediumitem receptacle36_refrigerator)
	(inreceptacle item9_cup_smallitem receptacle33_sink)
	(inreceptacle item22_potted_plant_largeitem receptacle15_chair)
	(inreceptacle item2_handbag_largeitem receptacle23_bed)
	(inreceptacle item10_cup_smallitem receptacle18_couch)
	(inreceptacle item27_laptop_mediumitem receptacle23_bed)))
)

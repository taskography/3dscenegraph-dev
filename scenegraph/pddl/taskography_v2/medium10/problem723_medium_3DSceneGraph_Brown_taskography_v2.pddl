...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg59_Yneg33_place3_room1_floorB)
  ...
  (:goal (and
	(inreceptacle item26_clock_mediumitem receptacle4_oven)
	(inreceptacle item51_tv_largeitem receptacle35_toilet)
	(inreceptacle item28_clock_mediumitem receptacle6_sink)
	(inreceptacle item22_clock_mediumitem receptacle40_chair)
	(inreceptacle item17_bottle_smallitem receptacle10_sink)
	(inreceptacle item33_bowl_smallitem receptacle8_sink)
	(inreceptacle item18_bottle_smallitem receptacle50_dining_table)
	(inreceptacle item21_clock_mediumitem receptacle15_refrigerator)
	(inreceptacle item46_potted_plant_largeitem receptacle38_toilet)
	(inreceptacle item24_clock_mediumitem receptacle32_bench)))
)

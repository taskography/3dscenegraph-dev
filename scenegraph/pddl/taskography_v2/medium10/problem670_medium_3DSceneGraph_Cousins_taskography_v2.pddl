...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	(inreceptacle item121_book_smallitem receptacle93_bed)
	(inreceptacle item23_apple_smallitem receptacle47_couch)
	(inreceptacle item14_wine_glass_smallitem receptacle47_couch)
	(inreceptacle item135_teddy_bear_mediumitem receptacle116_refrigerator)
	(inreceptacle item136_teddy_bear_mediumitem receptacle28_chair)
	(inreceptacle item26_cake_mediumitem receptacle96_bed)
	(inreceptacle item24_cake_mediumitem receptacle31_chair)
	(inreceptacle item128_book_smallitem receptacle40_chair)
	(inreceptacle item56_potted_plant_largeitem receptacle96_bed)
	(inreceptacle item123_book_smallitem receptacle96_bed)))
)

...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg17_Yneg39_place13_room11_floorB)
	...
	(inplace agent place13_door_room11_corridor)
  ...
  (:goal (and
	(inreceptacle item58_potted_plant_largeitem receptacle99_toilet)
	(inreceptacle item19_bowl_smallitem receptacle40_chair)
	(inreceptacle item135_teddy_bear_mediumitem receptacle29_chair)
	(inreceptacle item60_potted_plant_largeitem receptacle32_chair)
	(inreceptacle item88_potted_plant_largeitem receptacle96_bed)
	(inreceptacle item23_apple_smallitem receptacle51_couch)
	(inreceptacle item76_potted_plant_largeitem receptacle41_chair)
	(inreceptacle item26_cake_mediumitem receptacle92_bed)
	(inreceptacle item62_potted_plant_largeitem receptacle94_bed)
	(inreceptacle item129_clock_mediumitem receptacle30_chair)))
)

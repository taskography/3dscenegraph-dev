...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos126_Yneg99_place7_room1_floorA)
  ...
  (:goal (and
	(inreceptacle item15_bicycle_largeitem receptacle36_toilet)
	(inreceptacle item30_bottle_smallitem receptacle43_refrigerator)
	(inreceptacle item28_sports_ball_largeitem receptacle35_chair)
	(inreceptacle item9_bicycle_largeitem receptacle41_sink)
	(inreceptacle item10_bicycle_largeitem receptacle21_bench)
	(inreceptacle item27_suitcase_largeitem receptacle20_bench)
	(inreceptacle item31_bottle_smallitem receptacle36_toilet)
	(inreceptacle item17_motorcycle_largeitem receptacle43_refrigerator)
	(inreceptacle item2_bicycle_largeitem receptacle35_chair)

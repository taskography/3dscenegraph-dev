...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg26_Ypos12_place4_room10_floorA)
	...
	(inplace agent place4_door_room10_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item5_bottle_smallitem receptacle28_microwave)
	(inreceptacle item7_bottle_smallitem receptacle36_refrigerator)
	(inreceptacle item27_laptop_mediumitem receptacle35_sink)
	(inreceptacle item40_book_smallitem receptacle17_couch)
	(inreceptacle item42_vase_mediumitem receptacle37_refrigerator)
	(inreceptacle item8_bottle_smallitem receptacle32_sink)
	...
	(inreceptacle item4_bottle_smallitem receptacle36_refrigerator)))
)

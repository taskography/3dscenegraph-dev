...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xneg7_Yneg39_place20_room21_floorA)
	...
	(inplace agent place20_door_room21_staircase)
  ...
  (:goal (and
	(inreceptacle item21_bowl_smallitem receptacle99_toilet)
	(inreceptacle item54_potted_plant_largeitem receptacle114_sink)
	(inreceptacle item130_clock_mediumitem receptacle93_bed)
	(inreceptacle item87_potted_plant_largeitem receptacle32_chair)
	(inreceptacle item4_tie_smallitem receptacle38_chair)
	(inreceptacle item82_potted_plant_largeitem receptacle112_sink)
	(inreceptacle item22_apple_smallitem receptacle92_bed)
	(inreceptacle item57_potted_plant_largeitem receptacle35_chair)
	(inreceptacle item76_potted_plant_largeitem receptacle40_chair)
	(inreceptacle item120_book_smallitem receptacle111_sink)))
)

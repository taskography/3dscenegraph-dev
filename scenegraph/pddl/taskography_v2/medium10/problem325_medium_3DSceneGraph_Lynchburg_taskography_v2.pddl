...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos45_Ypos4_place11_room10_floorA)
	...
	(inplace agent place11_door_room10_living_room)
  ...
  (:goal (and
	(inreceptacle item10_bottle_smallitem receptacle60_microwave)
	(inreceptacle item44_potted_plant_largeitem receptacle20_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle67_refrigerator)
	(inreceptacle item74_book_smallitem receptacle55_toilet)
	(inreceptacle item14_cup_smallitem receptacle19_chair)
	(inreceptacle item15_knife_smallitem receptacle63_sink)
	(inreceptacle item70_book_smallitem receptacle46_bed)
	(inreceptacle item13_cup_smallitem receptacle29_chair)
	(inreceptacle item9_bottle_smallitem receptacle46_bed)

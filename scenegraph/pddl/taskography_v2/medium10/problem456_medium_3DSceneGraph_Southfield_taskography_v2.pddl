...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:goal (and
	...
	(inreceptacle item19_clock_mediumitem receptacle14_refrigerator)
	(inreceptacle item20_clock_mediumitem receptacle23_bench)
	(inreceptacle item29_umbrella_largeitem receptacle35_bed)
	(inreceptacle item30_umbrella_largeitem receptacle28_chair)
	(inreceptacle item16_bottle_smallitem receptacle13_refrigerator)
	(inreceptacle item24_tie_smallitem receptacle4_sink)
	(inreceptacle item31_umbrella_largeitem receptacle34_bed)
	(inreceptacle item17_bottle_smallitem receptacle10_sink)
	(inreceptacle item3_surfboard_largeitem receptacle13_refrigerator)))
)

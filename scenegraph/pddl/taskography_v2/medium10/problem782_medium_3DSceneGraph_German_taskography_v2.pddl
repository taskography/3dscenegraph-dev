...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos109_Yneg52_place4_room8_floorA)
	...
	(inplace agent place4_door_room8_reception)
  ...
  (:goal (and
	(inreceptacle item39_laptop_mediumitem receptacle41_sink)
	(inreceptacle item37_tv_largeitem receptacle43_refrigerator)
	(inreceptacle item8_bicycle_largeitem receptacle22_bench)
	(inreceptacle item31_bottle_smallitem receptacle43_refrigerator)
	(inreceptacle item13_bicycle_largeitem receptacle34_chair)
	(inreceptacle item6_bicycle_largeitem receptacle19_bench)
	(inreceptacle item11_bicycle_largeitem receptacle41_sink)
	(inreceptacle item23_suitcase_largeitem receptacle20_bench)
	(inreceptacle item27_suitcase_largeitem receptacle42_refrigerator)
	(inreceptacle item40_laptop_mediumitem receptacle42_refrigerator)))
)

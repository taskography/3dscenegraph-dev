...
(define (problem taskograph_rearrangement) (:domain taskography_v2)
  ...
  (:init 
	(atlocation agent location_Xpos43_Ypos19_place0_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item26_potted_plant_largeitem receptacle11_refrigerator)
	...
	(inreceptacle item5_surfboard_largeitem receptacle13_refrigerator)
	(inreceptacle item25_potted_plant_largeitem receptacle9_sink)
	(inreceptacle item4_surfboard_largeitem receptacle21_toilet)

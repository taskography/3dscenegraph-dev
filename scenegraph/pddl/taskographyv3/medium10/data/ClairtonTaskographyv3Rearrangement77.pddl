...
(define (problem ClairtonTaskographyv3Rearrangement77) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg10_Ypos11_place5_room4_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item2_tie_smallitem receptacle19_couch)
	...
	(inreceptacle item50_book_smallitem receptacle37_toilet)
	(inreceptacle item26_potted_plant_largeitem receptacle11_chair)
	(inreceptacle item22_potted_plant_largeitem receptacle31_bed)))
)

...
(define (problem GermanTaskographyv3Rearrangement96) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos126_Yneg99_place7_room1_floorA)
	...
	(inplace robot place7_door_room1_bathroom)
  ...
  (:goal (and
	(inreceptacle item13_bicycle_largeitem receptacle20_bench)
	(inreceptacle item11_bicycle_largeitem receptacle41_sink)
	(inreceptacle item30_bottle_smallitem receptacle43_refrigerator)
	(inreceptacle item2_bicycle_largeitem receptacle36_toilet)
	(inreceptacle item39_laptop_mediumitem receptacle20_bench)
	(inreceptacle item37_tv_largeitem receptacle20_bench)
	(inreceptacle item29_bottle_smallitem receptacle21_bench)
	(inreceptacle item40_laptop_mediumitem receptacle21_bench)
	(inreceptacle item32_bottle_smallitem receptacle44_refrigerator)
	(inreceptacle item26_suitcase_largeitem receptacle36_toilet)))
)

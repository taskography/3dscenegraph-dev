...
(define (problem AnaheimTaskographyv3Rearrangement74) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item12_cup_smallitem receptacle37_bed)
	(inreceptacle item46_laptop_mediumitem receptacle54_sink)
	(inreceptacle item11_cup_smallitem receptacle43_toilet)

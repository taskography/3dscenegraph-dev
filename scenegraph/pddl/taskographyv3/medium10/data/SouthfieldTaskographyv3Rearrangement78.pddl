...
(define (problem SouthfieldTaskographyv3Rearrangement78) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg4_Yneg4_place18_room12_floorB)
	...
	(inplace robot place18_door_room12_empty_room)
  ...
  (:goal (and
	(inreceptacle item24_tie_smallitem receptacle6_sink)
	(inreceptacle item29_umbrella_largeitem receptacle8_sink)
	...
	(inreceptacle item18_bottle_smallitem receptacle22_bench)
	(inreceptacle item17_bottle_smallitem receptacle13_refrigerator)
	(inreceptacle item19_clock_mediumitem receptacle27_toilet)

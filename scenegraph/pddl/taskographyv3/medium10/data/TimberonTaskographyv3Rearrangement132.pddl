...
(define (problem TimberonTaskographyv3Rearrangement132) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos24_Yneg48_place6_room16_floorA)
	...
	(inplace robot place6_door_room16_television_room)
	...
	(inroom robot room16_television_room)
  ...
  (:goal (and
	(inreceptacle item38_potted_plant_largeitem receptacle29_chair)

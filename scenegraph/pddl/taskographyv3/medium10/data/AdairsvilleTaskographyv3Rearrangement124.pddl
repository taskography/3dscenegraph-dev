...
(define (problem AdairsvilleTaskographyv3Rearrangement124) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item43_tv_largeitem receptacle2_oven)
	(inreceptacle item15_vase_mediumitem receptacle38_bed)

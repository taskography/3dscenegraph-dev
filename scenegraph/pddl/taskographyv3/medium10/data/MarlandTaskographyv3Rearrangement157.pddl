...
(define (problem MarlandTaskographyv3Rearrangement157) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos20_Yneg29_place12_room5_floorB)
	...
	(inplace robot place12_door_room5_closet)
  ...
  (:goal (and
	...
	(inreceptacle item44_tv_largeitem receptacle18_toilet)

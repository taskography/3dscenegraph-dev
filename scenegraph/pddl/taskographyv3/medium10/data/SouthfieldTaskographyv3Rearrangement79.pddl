...
(define (problem SouthfieldTaskographyv3Rearrangement79) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos3_Ypos1_place9_room20_floorA)
	...
	(inplace robot place9_door_room20_storage)
  ...
  (:goal (and
	...
	(inreceptacle item29_umbrella_largeitem receptacle25_toilet)
	(inreceptacle item17_bottle_smallitem receptacle11_refrigerator)
	(inreceptacle item30_umbrella_largeitem receptacle9_sink)
	(inreceptacle item31_umbrella_largeitem receptacle13_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle14_refrigerator)
	(inreceptacle item19_clock_mediumitem receptacle22_bench)
	(inreceptacle item3_surfboard_largeitem receptacle23_bench)))
)

...
(define (problem AdairsvilleTaskographyv3Rearrangement125) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg75_Ypos38_place4_room3_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item43_tv_largeitem receptacle25_chair)

...
(define (problem AirportTaskographyv3Rearrangement140) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	(inreceptacle item73_book_smallitem receptacle60_toilet)
	(inreceptacle item84_vase_mediumitem receptacle41_chair)
	(inreceptacle item56_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item82_vase_mediumitem receptacle31_chair)
	(inreceptacle item14_suitcase_largeitem receptacle71_refrigerator)
	(inreceptacle item3_bicycle_largeitem receptacle69_refrigerator)
	(inreceptacle item16_suitcase_largeitem receptacle58_dining_table)
	(inreceptacle item18_frisbee_mediumitem receptacle35_chair)
	(inreceptacle item19_sports_ball_largeitem receptacle57_bed)
	(inreceptacle item10_suitcase_largeitem receptacle35_chair)))
)

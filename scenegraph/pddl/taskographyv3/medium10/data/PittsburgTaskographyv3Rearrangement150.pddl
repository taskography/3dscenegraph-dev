...
(define (problem PittsburgTaskographyv3Rearrangement150) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item45_potted_plant_largeitem receptacle6_sink)
	(inreceptacle item21_bowl_smallitem receptacle37_chair)
	(inreceptacle item15_vase_mediumitem receptacle23_toilet)
	(inreceptacle item13_book_smallitem receptacle48_bed)
	(inreceptacle item10_bottle_smallitem receptacle38_couch)
	(inreceptacle item16_vase_mediumitem receptacle48_bed)

...
(define (problem HortenseTaskographyv3Rearrangement89) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item51_clock_mediumitem receptacle17_chair)
	(inreceptacle item8_bowl_smallitem receptacle38_sink)
	(inreceptacle item23_potted_plant_largeitem receptacle43_sink)
	(inreceptacle item33_laptop_mediumitem receptacle45_refrigerator)
	(inreceptacle item10_bowl_smallitem receptacle14_chair)
	(inreceptacle item52_vase_mediumitem receptacle44_refrigerator)
	(inreceptacle item4_bottle_smallitem receptacle17_chair)
	(inreceptacle item6_knife_smallitem receptacle34_microwave)

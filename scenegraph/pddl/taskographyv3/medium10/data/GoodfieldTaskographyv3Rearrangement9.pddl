...
(define (problem GoodfieldTaskographyv3Rearrangement9) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg30_Yneg33_place8_room20_floorB)
	...
	(inplace robot place8_door_room20_staircase)
  ...
  (:goal (and
	(inreceptacle item40_tv_largeitem receptacle32_couch)

...
(define (problem CousinsTaskographyv3Rearrangement152) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg57_Ypos6_place10_room7_floorB)
	...
	(inplace robot place10_door_room7_childs_room)
  ...
  (:goal (and
	(inreceptacle item58_potted_plant_largeitem receptacle93_bed)
	(inreceptacle item14_wine_glass_smallitem receptacle36_chair)
	(inreceptacle item132_vase_mediumitem receptacle111_sink)
	(inreceptacle item4_tie_smallitem receptacle35_chair)
	(inreceptacle item80_potted_plant_largeitem receptacle43_chair)
	(inreceptacle item64_potted_plant_largeitem receptacle50_couch)
	(inreceptacle item66_potted_plant_largeitem receptacle116_refrigerator)
	(inreceptacle item127_book_smallitem receptacle97_dining_table)
	(inreceptacle item25_cake_mediumitem receptacle95_bed)

...
(define (problem AncorTaskographyv3Rearrangement109) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg14_Yneg12_place4_room2_floorC)
  ...
  (:goal (and
	(inreceptacle item44_potted_plant_largeitem receptacle12_refrigerator)
	(inreceptacle item20_book_smallitem receptacle28_chair)
	(inreceptacle item21_vase_mediumitem receptacle6_oven)
	(inreceptacle item23_vase_mediumitem receptacle14_refrigerator)
	(inreceptacle item43_potted_plant_largeitem receptacle34_couch)
	(inreceptacle item41_potted_plant_largeitem receptacle50_bed)
	(inreceptacle item40_potted_plant_largeitem receptacle27_toilet)
	(inreceptacle item4_baseball_bat_largeitem receptacle24_dining_table)
	(inreceptacle item38_potted_plant_largeitem receptacle5_microwave)
	(inreceptacle item9_bottle_smallitem receptacle14_refrigerator)))
)

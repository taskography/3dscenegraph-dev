...
(define (problem AncorTaskographyv3Rearrangement108) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg42_Yneg2_place0_room4_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item46_potted_plant_largeitem receptacle34_couch)
	(inreceptacle item21_vase_mediumitem receptacle28_chair)
	(inreceptacle item3_baseball_bat_largeitem receptacle11_refrigerator)
	(inreceptacle item23_vase_mediumitem receptacle15_sink)
	(inreceptacle item45_potted_plant_largeitem receptacle31_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle6_oven)
	(inreceptacle item22_vase_mediumitem receptacle50_bed)
	(inreceptacle item2_baseball_bat_largeitem receptacle24_dining_table)
	(inreceptacle item37_potted_plant_largeitem receptacle25_dining_table)))
)

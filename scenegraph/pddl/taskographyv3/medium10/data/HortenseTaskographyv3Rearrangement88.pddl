...
(define (problem HortenseTaskographyv3Rearrangement88) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg19_Yneg29_place11_room6_floorA)
  ...
  (:goal (and
	(inreceptacle item24_potted_plant_largeitem receptacle40_sink)
	(inreceptacle item9_bowl_smallitem receptacle31_toilet)
	(inreceptacle item22_potted_plant_largeitem receptacle27_bed)
	(inreceptacle item23_potted_plant_largeitem receptacle39_sink)
	(inreceptacle item10_bowl_smallitem receptacle49_refrigerator)
	(inreceptacle item4_bottle_smallitem receptacle30_toilet)
	(inreceptacle item8_bowl_smallitem receptacle19_chair)
	(inreceptacle item5_cup_smallitem receptacle42_sink)
	(inreceptacle item2_bottle_smallitem receptacle42_sink)
	(inreceptacle item25_potted_plant_largeitem receptacle47_refrigerator)))
)

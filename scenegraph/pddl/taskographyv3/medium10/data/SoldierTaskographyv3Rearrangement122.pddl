...
(define (problem SoldierTaskographyv3Rearrangement122) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg94_Yneg23_place8_room14_floorA)
  ...
  (:goal (and
	(inreceptacle item8_knife_smallitem receptacle18_chair)
	(inreceptacle item66_clock_mediumitem receptacle43_dining_table)

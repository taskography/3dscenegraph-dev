...
(define (problem TokelandTaskographyv3Rearrangement159) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos4_Ypos15_place10_room11_floorA)
	...
	(inplace robot place10_door_room11_liviing_room)
	...
	(inroom robot room11_liviing_room)
  ...
  (:goal (and
	(inreceptacle item64_potted_plant_largeitem receptacle12_chair)
	(inreceptacle item2_sports_ball_largeitem receptacle17_chair)
	(inreceptacle item46_potted_plant_largeitem receptacle74_toilet)
	(inreceptacle item53_potted_plant_largeitem receptacle79_sink)
	(inreceptacle item62_potted_plant_largeitem receptacle22_chair)
	(inreceptacle item89_vase_mediumitem receptacle23_chair)
	(inreceptacle item75_tv_largeitem receptacle69_bed)
	(inreceptacle item41_potted_plant_largeitem receptacle32_couch)
	(inreceptacle item66_potted_plant_largeitem receptacle81_sink)

...
(define (problem GermanTaskographyv3Rearrangement97) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item33_cup_smallitem receptacle34_chair)
	(inreceptacle item3_bicycle_largeitem receptacle34_chair)
	(inreceptacle item8_bicycle_largeitem receptacle34_chair)
	(inreceptacle item16_motorcycle_largeitem receptacle36_toilet)
	(inreceptacle item40_laptop_mediumitem receptacle41_sink)
	(inreceptacle item24_suitcase_largeitem receptacle19_bench)
	(inreceptacle item31_bottle_smallitem receptacle22_bench)
	(inreceptacle item11_bicycle_largeitem receptacle21_bench)
	(inreceptacle item18_motorcycle_largeitem receptacle41_sink)))
)

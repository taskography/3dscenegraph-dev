...
(define (problem TimberonTaskographyv3Rearrangement133) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	(inreceptacle item50_tv_largeitem receptacle47_toilet)
	(inreceptacle item54_tv_largeitem receptacle61_sink)
	(inreceptacle item6_bottle_smallitem receptacle44_toilet)
	(inreceptacle item10_bottle_smallitem receptacle31_couch)
	(inreceptacle item78_vase_mediumitem receptacle22_chair)
	(inreceptacle item51_tv_largeitem receptacle22_chair)
	(inreceptacle item13_bottle_smallitem receptacle22_chair)
	(inreceptacle item37_potted_plant_largeitem receptacle63_sink)
	(inreceptacle item58_keyboard_largeitem receptacle18_chair)
	(inreceptacle item49_tv_largeitem receptacle63_sink)))
)

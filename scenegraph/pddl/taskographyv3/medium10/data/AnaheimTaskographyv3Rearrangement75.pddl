...
(define (problem AnaheimTaskographyv3Rearrangement75) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg25_Ypos9_place8_room6_floorC)
  ...
  (:goal (and
	(inreceptacle item6_bottle_smallitem receptacle47_microwave)
	...
	(inreceptacle item13_cup_smallitem receptacle50_sink)
	(inreceptacle item33_potted_plant_largeitem receptacle50_sink)
	(inreceptacle item5_bottle_smallitem receptacle25_chair)
	(inreceptacle item7_bottle_smallitem receptacle25_chair)
	(inreceptacle item11_cup_smallitem receptacle41_dining_table)

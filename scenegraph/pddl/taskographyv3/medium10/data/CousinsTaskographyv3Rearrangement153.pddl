...
(define (problem CousinsTaskographyv3Rearrangement153) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg1_Ypos6_place21_room6_floorB)
	...
	(inplace robot place21_door_room6_childs_room)
  ...
  (:goal (and
	(inreceptacle item70_potted_plant_largeitem receptacle34_chair)
	(inreceptacle item79_potted_plant_largeitem receptacle28_chair)
	(inreceptacle item80_potted_plant_largeitem receptacle100_toilet)
	(inreceptacle item77_potted_plant_largeitem receptacle114_sink)
	(inreceptacle item71_potted_plant_largeitem receptacle91_bed)
	(inreceptacle item122_book_smallitem receptacle111_sink)
	(inreceptacle item14_wine_glass_smallitem receptacle97_dining_table)
	(inreceptacle item12_wine_glass_smallitem receptacle43_chair)
	(inreceptacle item119_book_smallitem receptacle92_bed)
	(inreceptacle item82_potted_plant_largeitem receptacle110_sink)))
)

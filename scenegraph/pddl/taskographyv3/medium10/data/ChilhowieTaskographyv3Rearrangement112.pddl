...
(define (problem ChilhowieTaskographyv3Rearrangement112) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg62_Yneg21_place5_room8_floorA)
  ...
  (:goal (and
	(inreceptacle item8_surfboard_largeitem receptacle46_sink)
	(inreceptacle item50_clock_mediumitem receptacle13_chair)
	(inreceptacle item5_tie_smallitem receptacle43_sink)
	(inreceptacle item6_tie_smallitem receptacle20_couch)
	(inreceptacle item52_vase_mediumitem receptacle41_oven)
	(inreceptacle item9_banana_smallitem receptacle41_oven)
	(inreceptacle item35_tv_largeitem receptacle23_couch)
	(inreceptacle item51_vase_mediumitem receptacle41_oven)
	(inreceptacle item34_tv_largeitem receptacle48_refrigerator)
	(inreceptacle item1_backpack_largeitem receptacle16_chair)))
)

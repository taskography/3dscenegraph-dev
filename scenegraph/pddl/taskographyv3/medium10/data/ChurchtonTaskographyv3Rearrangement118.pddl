...
(define (problem ChurchtonTaskographyv3Rearrangement118) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item4_tie_smallitem receptacle53_sink)
	(inreceptacle item63_toothbrush_smallitem receptacle34_bed)
	(inreceptacle item1_bicycle_largeitem receptacle40_dining_table)
	(inreceptacle item47_tv_largeitem receptacle34_bed)
	(inreceptacle item62_toothbrush_smallitem receptacle38_dining_table)))
)

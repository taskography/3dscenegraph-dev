...
(define (problem SoldierTaskographyv3Rearrangement123) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg52_Ypos14_place7_room10_floorA)
	...
	(inplace robot place7_door_room10_dining_room)
  ...
  (:goal (and
	(inreceptacle item4_tie_smallitem receptacle33_couch)
	(inreceptacle item48_tv_largeitem receptacle43_dining_table)
	(inreceptacle item70_clock_mediumitem receptacle42_dining_table)
	(inreceptacle item2_umbrella_largeitem receptacle52_sink)
	(inreceptacle item80_vase_mediumitem receptacle14_chair)
	(inreceptacle item69_clock_mediumitem receptacle45_toilet)
	(inreceptacle item5_suitcase_largeitem receptacle52_sink)
	(inreceptacle item61_book_smallitem receptacle20_chair)
	(inreceptacle item67_clock_mediumitem receptacle19_chair)
	(inreceptacle item66_clock_mediumitem receptacle24_chair)))
)

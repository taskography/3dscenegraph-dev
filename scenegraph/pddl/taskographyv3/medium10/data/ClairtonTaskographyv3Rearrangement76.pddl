...
(define (problem ClairtonTaskographyv3Rearrangement76) (:domain taskographyv3)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:goal (and
	(inreceptacle item21_potted_plant_largeitem receptacle43_sink)
	(inreceptacle item49_book_smallitem receptacle33_bed)
	(inreceptacle item25_potted_plant_largeitem receptacle38_toilet)
	(inreceptacle item47_book_smallitem receptacle34_dining_table)
	(inreceptacle item4_bowl_smallitem receptacle43_sink)
	(inreceptacle item27_potted_plant_largeitem receptacle7_chair)
	(inreceptacle item48_book_smallitem receptacle12_chair)
	(inreceptacle item5_banana_smallitem receptacle16_chair)

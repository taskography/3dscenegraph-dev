...
(define (problem BenevolenceTaskographyv2Rearrangement25.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item39_tv_largeitem receptacle25_chair)
	...
	(inreceptacle item12_bottle_smallitem receptacle37_dining_table)

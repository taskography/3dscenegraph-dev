...
(define (problem PomariaTaskographyv2Rearrangement2.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg96_Yneg1_place0_room17_floorA)
	...
	(inplace robot place0_door_room17_television_room)
  ...
  (:goal (and
	(inreceptacle item85_book_smallitem receptacle3_chair)
	(inreceptacle item64_book_smallitem receptacle3_chair)
	(inreceptacle item53_book_smallitem receptacle22_bed)
	(inreceptacle item63_book_smallitem receptacle34_sink)
	(inreceptacle item19_potted_plant_largeitem receptacle33_oven)
	(inreceptacle item46_book_smallitem receptacle4_chair)
	(inreceptacle item50_book_smallitem receptacle35_sink)
	(inreceptacle item52_book_smallitem receptacle4_chair)
	(inreceptacle item40_book_smallitem receptacle35_sink)
	(inreceptacle item79_book_smallitem receptacle22_bed)))
)

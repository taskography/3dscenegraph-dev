...
(define (problem ArkansawTaskographyv2Rearrangement13.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg34_Ypos44_place0_room14_floorA)
	...
	(inplace robot place0_door_room14_living_room)
  ...
  (:goal (and
	(inreceptacle item8_bowl_smallitem receptacle19_chair)
	(inreceptacle item2_suitcase_largeitem receptacle50_toilet)
	(inreceptacle item71_vase_mediumitem receptacle56_oven)
	(inreceptacle item73_vase_mediumitem receptacle24_chair)
	(inreceptacle item76_vase_mediumitem receptacle31_chair)
	(inreceptacle item70_vase_mediumitem receptacle29_chair)
	(inreceptacle item65_book_smallitem receptacle59_sink)
	(inreceptacle item68_clock_mediumitem receptacle23_chair)
	(inreceptacle item5_cup_smallitem receptacle18_chair)
	(inreceptacle item77_teddy_bear_mediumitem receptacle42_bed)))
)

...
(define (problem MarlandTaskographyv2Rearrangement24.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg91_Yneg5_place5_room9_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item42_tv_largeitem receptacle23_chair)

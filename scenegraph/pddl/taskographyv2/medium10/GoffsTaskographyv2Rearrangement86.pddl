...
(define (problem GoffsTaskographyv2Rearrangement86.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg11_Yneg14_place12_room6_floorB)
  ...
  (:goal (and
	(inreceptacle item11_bottle_smallitem receptacle37_bed)
	(inreceptacle item71_book_smallitem receptacle59_sink)
	(inreceptacle item79_book_smallitem receptacle56_oven)
	(inreceptacle item4_umbrella_largeitem receptacle23_chair)
	(inreceptacle item53_keyboard_largeitem receptacle57_sink)
	(inreceptacle item6_suitcase_largeitem receptacle66_refrigerator)
	(inreceptacle item84_book_smallitem receptacle27_chair)
	(inreceptacle item80_book_smallitem receptacle40_bed)
	(inreceptacle item54_cell_phone_smallitem receptacle59_sink)

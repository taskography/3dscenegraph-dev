...
(define (problem ClairtonTaskographyv2Rearrangement15.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg77_Yneg46_place4_room6_floorA)
	...
	(inplace robot place4_door_room6_dining_room)
  ...
  (:goal (and
	(inreceptacle item48_book_smallitem receptacle35_dining_table)
	...
	(inreceptacle item49_book_smallitem receptacle36_dining_table)
	(inreceptacle item2_tie_smallitem receptacle17_couch)
	(inreceptacle item39_tv_largeitem receptacle10_chair)
	...
	(inreceptacle item21_potted_plant_largeitem receptacle44_sink)
	(inreceptacle item53_clock_mediumitem receptacle19_couch)))
)

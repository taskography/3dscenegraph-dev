...
(define (problem AirportTaskographyv2Rearrangement85.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg35_Yneg16_place8_room4_floorC)
  ...
  (:goal (and
	(inreceptacle item76_clock_mediumitem receptacle64_microwave)
	(inreceptacle item8_umbrella_largeitem receptacle35_chair)
	(inreceptacle item73_book_smallitem receptacle44_chair)
	(inreceptacle item14_suitcase_largeitem receptacle65_oven)
	(inreceptacle item2_bicycle_largeitem receptacle64_microwave)
	(inreceptacle item82_vase_mediumitem receptacle41_chair)
	(inreceptacle item85_vase_mediumitem receptacle37_chair)
	...
	(inreceptacle item79_vase_mediumitem receptacle72_refrigerator)))
)

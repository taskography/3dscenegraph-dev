...
(define (problem DarrtownTaskographyv2Rearrangement46.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos39_Yneg69_place9_room2_floorB)
  ...
  (:goal (and
	(inreceptacle item69_book_smallitem receptacle51_toilet)
	(inreceptacle item17_bowl_smallitem receptacle53_oven)
	(inreceptacle item13_cup_smallitem receptacle50_toilet)
	(inreceptacle item68_book_smallitem receptacle22_chair)
	(inreceptacle item16_spoon_smallitem receptacle48_toilet)
	(inreceptacle item12_cup_smallitem receptacle53_oven)
	(inreceptacle item6_baseball_bat_largeitem receptacle51_toilet)
	(inreceptacle item14_cup_smallitem receptacle50_toilet)
	(inreceptacle item7_bottle_smallitem receptacle26_chair)
	(inreceptacle item5_baseball_bat_largeitem receptacle24_chair)))
)

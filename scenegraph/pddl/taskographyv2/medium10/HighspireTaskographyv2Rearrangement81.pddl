...
(define (problem HighspireTaskographyv2Rearrangement81.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos18_Yneg14_place1_room11_floorC)
	...
	(inplace robot place1_door_room11_home_office)
	...
	(inroom robot room11_home_office)
  ...
  (:goal (and
	(inreceptacle item46_vase_mediumitem receptacle14_chair)
	(inreceptacle item45_clock_mediumitem receptacle34_oven)
	(inreceptacle item6_bowl_smallitem receptacle16_chair)
	(inreceptacle item32_tv_largeitem receptacle7_chair)
	(inreceptacle item47_vase_mediumitem receptacle39_sink)
	(inreceptacle item29_tv_largeitem receptacle37_sink)
	(inreceptacle item4_bottle_smallitem receptacle41_sink)
	(inreceptacle item48_teddy_bear_mediumitem receptacle10_chair)

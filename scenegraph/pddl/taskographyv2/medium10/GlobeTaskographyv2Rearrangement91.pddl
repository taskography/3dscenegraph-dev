...
(define (problem GlobeTaskographyv2Rearrangement91.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg69_Ypos25_place15_room10_floorC)
  ...
  (:goal (and
	(inreceptacle item8_bowl_smallitem receptacle29_couch)
	(inreceptacle item64_book_smallitem receptacle15_chair)
	(inreceptacle item66_clock_mediumitem receptacle53_toilet)
	(inreceptacle item33_potted_plant_largeitem receptacle29_couch)
	(inreceptacle item67_vase_mediumitem receptacle16_chair)
	(inreceptacle item65_clock_mediumitem receptacle51_dining_table)

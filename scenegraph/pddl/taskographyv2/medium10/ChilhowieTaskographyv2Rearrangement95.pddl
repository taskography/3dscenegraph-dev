...
(define (problem ChilhowieTaskographyv2Rearrangement95.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg51_Ypos72_place12_room3_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item1_backpack_largeitem receptacle40_oven)
	(inreceptacle item36_tv_largeitem receptacle33_toilet)
	(inreceptacle item7_tie_smallitem receptacle46_sink)
	(inreceptacle item35_tv_largeitem receptacle18_chair)
	(inreceptacle item52_vase_mediumitem receptacle15_chair)
	...
	(inreceptacle item50_clock_mediumitem receptacle29_dining_table)))
)

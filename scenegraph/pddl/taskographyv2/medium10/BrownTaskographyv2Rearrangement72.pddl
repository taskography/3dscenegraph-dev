...
(define (problem BrownTaskographyv2Rearrangement72.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg29_Yneg31_place22_room9_floorA)
  ...
  (:goal (and
	(inreceptacle item18_bottle_smallitem receptacle48_bed)
	(inreceptacle item33_bowl_smallitem receptacle41_chair)
	(inreceptacle item17_bottle_smallitem receptacle13_refrigerator)
	(inreceptacle item44_potted_plant_largeitem receptacle3_oven)
	...
	(inreceptacle item20_bottle_smallitem receptacle6_sink)
	(inreceptacle item26_clock_mediumitem receptacle37_toilet)
	(inreceptacle item27_clock_mediumitem receptacle8_sink)))
)

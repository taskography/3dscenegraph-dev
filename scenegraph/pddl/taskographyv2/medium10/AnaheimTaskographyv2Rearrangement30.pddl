...
(define (problem AnaheimTaskographyv2Rearrangement30.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item46_laptop_mediumitem receptacle36_bed)
	(inreceptacle item60_book_smallitem receptacle23_chair)
	(inreceptacle item59_book_smallitem receptacle16_chair)
	(inreceptacle item61_vase_mediumitem receptacle28_chair)

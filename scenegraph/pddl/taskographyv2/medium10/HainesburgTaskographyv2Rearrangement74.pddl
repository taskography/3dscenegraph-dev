...
(define (problem HainesburgTaskographyv2Rearrangement74.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item31_potted_plant_largeitem receptacle12_refrigerator)
	...
	(inreceptacle item24_banana_smallitem receptacle7_sink)
	(inreceptacle item19_bottle_smallitem receptacle7_sink)
	(inreceptacle item17_bottle_smallitem receptacle7_sink)
	(inreceptacle item23_clock_mediumitem receptacle9_sink)

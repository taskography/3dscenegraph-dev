...
(define (problem AnnonaTaskographyv2Rearrangement82) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos1_Ypos55_place15_room8_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item18_book_smallitem receptacle42_chair)
	(inreceptacle item21_vase_mediumitem receptacle39_chair)
	(inreceptacle item27_banana_smallitem receptacle30_toilet)
	(inreceptacle item50_potted_plant_largeitem receptacle3_sink)
	(inreceptacle item48_potted_plant_largeitem receptacle55_bed)
	(inreceptacle item47_potted_plant_largeitem receptacle10_refrigerator)
	(inreceptacle item1_umbrella_largeitem receptacle38_chair)
	(inreceptacle item23_vase_mediumitem receptacle12_refrigerator)
	(inreceptacle item19_cup_smallitem receptacle42_chair)))
)

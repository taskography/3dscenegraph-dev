...
(define (problem WaipahuTaskographyv2Rearrangement115) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item55_book_smallitem receptacle33_bed)
	...
	(inreceptacle item8_bowl_smallitem receptacle40_dining_table)
	(inreceptacle item58_clock_mediumitem receptacle53_refrigerator)))
)

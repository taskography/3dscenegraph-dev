...
(define (problem PittsburgTaskographyv2Rearrangement151) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos34_Yneg9_place7_room9_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item44_potted_plant_largeitem receptacle51_dining_table)
	(inreceptacle item15_vase_mediumitem receptacle50_dining_table)
	(inreceptacle item14_book_smallitem receptacle30_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item9_bottle_smallitem receptacle51_dining_table)
	(inreceptacle item13_book_smallitem receptacle31_chair)
	(inreceptacle item10_bottle_smallitem receptacle25_toilet)
	(inreceptacle item45_potted_plant_largeitem receptacle1_microwave)

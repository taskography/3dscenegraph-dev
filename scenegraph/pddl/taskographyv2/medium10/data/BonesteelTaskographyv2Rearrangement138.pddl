...
(define (problem BonesteelTaskographyv2Rearrangement138) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg17_Ypos60_place1_room12_floorA)
	...
	(inplace robot place1_door_room12_kitchen)
  ...
  (:goal (and
	(inreceptacle item64_clock_mediumitem receptacle54_oven)
	(inreceptacle item66_vase_mediumitem receptacle19_chair)
	(inreceptacle item7_bottle_smallitem receptacle18_chair)
	(inreceptacle item62_book_smallitem receptacle11_chair)
	(inreceptacle item8_bottle_smallitem receptacle23_couch)
	(inreceptacle item35_potted_plant_largeitem receptacle48_dining_table)
	(inreceptacle item68_vase_mediumitem receptacle44_dining_table)
	(inreceptacle item34_potted_plant_largeitem receptacle52_microwave)
	(inreceptacle item65_clock_mediumitem receptacle10_chair)
	(inreceptacle item30_potted_plant_largeitem receptacle42_bed)))
)

...
(define (problem BonesteelTaskographyv2Rearrangement139) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg11_Ypos30_place13_room14_floorA)
  ...
  (:goal (and
	(inreceptacle item33_potted_plant_largeitem receptacle53_oven)
	...
	(inreceptacle item66_vase_mediumitem receptacle49_toilet)
	(inreceptacle item65_clock_mediumitem receptacle20_chair)
	(inreceptacle item5_bottle_smallitem receptacle45_dining_table)
	(inreceptacle item27_potted_plant_largeitem receptacle13_chair)
	(inreceptacle item36_potted_plant_largeitem receptacle54_oven)

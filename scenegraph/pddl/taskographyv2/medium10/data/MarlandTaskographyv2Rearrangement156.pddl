...
(define (problem MarlandTaskographyv2Rearrangement156) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg56_Yneg58_place16_room16_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item11_vase_mediumitem receptacle19_toilet)
	(inreceptacle item45_tv_largeitem receptacle37_dining_table)
	...
	(inreceptacle item41_tv_largeitem receptacle29_couch)
	(inreceptacle item31_potted_plant_largeitem receptacle2_oven)
	(inreceptacle item44_tv_largeitem receptacle28_chair)))
)

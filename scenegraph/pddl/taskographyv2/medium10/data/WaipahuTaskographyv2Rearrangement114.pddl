...
(define (problem WaipahuTaskographyv2Rearrangement114) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item56_clock_mediumitem receptacle54_refrigerator)
	(inreceptacle item3_suitcase_largeitem receptacle48_sink)
	(inreceptacle item44_tv_largeitem receptacle33_bed)
	(inreceptacle item8_bowl_smallitem receptacle10_chair)
	(inreceptacle item57_clock_mediumitem receptacle54_refrigerator)
	...
	(inreceptacle item58_clock_mediumitem receptacle48_sink)))
)

...
(define (problem BrownTaskographyv2Rearrangement116) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg16_Ypos38_place25_room12_floorB)
	...
	(inplace robot place25_door_room12_corridor)
  ...
  (:goal (and
	(inreceptacle item46_potted_plant_largeitem receptacle10_sink)
	(inreceptacle item25_clock_mediumitem receptacle49_bed)
	(inreceptacle item23_clock_mediumitem receptacle36_toilet)
	(inreceptacle item22_clock_mediumitem receptacle30_bench)
	(inreceptacle item45_potted_plant_largeitem receptacle42_chair)
	(inreceptacle item19_bottle_smallitem receptacle34_toilet)
	(inreceptacle item20_bottle_smallitem receptacle48_bed)
	(inreceptacle item24_clock_mediumitem receptacle5_sink)
	(inreceptacle item18_bottle_smallitem receptacle14_refrigerator)
	(inreceptacle item27_clock_mediumitem receptacle48_bed)))
)

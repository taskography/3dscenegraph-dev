...
(define (problem GoodfieldTaskographyv2Rearrangement8) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg15_Ypos5_place10_room15_floorC)
  ...
  (:goal (and
	...
	(inreceptacle item7_bottle_smallitem receptacle27_couch)
	...
	(inreceptacle item54_book_smallitem receptacle47_sink)
	(inreceptacle item57_vase_mediumitem receptacle42_oven)
	(inreceptacle item4_surfboard_largeitem receptacle20_chair)

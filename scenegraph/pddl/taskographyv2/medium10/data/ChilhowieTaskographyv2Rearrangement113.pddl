...
(define (problem ChilhowieTaskographyv2Rearrangement113) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg16_Ypos0_place4_room14_floorA)
	...
	(inplace robot place4_door_room14_living_room)
  ...
  (:goal (and
	...
	(inreceptacle item50_clock_mediumitem receptacle43_sink)
	(inreceptacle item1_backpack_largeitem receptacle39_microwave)
	(inreceptacle item52_vase_mediumitem receptacle42_sink)
	...
	(inreceptacle item37_tv_largeitem receptacle25_couch)
	(inreceptacle item7_tie_smallitem receptacle23_couch)
	(inreceptacle item8_surfboard_largeitem receptacle12_chair)))
)

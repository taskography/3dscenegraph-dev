...
(define (problem AnnonaTaskographyv2Rearrangement83) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg31_Ypos54_place1_room12_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item47_potted_plant_largeitem receptacle57_dining_table)
	(inreceptacle item23_vase_mediumitem receptacle8_refrigerator)
	(inreceptacle item22_vase_mediumitem receptacle31_toilet)
	(inreceptacle item19_cup_smallitem receptacle46_couch)
	(inreceptacle item18_book_smallitem receptacle45_couch)
	(inreceptacle item16_book_smallitem receptacle53_bed)
	(inreceptacle item21_vase_mediumitem receptacle59_dining_table)
	(inreceptacle item20_vase_mediumitem receptacle39_chair)
	(inreceptacle item1_umbrella_largeitem receptacle44_chair)))
)

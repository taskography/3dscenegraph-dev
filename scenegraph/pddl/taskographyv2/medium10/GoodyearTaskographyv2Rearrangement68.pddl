...
(define (problem GoodyearTaskographyv2Rearrangement68.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg57_Yneg37_place12_room17_floorA)
	...
	(inplace robot place12_door_room17_utility_room)
  ...
  (:goal (and
	(inreceptacle item38_potted_plant_largeitem receptacle3_bench)
	(inreceptacle item51_potted_plant_largeitem receptacle62_dining_table)
	(inreceptacle item9_baseball_bat_largeitem receptacle25_chair)
	(inreceptacle item16_bowl_smallitem receptacle60_dining_table)
	(inreceptacle item14_bowl_smallitem receptacle19_chair)
	(inreceptacle item79_vase_mediumitem receptacle19_chair)
	(inreceptacle item49_potted_plant_largeitem receptacle25_chair)
	(inreceptacle item75_vase_mediumitem receptacle30_couch)
	(inreceptacle item8_kite_largeitem receptacle26_chair)
	(inreceptacle item52_potted_plant_largeitem receptacle58_bed)))
)

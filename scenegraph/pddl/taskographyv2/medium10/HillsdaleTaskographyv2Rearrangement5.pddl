...
(define (problem HillsdaleTaskographyv2Rearrangement5.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos16_Ypos2_place6_room11_floorA)
	...
	(inplace robot place6_door_room11_living_room)
  ...
  (:goal (and
	(inreceptacle item40_book_smallitem receptacle37_refrigerator)
	(inreceptacle item9_cup_smallitem receptacle26_toilet)
	(inreceptacle item22_potted_plant_largeitem receptacle19_couch)
	(inreceptacle item27_laptop_mediumitem receptacle23_bed)
	(inreceptacle item12_spoon_smallitem receptacle13_chair)
	(inreceptacle item3_handbag_largeitem receptacle24_dining_table)
	(inreceptacle item11_cup_smallitem receptacle16_chair)
	(inreceptacle item4_bottle_smallitem receptacle23_bed)

...
(define (problem WaipahuTaskographyv2Rearrangement18.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg43_Ypos31_place1_room7_floorA)
	...
	(inplace robot place1_door_room7_dining_room)
  ...
  (:goal (and
	(inreceptacle item55_book_smallitem receptacle20_chair)
	(inreceptacle item4_suitcase_largeitem receptacle52_refrigerator)
	...
	(inreceptacle item2_handbag_largeitem receptacle22_couch)
	(inreceptacle item5_bottle_smallitem receptacle24_couch)
	(inreceptacle item6_bottle_smallitem receptacle13_chair)
	(inreceptacle item27_potted_plant_largeitem receptacle39_dining_table)
	(inreceptacle item26_potted_plant_largeitem receptacle51_refrigerator)
	(inreceptacle item3_suitcase_largeitem receptacle49_sink)))
)

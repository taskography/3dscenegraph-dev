...
(define (problem ByersTaskographyv2Rearrangement56.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg52_Ypos13_place8_room4_floorC)
  ...
  (:goal (and
	(inreceptacle item55_vase_mediumitem receptacle46_sink)
	...
	(inreceptacle item4_tie_smallitem receptacle47_refrigerator)
	(inreceptacle item23_potted_plant_largeitem receptacle42_oven)
	(inreceptacle item9_spoon_smallitem receptacle30_toilet)
	(inreceptacle item7_suitcase_largeitem receptacle14_chair)
	(inreceptacle item50_clock_mediumitem receptacle43_oven)
	(inreceptacle item2_backpack_largeitem receptacle11_chair)))
)

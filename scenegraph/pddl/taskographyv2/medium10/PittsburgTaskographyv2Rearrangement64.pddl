...
(define (problem PittsburgTaskographyv2Rearrangement64.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos63_Yneg6_place6_room5_floorC)
  ...
  (:goal (and
	(inreceptacle item20_bowl_smallitem receptacle24_toilet)
	(inreceptacle item42_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item10_bottle_smallitem receptacle36_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle51_dining_table)
	(inreceptacle item19_vase_mediumitem receptacle2_oven)
	...
	(inreceptacle item9_bottle_smallitem receptacle25_toilet)
	(inreceptacle item14_book_smallitem receptacle5_sink)))
)

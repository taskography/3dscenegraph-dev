...
(define (problem GoodfieldTaskographyv2Rearrangement12.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item54_book_smallitem receptacle18_chair)
	...
	(inreceptacle item1_umbrella_largeitem receptacle20_chair)
	(inreceptacle item2_umbrella_largeitem receptacle23_chair)
	(inreceptacle item63_vase_mediumitem receptacle15_chair)
	(inreceptacle item11_banana_smallitem receptacle42_oven)
	(inreceptacle item10_bowl_smallitem receptacle43_oven)

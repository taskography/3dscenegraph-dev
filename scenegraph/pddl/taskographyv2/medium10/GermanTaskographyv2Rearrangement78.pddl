...
(define (problem GermanTaskographyv2Rearrangement78.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos92_Yneg74_place3_room4_floorA)
	...
	(inplace robot place3_door_room4_corridor)
  ...
  (:goal (and
	(inreceptacle item38_tv_largeitem receptacle19_bench)
	(inreceptacle item30_bottle_smallitem receptacle41_sink)
	(inreceptacle item5_bicycle_largeitem receptacle34_chair)
	...
	(inreceptacle item17_motorcycle_largeitem receptacle35_chair)
	(inreceptacle item12_bicycle_largeitem receptacle20_bench)
	(inreceptacle item18_motorcycle_largeitem receptacle34_chair)
	(inreceptacle item1_bicycle_largeitem receptacle36_toilet)))
)

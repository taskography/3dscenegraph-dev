...
(define (problem RockportTaskographyv2Rearrangement10.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos11_Ypos21_place9_room3_floorB)
	...
	(inplace robot place9_door_room3_corridor)
  ...
  (:goal (and
	(inreceptacle item16_vase_mediumitem receptacle55_dining_table)
	...
	(inreceptacle item40_potted_plant_largeitem receptacle4_oven)
	(inreceptacle item39_potted_plant_largeitem receptacle51_bed)
	(inreceptacle item7_handbag_largeitem receptacle25_toilet)
	...
	(inreceptacle item19_vase_mediumitem receptacle26_chair)))
)

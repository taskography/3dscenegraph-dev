...
(define (problem SandsTaskographyv2Rearrangement9.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item19_frisbee_mediumitem receptacle3_oven)
	...
	(inreceptacle item15_cup_smallitem receptacle11_refrigerator)
	(inreceptacle item18_bottle_smallitem receptacle7_sink)
	(inreceptacle item5_surfboard_largeitem receptacle10_sink)
	(inreceptacle item16_bottle_smallitem receptacle23_toilet)
	(inreceptacle item27_potted_plant_largeitem receptacle14_refrigerator)))
)

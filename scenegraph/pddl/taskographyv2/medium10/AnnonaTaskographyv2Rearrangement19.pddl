...
(define (problem AnnonaTaskographyv2Rearrangement19.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg19_Ypos67_place9_room15_floorA)
	...
	(inplace robot place9_door_room15_staircase)
  ...
  (:goal (and
	(inreceptacle item27_banana_smallitem receptacle26_bench)
	(inreceptacle item28_toothbrush_smallitem receptacle30_toilet)
	(inreceptacle item25_clock_mediumitem receptacle55_bed)
	...
	(inreceptacle item19_cup_smallitem receptacle3_sink)

...
(define (problem HortenseTaskographyv2Rearrangement53.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg41_Yneg39_place12_room7_floorB)
  ...
  (:goal (and
	(inreceptacle item2_bottle_smallitem receptacle30_toilet)
	(inreceptacle item7_bowl_smallitem receptacle40_sink)
	(inreceptacle item53_vase_mediumitem receptacle26_bed)
	(inreceptacle item11_bowl_smallitem receptacle13_chair)
	(inreceptacle item8_bowl_smallitem receptacle40_sink)
	(inreceptacle item50_book_smallitem receptacle15_chair)

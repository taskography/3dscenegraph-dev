...
(define (problem SwormvilleTaskographyv2Rearrangement59.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos12_Ypos36_place0_room7_floorA)
  ...
  (:goal (and
	...
	(inreceptacle item8_bottle_smallitem receptacle37_dining_table)
	...
	(inreceptacle item10_bottle_smallitem receptacle7_refrigerator)
	(inreceptacle item31_potted_plant_largeitem receptacle37_dining_table)
	(inreceptacle item12_clock_mediumitem receptacle22_chair)))
)

...
(define (problem AncorTaskographyv2Rearrangement73.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg15_Ypos23_place1_room11_floorA)
	...
	(inplace robot place1_door_room11_staircase)
  ...
  (:goal (and
	(inreceptacle item1_remote_smallitem receptacle7_oven)
	(inreceptacle item36_potted_plant_largeitem receptacle6_oven)
	(inreceptacle item51_suitcase_largeitem receptacle29_chair)
	(inreceptacle item9_bottle_smallitem receptacle24_dining_table)
	(inreceptacle item37_potted_plant_largeitem receptacle50_bed)
	(inreceptacle item47_potted_plant_largeitem receptacle15_sink)
	(inreceptacle item23_vase_mediumitem receptacle5_microwave)

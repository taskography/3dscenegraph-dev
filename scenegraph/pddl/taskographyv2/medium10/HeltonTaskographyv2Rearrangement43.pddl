...
(define (problem HeltonTaskographyv2Rearrangement43.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item12_bowl_smallitem receptacle66_refrigerator)
	...
	(inreceptacle item67_book_smallitem receptacle41_bed)
	(inreceptacle item32_potted_plant_largeitem receptacle54_oven)
	(inreceptacle item36_potted_plant_largeitem receptacle45_toilet)

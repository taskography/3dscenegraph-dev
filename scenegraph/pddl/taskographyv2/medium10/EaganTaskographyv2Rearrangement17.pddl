...
(define (problem EaganTaskographyv2Rearrangement17.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg25_Ypos52_place1_room16_floorA)
	...
	(inplace robot place1_door_room16_utility_room)
	...
	(inroom robot room16_utility_room)
  ...
  (:goal (and
	...
	(inreceptacle item5_bottle_smallitem receptacle44_dining_table)
	(inreceptacle item64_toothbrush_smallitem receptacle44_dining_table)
	(inreceptacle item37_potted_plant_largeitem receptacle21_couch)
	(inreceptacle item38_potted_plant_largeitem receptacle57_refrigerator)
	(inreceptacle item22_potted_plant_largeitem receptacle56_refrigerator)
	(inreceptacle item10_cake_mediumitem receptacle56_refrigerator)
	(inreceptacle item25_potted_plant_largeitem receptacle21_couch)))
)

...
(define (problem SussexTaskographyv2Rearrangement4.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item31_bowl_smallitem receptacle59_bed)
	(inreceptacle item50_potted_plant_largeitem receptacle11_refrigerator)
	(inreceptacle item14_cup_smallitem receptacle43_chair)
	(inreceptacle item52_potted_plant_largeitem receptacle62_dining_table)
	(inreceptacle item2_cake_mediumitem receptacle10_refrigerator)
	(inreceptacle item56_potted_plant_largeitem receptacle58_bed)

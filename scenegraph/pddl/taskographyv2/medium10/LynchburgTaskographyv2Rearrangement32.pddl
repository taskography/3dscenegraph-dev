...
(define (problem LynchburgTaskographyv2Rearrangement32.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item58_tv_largeitem receptacle64_sink)
	(inreceptacle item4_tie_smallitem receptacle52_dining_table)
	(inreceptacle item10_bottle_smallitem receptacle26_chair)
	(inreceptacle item39_potted_plant_largeitem receptacle66_refrigerator)
	(inreceptacle item2_tie_smallitem receptacle53_dining_table)
	(inreceptacle item14_cup_smallitem receptacle45_bed)
	(inreceptacle item73_book_smallitem receptacle48_bed)))
)

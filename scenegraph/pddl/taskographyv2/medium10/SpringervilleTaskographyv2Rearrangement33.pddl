...
(define (problem SpringervilleTaskographyv2Rearrangement33.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg17_Ypos40_place1_room2_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item16_spoon_smallitem receptacle7_sink)
	(inreceptacle item14_vase_mediumitem receptacle23_chair)
	(inreceptacle item9_book_smallitem receptacle21_toilet)
	...
	(inreceptacle item10_book_smallitem receptacle4_oven)))
)

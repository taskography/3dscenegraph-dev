...
(define (problem CousinsTaskographyv2Rearrangement67.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xpos38_Ypos5_place11_room14_floorA)
	...
	(inplace robot place11_door_room14_home_office)
  ...
  (:goal (and
	(inreceptacle item71_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item1_handbag_largeitem receptacle48_couch)
	(inreceptacle item9_bottle_smallitem receptacle92_bed)
	(inreceptacle item25_cake_mediumitem receptacle36_chair)
	(inreceptacle item15_wine_glass_smallitem receptacle110_sink)
	(inreceptacle item133_vase_mediumitem receptacle45_chair)
	(inreceptacle item117_book_smallitem receptacle112_sink)
	(inreceptacle item85_potted_plant_largeitem receptacle37_chair)
	(inreceptacle item6_tie_smallitem receptacle108_sink)
	(inreceptacle item65_potted_plant_largeitem receptacle37_chair)))
)

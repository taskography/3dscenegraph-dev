...
(define (problem SouthfieldTaskographyv2Rearrangement45.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item3_surfboard_largeitem receptacle8_sink)
	(inreceptacle item19_clock_mediumitem receptacle10_sink)
	(inreceptacle item31_umbrella_largeitem receptacle32_bed)
	(inreceptacle item18_bottle_smallitem receptacle34_bed)
	(inreceptacle item16_bottle_smallitem receptacle34_bed)
	(inreceptacle item24_tie_smallitem receptacle11_refrigerator)))
)

...
(define (problem BautistaTaskographyv2Rearrangement92.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item55_tv_largeitem receptacle47_bed)
	(inreceptacle item17_suitcase_largeitem receptacle67_refrigerator)
	(inreceptacle item10_tie_smallitem receptacle52_toilet)
	(inreceptacle item80_book_smallitem receptacle66_refrigerator)
	(inreceptacle item28_spoon_smallitem receptacle47_bed)
	(inreceptacle item86_clock_mediumitem receptacle53_toilet)
	(inreceptacle item44_potted_plant_largeitem receptacle68_refrigerator)
	(inreceptacle item56_mouse_smallitem receptacle3_bench)

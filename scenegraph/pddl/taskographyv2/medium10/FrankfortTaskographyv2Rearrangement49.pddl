...
(define (problem FrankfortTaskographyv2Rearrangement49.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	...
	(inreceptacle item5_bottle_smallitem receptacle17_couch)
	(inreceptacle item50_book_smallitem receptacle36_microwave)
	(inreceptacle item49_book_smallitem receptacle24_bed)
	(inreceptacle item32_tv_largeitem receptacle28_toilet)
	(inreceptacle item9_cake_mediumitem receptacle24_bed)
	(inreceptacle item51_book_smallitem receptacle47_refrigerator)
	(inreceptacle item54_clock_mediumitem receptacle29_toilet)))
)

...
(define (problem AdairsvilleTaskographyv2Rearrangement8.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg35_Ypos38_place1_room13_floorB)
	...
	(inplace robot place1_door_room13_kitchen)
  ...
  (:goal (and
	(inreceptacle item34_potted_plant_largeitem receptacle3_sink)
	...
	(inreceptacle item35_potted_plant_largeitem receptacle20_toilet)
	(inreceptacle item36_potted_plant_largeitem receptacle26_chair)
	...
	(inreceptacle item44_tv_largeitem receptacle39_bed)))
)

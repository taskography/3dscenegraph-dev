...
(define (problem PameliaTaskographyv2Rearrangement51.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg5_Ypos2_place8_room10_floorB)
	...
	(inplace robot place8_door_room10_home_office)
  ...
  (:goal (and
	(inreceptacle item13_bottle_smallitem receptacle34_couch)
	(inreceptacle item17_bottle_smallitem receptacle47_toilet)
	(inreceptacle item22_banana_smallitem receptacle46_toilet)
	(inreceptacle item69_book_smallitem receptacle27_chair)
	(inreceptacle item74_clock_mediumitem receptacle54_oven)
	(inreceptacle item83_teddy_bear_mediumitem receptacle43_bed)
	(inreceptacle item36_potted_plant_largeitem receptacle62_refrigerator)
	(inreceptacle item84_teddy_bear_mediumitem receptacle25_chair)
	(inreceptacle item23_orange_smallitem receptacle47_toilet)

...
(define (problem BonesteelTaskographyv2Rearrangement63.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg43_Ypos61_place12_room5_floorB)
  ...
  (:goal (and
	...
	(inreceptacle item27_potted_plant_largeitem receptacle41_bed)
	(inreceptacle item66_vase_mediumitem receptacle19_chair)
	(inreceptacle item4_bottle_smallitem receptacle47_dining_table)
	(inreceptacle item68_vase_mediumitem receptacle16_chair)
	(inreceptacle item67_vase_mediumitem receptacle1_bench)
	(inreceptacle item62_book_smallitem receptacle52_microwave)
	(inreceptacle item36_potted_plant_largeitem receptacle16_chair)
	(inreceptacle item35_potted_plant_largeitem receptacle56_sink)))
)

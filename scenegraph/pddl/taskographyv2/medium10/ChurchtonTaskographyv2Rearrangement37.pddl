...
(define (problem ChurchtonTaskographyv2Rearrangement37.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg19_Yneg11_place10_room16_floorB)
	...
	(inplace robot place10_door_room16_living_room)
  ...
  (:goal (and
	...
	(inreceptacle item58_clock_mediumitem receptacle46_toilet)
	(inreceptacle item60_clock_mediumitem receptacle44_toilet)
	(inreceptacle item47_tv_largeitem receptacle50_oven)
	(inreceptacle item6_bottle_smallitem receptacle34_bed)
	(inreceptacle item3_tie_smallitem receptacle45_toilet)
	(inreceptacle item20_potted_plant_largeitem receptacle17_chair)
	(inreceptacle item10_bottle_smallitem receptacle41_dining_table)

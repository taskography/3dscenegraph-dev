...
(define (problem NaturalTaskographyv2Rearrangement48.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg24_Ypos20_place13_room21_floorB)
	...
	(inplace robot place13_door_room21_living_room)
  ...
  (:goal (and
	(inreceptacle item5_umbrella_largeitem receptacle54_toilet)
	(inreceptacle item60_remote_smallitem receptacle29_chair)
	(inreceptacle item11_bottle_smallitem receptacle26_chair)
	(inreceptacle item78_book_smallitem receptacle13_chair)
	(inreceptacle item84_toothbrush_smallitem receptacle19_chair)
	(inreceptacle item8_tie_smallitem receptacle53_toilet)
	(inreceptacle item83_vase_mediumitem receptacle69_sink)
	(inreceptacle item57_tv_largeitem receptacle64_oven)
	(inreceptacle item59_remote_smallitem receptacle18_chair)
	(inreceptacle item82_clock_mediumitem receptacle23_chair)))
)

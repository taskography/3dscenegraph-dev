...
(define (problem OyensTaskographyv2Rearrangement66.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item14_bottle_smallitem receptacle35_bed)
	...
	(inreceptacle item19_bowl_smallitem receptacle24_chair)
	...
	(inreceptacle item8_book_smallitem receptacle35_bed)))
)

...
(define (problem SoldierTaskographyv2Rearrangement7.pddl) (:domain taskographyv2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item35_potted_plant_largeitem receptacle27_couch)
	(inreceptacle item8_knife_smallitem receptacle15_chair)
	(inreceptacle item74_vase_mediumitem receptacle25_chair)
	...
	(inreceptacle item61_book_smallitem receptacle44_toilet)
	(inreceptacle item77_vase_mediumitem receptacle14_chair)
	(inreceptacle item63_clock_mediumitem receptacle50_microwave)
	(inreceptacle item76_vase_mediumitem receptacle46_toilet)))
)

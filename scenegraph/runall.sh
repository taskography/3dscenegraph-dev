...
#         cmd="python plan.py --domain-name taskography${i} --planner ${j} --log-dir exp-official --expid taskography${i}_${j} --timeout ${optimal_timeout} --skip-train"
#         echo "$cmd"
#     done
# done
...
#     do
#         echo "# Planning in $i with $j"
#         cmd="python plan.py --domain-name taskography${i} --planner ${j} --log-dir exp-official --expid taskography${i}_${j} --timeout ${satisficing_timeout} --skip-train"
#         echo "$cmd"
#     done
# done
